...
public class ZeroLatLongDevicesReportDao {
	public static String rbKey = String.valueOf(getSysParameterForVts());

	@SuppressWarnings("unchecked")
	public JSONObject getDataForZeroLatLongDevices(HttpServletRequest request, String depotId,String startdate){
		...
		try{
			...
			myresult=port.webGetZeroLatLongDevicePackets(depot,startdate,rbKey);

...
public class EarlyArrivalDetailedReportAction extends ActionSupport{
	String path="";
	char ft = 15;
	String str="";
	String c=" ";
...
public String AjaxEarlyArrivalDetailed()
  {
	try {
...
//					String fileName = "EarlyArrivalSummary.txt";
					     ...
					     regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br>Early Arrival Deatiled Report</br>From Date:- "+startdate+" To Date:-"+ enddate+"</h4></div>";
...
//				        regionTypeAjaxString +="<div align='center'><b>Range Of Conductors:</b></div>"+"<br>";
						...
						regionTypeAjaxString +="<td align='center' width='10%'><b>SR. NO</b></td><td align='center' width='10%'><b>DIVISION</b></td><td align='center' width='20%'><b>DEPOT</b></td><td align='center' width='20%'><b>SCHEDULE NO.</b></td><td align='center' width='20%'><b>DUTY</b></td>";
						regionTypeAjaxString +="<td align='center' width='10%'><b>VEH NO.</b></td><td align='center' width='20%'><b>SCH. DEP.TIME</b></td>" +
								"<td align='center' width='10%'><b>GPS DEP.</b></td><td align='center' width='20%'><b>TIMEDIFFERENCE(MIN) </b></td></tr>";

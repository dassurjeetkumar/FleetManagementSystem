...
public class DriverLicenseExpiryReportActionIts {
	...
	public String getStartdate() {
		...
		public String getdriverlicenseexpiry()
		{
			...
			session1 = HibernateUtil.getSession("hibernate.cfg.xml");
			 ...
			 String sql2 = "select EMPLOYEE_NAME,IFNULL(TOKEN,'') TOKEN,EMPLOYEE_DESIGNATION,IFNULL(DRIVING_LC_NO,'') DRIVING_LC_NO,IFNULL(DL_EXPIRY_DT,'') DL_EXPIRY_DT," +

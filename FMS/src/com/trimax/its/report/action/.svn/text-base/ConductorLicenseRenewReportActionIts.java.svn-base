...
public class ConductorLicenseRenewReportActionIts {
	...
	public String getStartdate() {
		...
		public String getconductorlicenserenew()
		{
			try {
			...
			session1 = HibernateUtil.getSession("hibernate.cfg.xml");
			 ...
			 String sql2 = "select EMPLOYEE_NAME,IFNULL(TOKEN,'') TOKEN,EMPLOYEE_DESIGNATION,IFNULL(DRIVING_LC_NO,'') DRIVING_LC_NO,IFNULL(Conductor_RENEWAL_DT,'') Conductor_RENEWAL_DT," +
			...
			Query query = session1.createSQLQuery(sql2).addScalar("EMPLOYEE_NAME").addScalar("TOKEN").addScalar("EMPLOYEE_DESIGNATION")
					.addScalar("DRIVING_LC_NO").addScalar("Conductor_RENEWAL_DT");

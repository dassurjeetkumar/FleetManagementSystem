...
public class VehicleLicenseExpiryReportActionIts {
	...
	public String getStartdate() {
		...
		public String getvehiclelicenseexpiry()
		{
			try {
			...
			session1 = HibernateUtil.getSession("hibernate.cfg.xml");
			 ...
			 String sql2 = "SELECT `license_number`, `fc_expiry_date` FROM `vehicle` " +
			 		"WHERE status='active' and fc_expiry_date between '"+date1+"' and '"+date2+"' and deleted_status='0' "+Condition+" ";
			
			
			Query query = session1.createSQLQuery(sql2).addScalar("license_number").addScalar("fc_expiry_date");
			...
			String fileName = "ConductorExpiryReport.txt";
				...
				regionTypeAjaxString +="<thead><tr><th>Sr No</th><th>Vehicle No</th><th>Expire Date</th>" +
//						"<th>Remarks</th>" +
						""+"</tr></thead><tbody>";
				...
				regionTypeAjaxString +="<td align='right'>"+ list.get("fc_expiry_date").toString() +"</td>";

...
public class DriverWiseKMPLReportITS {
...
public String driverWiseKMPLReportITS()
  {
	try {
...
//					String fileName = "EarlyArrivalSummary.txt";
					     ...
					     regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br>DriverWise KMPL Report(Corporation)</br>From Date:- "+startdate+" To Date:-"+ enddate+"</h4></div>";
...
//				
	...
	public String driverWiseKMPLDetailsReportITS(){
...
//						String fileName = "EarlyArrivalSummary.txt";
						     ...
						     regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br>DivisionWise DriverWise KMPL Report</br>From Date:- "+startdate1+" To Date:-"+ enddate1+"</h4></div>";
...
//								regionTypeAjaxString +="<td>"+"BMTC"+"</td>";
...
//						
	...
	public String getdepotdetails1()
	  {
		try {
			...
			List<Map<String, Object>> aliasToValueMapList = query2.list();
						String realpath = ServletActionContext.getRequest()
						     ...
						     regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br> DepotWise DriverWise KMPL Report</br>From Date:- "+startdate1+" To Date:-"+ enddate1+"</h4></div>";
	...
	public String getdetailsname1()
	  {
		try {
			...
			session1 = HibernateUtil.getSession("hibernate.cfg.xml");
			 transaction = session1.beginTransaction();
			  sql1 ="SELECT EMPLOYEE_NAME,TOKEN,SUM(operated_km) operated, SUM(fuel) fuel,SUM(operated_km)/SUM(fuel) kmpl " +
			  		"FROM `kmpl_details` km left join employee e on e.EMPLOYEE_ID=km.driver_id " +
			  		"WHERE `operated_date` between  '" + date1 +"' and '" + date2 +"'  and km.depot_id='"+ depotid+"' group by km.driver_id order by kmpl";



			 Query query2 = session1.createSQLQuery(sql1).addScalar("EMPLOYEE_NAME").addScalar("TOKEN").addScalar("operated").addScalar("fuel")
				 		.addScalar("kmpl");
			 query2.setResultTransformer(AliasToEntityMapResultTransformer.INSTANCE);
			List<Map<String, Object>> aliasToValueMapList = query2.list();
						String realpath = ServletActionContext.getRequest()
...
//						String fileName = "EarlyArrivalSummary.txt";
						     ...
						     regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br>DriverWise KMPL Report</br>From Date:- "+startdate1+" To Date:-"+ enddate1+"</h4></div>";
					        ...
					        regionTypeAjaxString += "<div style='height:310px; overflow-y:scroll; display:block;'><div id='printid'><table border='1' class='table table-striped table-bordered table-hover' id='sample_6' style='width:50%;border-collapse: collapse;'></thead>";
							regionTypeAjaxString +="<tr><td align='center' width='10%'><b>Sl No.</b></td><td align='center' width='20%'><b>Driver Name</b></td><td  align='center' width='10%'><b>Driver Token No</b></td><td  align='center' width='10%'><b>Total Actual Operated KM</b></td><td align='center' width='10%'><b>Total HSD in Litres</b></td><td align='center' width='10%'><b>Average KMPL</b></td></tr>";
...
//						
							...
							for (int i = 0; i < aliasToValueMapList.size(); i++) {
								...
								Map<String, Object> list = aliasToValueMapList.get(i);
								regionTypeAjaxString +="<td>"+j+"</td>";
								regionTypeAjaxString +="<td>"+list.get("EMPLOYEE_NAME").toString()+"</td>";

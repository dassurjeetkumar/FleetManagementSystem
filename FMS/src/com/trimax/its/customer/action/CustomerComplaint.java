...
public class CustomerComplaint extends ActionSupport{
...
@SkipValidation
	...
	@SkipValidation
	 public String getCustomerComplaintview(){
...
//				LineSectorDao linedao=new LineSectorDao();
				...
				int total = -1;
				total = cstdao.getTotalRecordsForComplaint(total, request,
				...
				result = cstdao.getDataForComplaint(total, request,
						dbcol[Integer.parseInt(sCol)], sdir,viewdeletedrecord);

...
public class TripwiseEarlyDepartureReport extends ActionSupport {
...
//	        System.out.println("parentId="+parentId+"formattedgivendate"+date);
	  ...
	  public String getTripwiseEarlyDeparture(){
			
//			System.out.println("Enter into getTripwiseEarlyDeparture");
			HttpServletRequest req = ServletActionContext.getRequest();
...
//				List<Map<String, Object>> aliasToValueMapList = query.list();
				 ...
				 VtsResponse6 alertresults=scheduleDAO.getDataTripWiseEarlyDepartureReport(date1,scheduleNo);
//				 System.out.println("alertresults Size==="+alertresults.getWaybillDetails().size());
				 regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br> Tripwise Early Departure Report</br></h4></div>";
			     regionTypeAjaxString +="<div align='right'><b>Run Date:-</b>"+runDateTime+"<b>Schedule NO:-</b>"+scheduleNo+"</div></div>";
					...
					regionTypeAjaxString +="<thead><tr><th>Sl No.</th><th>Duty type</th><th>Trip No</th><th>Vehicle No</th><th>Start Point Name</th><th>Sch Trip Dept. Time </th><th>Act Trip Dept. Time</th><th>Time Difference</th><th>Trip Status</th>"+"</tr></thead><tbody>";
...
//					   System.out.println("Enter into forloop="+alertresults.getWaybillDetails().get(i).getShiftTypeName().toString());
						...
						regionTypeAjaxString +="<td align='right'>"+ list.getSTARTBUSSTOPNAME().toString() +"</td>";
						regionTypeAjaxString +="<td align='right'>"+ list.getSTARTTIME().toString() +"</td>";
						regionTypeAjaxString +="<td align='right'>"+ list.getACTSTARTTIME().toString() +"</td>";

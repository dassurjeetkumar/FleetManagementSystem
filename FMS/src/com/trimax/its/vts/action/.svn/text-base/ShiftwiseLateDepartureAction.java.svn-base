...
import org.hibernate.Session;
	...
	public class ShiftwiseLateDepartureAction {
...
//	String regionTypeAjaxString = "";
	StringBuilder regionTypeAjaxString=new StringBuilder();
		...
		public String getShiftwiseLateDepartureData()
		{
					System.out.println("in shift wise late dept Report ");
			...
			String fileName = "ShiftwiseLateDepartureReport.txt";
			System.out.println("we are in ajax code................");

			regionTypeAjaxString.append(" <div id='header' style='display: none;'><div align='center'><h4>Shift wise Late Departure Report</br>From Date:- "
					+ startDate  +"</h4></br></div>");
			regionTypeAjaxString.append("<div align='right'><b>Current Date:-</b>"
					+ runDateTime + "</div></div>");

			String nwkr = ""
					+ "                                   Late Departure Shiftwise    " +

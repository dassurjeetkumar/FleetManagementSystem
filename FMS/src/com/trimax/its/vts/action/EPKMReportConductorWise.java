...
import org.hibernate.Session;
	...
	public class EPKMReportConductorWise {
...
//					depotIn =depotIn+")";
			...
			activeresult = port.webGetEPKMDataConductorWise(startDate1, todate,
					qryy, rbKey); // calling Web service
			

			regionTypeAjaxString.append(" <div id='header' style='display: none;'><div align='center'><h4>ConductorWise EPKM Report</br>From Date:- "
			...
			regionTypeAjaxString.append("<thead><tr><th>Sr.No.</th><th>Depot No</th><th>Cond Name</th><th>Cond Token</th><th>Waybill No</th><th>Vehicle No</th><th>Sch KM</th><th>Log KM</th><th>GPS KM</th><th>Revenue</th><th>Log EPKM</th><th>GPS EPKM</th>"
					+ "</tr></thead><tbody>");
			...
			for (i = 0; i < activeresult.getWaybillDetails().size(); i++) {
				...
				regionTypeAjaxString.append("<td>"+ activeresult.getWaybillDetails().get(i).getCONDNAME()+ "</td>");
				regionTypeAjaxString.append("<td>"+ activeresult.getWaybillDetails().get(i).getCONDTOKENNO()+ "</td>");
				...
				regionTypeAjaxString.append("<td>"+ activeresult.getWaybillDetails().get(i).getLogsheetKm()+ "</td>");

				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create BreakDown History
							</div>
							<div class="tools">
						    </div>
						</div>
						<div class="portlet-body form">
                         <s:if test="hasActionErrors()">
							...
							<form action="saveBreakDownHistory.action" class="form-horizontal"
								method="post">
								<div class="form-body">
							 ...
							 <div class="form-group">
									...
									<!-- <input class="form-control input-lg"  id="busStop" name="project" type="text" onkeyup="getDropStops(this.value)" /> -->
									  <input id="vehicle" type="text" class="form-control" name="breakdownhistory.vehicle.vehicleRegistrationNumber" maxLength="11"
										...
										<s:if test="fieldErrors.get('vehicle').size() > 0">
													<span style="color: red;"><s:property
															value="fieldErrors.get('vehicle').get(0)" /></span>
												</s:if>
										</div>
									</div>
									<div class="form-group">
									...
									<!-- <input class="form-control input-lg"  id="busStop" name="project" type="text" onkeyup="getDropStops(this.value)" /> -->
									  <input id="breakdownType" type="text" class="form-control" name="breakdownhistory.breakDownTypeDetails.breakdown_name" maxLength="11"
										...
										<s:if test="fieldErrors.get('breakdownType').size() > 0">
													<span style="color: red;"><s:property
															value="fieldErrors.get('breakdownType').get(0)" /></span>
												</s:if>
										</div>
									</div>

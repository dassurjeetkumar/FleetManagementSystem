...
<form name="createAction" id='createAction' action="getScheduleMappingNew.action" method="post">
...
<form name="deleteAction" id="deleteAction" action="getDeleteScheduleMapping.action" method="post">
...
<%--                                 <span id="errorMsg" style="color:red;word-wrap: break-word;" ><s:actionerror/></span> --%>
                            ...
                            <table class="table table-striped table-bordered table-hover"  id="scheduleMappingTableViewList">
...
$(document).ready(function() {
    window.history.pushState("","", "getScheduleMappingView.action");

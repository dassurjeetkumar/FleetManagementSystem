...
<script>
	...
	function callCreate() {
		document.forms[0].action = "CreateServiceType.action";
...
<form name="editAction" id='editAction' action="EditServiceType.action" method="post">
	<input type="hidden" id='editServiceTypeId' name="editServiceTypeId"/>
</form>
<form name="deleteAction" id="deleteAction" action="DeleteServiceType.action" method="post">
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
						...
						<div class="caption">
							...
							<i class="fa fa-globe"></i> View Service Type
						</div>
						<div class="actions">

...
<script>                 	
   function tabletoExcel(btnExport){     
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='13'>ETM Availability</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    inputHTML += "</tr>";
    inputHTML += "</table>";
    var htmltable = document.getElementById("ETMAvailListable");
    var html = inputHTML + htmltable.outerHTML;
    var downloadLink = document.createElement("a");
    downloadLink.href = 'data:application/vnd.ms-excel,' + encodeURIComponent(html);
    downloadLink.download = "ETM Availability.xls";
...
<%@page import="com.trimax.its.utility.dao.AccessRightsDao" %>
	<%
		...
		accessrights = accessrightdao.accessRightsdetails(usrsessionid,
				"OnlineETMAvailabilityList.action");
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							...
							<i class="fa fa-globe"></i>View ETM Details
						</div>
						<div align="right">
...
<%-- 								<span id="errorMsg" style="color:red;word-wrap: break-word;" ><s:actionerror/></span> --%>
							...
							<table class="table table-striped table-bordered table-hover"
								id="ETMAvailListable" name="ETMAvailListable">
								<thead>
									<tr>
										<th></th>
<!-- 										<th>Schedule Id</th> -->

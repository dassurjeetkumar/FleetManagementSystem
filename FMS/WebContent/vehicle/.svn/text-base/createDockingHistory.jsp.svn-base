...
<script>
	...
	$(document).ready(function(){
			...
			var minutess = minutes > 9 ? minutes : '0' + minutes;
			 var monthNames = [ "January", "February", "March", "April", "May", "June",
			                    "July", "August", "September", "October", "November", "December" ];
			  var strDate = d.getDate() + " " + monthNames[d.getMonth()] + " " + d.getFullYear()+" " + "-"+""+d.getHours()+":"+minutess;
		}); 
</script>
				...
				<div class="tab-pane active" id="tab_0">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								<i class="fa fa-gift"></i>Create Docking History
							</div>
						...
						<s:if test="hasActionErrors()">
							...
							<!-- BEGIN FORM-->
							<form action="createDockingHistoryAction.action" method="post"  id="createComplaintId" class="form-horizontal">
							<input type="hidden" name="checkreq"  value="1" /> 
							<s:if test="%{insertstatus=='duplicate'}"><font color="red">Could not insert Duplicate PeakHours</font></s:if>
								...
								<div class="form-body"> 
									...
									<div class="form-group">
										<label class="col-md-3 control-label">
											 Registration Number:	<span class="required"> * </span></label>

										<div class="col-md-4"> 
 											
 											<s:select list="vehicleidlist" id="vehicleidlistid" name="dochistory.vehicle.vehicleId"  
								...
								<div class="col-md-4">
									<div class="input-group date form_datetime" >
										<input type="text" size="16" readonly name="dochistory.startDateString"  class="form-control" value="<s:property value='startdate'/>">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group date form_datetime" >
										<input type="text" size="16" readonly  	name="dochistory.endDateString" class="form-control" value="<s:property value='dochistory.endDateString'/>">
										<span class="input-group-btn">
											<button class="btn default date-set" type="button">
												<i class="fa fa-calendar"></i>
											</button>
									...
									<span class="help-block" style="color: red">
										 <s:property value="%{fieldErrors.get('endDateString').get(0)}" />
									</span>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select class="form-control" id="status" name="dochistory.status">
								...
								<div class="form-body"> 
									...
									<div class="form-group">
										<label class="col-md-3 control-label">
											Docking Type:<font color="red">*</font>
										</label>
										...
										<div class="col-md-4"> 
		     								...
		     								<span style="color:red;"><s:property value="fieldErrors.get('docking_type_id').get(0)" /></span> 
 											</s:if> 
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Docking Batch Name:</label>

										<div class="col-md-4">
											<input type="text" class="form-control" id="" maxlength="11"
												name="dochistory.docking_batch_name" value='<s:property value="dochistory.docking_batch_name"/>'>
												
												
												<s:if test="fieldErrors.get('docking_batch_name').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('docking_batch_name').get(0)" /></span>
											</s:if>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select class="form-control" id="fip_change" name="dochistory.fip_change">
								...
								<div class="form-group">
									<label class="col-md-3 control-label">EOC Change</label>
									<div class="col-md-4">
										<select class="form-control" id="status" name="dochistory.eoc_change">
									...
									<div class="form-group">
										...
										<div class="col-md-4"> 
 											...
 											<s:select list="componentlist" id="complainttakenId" name="dochistory.componenetType.componentTypeId"  
		     								...
		     								<span style="color:red;"><s:property value="fieldErrors.get('componentTypeId').get(0)" /></span> 
 											</s:if> 
										</div>
									</div>
								</div>

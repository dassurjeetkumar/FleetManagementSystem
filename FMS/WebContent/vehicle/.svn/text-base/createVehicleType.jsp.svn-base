			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i> Create Vehicle Type
						</div>
					</div>
					<div class="portlet-body form">
						...
						<form action="SaveVehicleType" class="form-horizontal form-row-seperated" method="post">
							<div class="form-body">
								...
								<s:hidden name="isNewVehicleType" value="1"/>
									...
									<div class="col-md-3">
										<input type="text" class="form-control" maxlength="20"
											placeholder="Enter text"  name="vehicleDetails.vehicle_type_name" value="<s:property value='vehicleDetails.vehicle_type_name'/>">
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<select class="select2_category form-control" name="vehicleDetails.status">
											<option value="ACTIVE" id="veh_active">ACTIVE</option>		
											<option value="INACTIVE" id="veh_inactive">INACTIVE</option>
										</select>
									</div>
									<script>
										var prevStatus = "<s:property value='vehicleDetails.status'/>";
										if(prevStatus!=""){
											if(prevStatus=="ACTIVE"){
												document.getElementById('veh_active').selected = true;
											}else{
												document.getElementById('veh_inactive').selected = true;
											}
										}
									</script>
								</div>

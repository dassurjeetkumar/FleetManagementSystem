...
<%if (access.equalsIgnoreCase("Y")){ %>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Vehicle Maintenance 
							</div>
							<div class="actions">
							...
							<%}%>
								<%if(delete.equalsIgnoreCase("Y")){ %>
								 <a href="javascript:void(0)" class="btn red" id="deletemaintenance" onclick="calldelete()">
							...
							<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right ">
										...
										<%if(status.equalsIgnoreCase("ACTIVE")){ %>
											<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=VEHICLEMAINTENANCERPT'">
						...
						<div class="portlet-body">
							...
							<s:if test="%{deletestatus=='fail'}">
								Could Not Delete Vehicle Maintenance Deleted 
							</s:if>
							</div>
							<table class="table table-striped table-bordered table-hover"
								id="listvehiclemaintence">
								<thead>
									<tr>
		...
		if (cnt == 0) {
			...
			bootbox.confirm("Are you Sure, you want to delete this record?",
							function(result) {
								...
								if (result == true) {
									document.getElementById("delmaintenanceid").value = val;
	...
	function callEdit() {
		...
		if (cnt == 0) {
			...
			if(isEligibleForOpertion(val)){
			document.getElementById("editmaintenanceid").value = val;
		...
		function callCreate() {
			document.forms[0].action = "createVehicleMaintence.action";
			document.forms[0].submit();
		}
		$(document).ready(function() {
			   window.history.pushState("","", "vehiclemaintenancelist.action");
			 });
...
<form name="form1" id="form1" action="ModifyVehicleMaintenanceDetails" method="POST">
	<input type="hidden" name="editmaintenanceid" id="editmaintenanceid" value="" />

</form>
<form name="form2" id="form2" action="DeleteMaintenanceDetails.action"
	method="POST">
	<input type="hidden" name="delmaintenanceid" id="delmaintenanceid" />
</form>
<%}else{%>

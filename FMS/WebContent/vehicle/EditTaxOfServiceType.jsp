			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i> Edit Service Tax
						</div>
					</div>
					<div class="portlet-body form">
						...
						<form action="saveEditTaxServiceTypeAction" class="form-horizontal form-row-seperated" method="post">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<input type="text" class="form-control"
											 value="<s:property value='serviceTypeDetails.baseValue'/>" 
											name="serviceTypeDetails.baseValue" maxlength="20">
									</div>
								</div>

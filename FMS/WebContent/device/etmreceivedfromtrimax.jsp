			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>Etm Recevied From Trimax
						</div>
						<div class="actions">
						<div class="btn-group">
...
//						alert(data);
		...
		//alert("data=="+data);
		document.forms[0].action = 'ReceivedByDepot.action?value='+data,

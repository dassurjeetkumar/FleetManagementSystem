...
$(function() {
	 getDepotWiseSummarySubmit();
});
});

function getDepotWiseSummarySubmit(){
	

        $.ajax({
        
            type: "get",
            url: '<%=request.getContextPath()%>/AjaxDepotWiseAndCauseWiseSummaryReport.action',
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Depot Wise & Cause Wise Summary
							</div>
						</div>

			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>View Service Ticket To Pick Up
						</div>
						<div class="actions">
						<div class="btn-group">
...
//						alert(data);
		...
		//alert("data=="+data);
		document.forms[0].action = 'serviceTicketToCompanyEtmpickup.action?value='+data+'&issuer='+issuer+'&receiver='+receiver,

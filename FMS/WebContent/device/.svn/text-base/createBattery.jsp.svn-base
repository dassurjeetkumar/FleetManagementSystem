			...
			<div class="col-md-12">
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-bars"></i>Create Battery
						</div>
					</div>
					<div class="portlet-body form">
						<form action="SaveNewBatteryAction"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group input-medium date date-picker"
										...
										<input type="text"  class="form-control" id="procuredDate" value='<s:property value="battery.procuredDateString"/>' readonly

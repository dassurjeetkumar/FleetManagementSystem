...
function getEditDetail(){
	...
	document.frm.action="updateRFIDCardDetails.action";
	document.frm.submit();
}
function cancelform(){
	document.frm.action="rfidcardlist.action";
	document.frm.submit();
}
function getDetails(){
...
<div class="tab-content">
							...
							<div class="portlet box grey-cascade">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit RFID Card
										</div>
								...
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">RFID Card Id:<font color="red">*</font></label>
										<div class="col-md-4">
<%-- 										<input   name="maintenancetype.maintenance_type_id"  value='<s:property value="maintenancetype.maintenance_type_id" />'  id="maintenance_id" readonly> --%>
										<input id="rfid_card_id" type="text" class="form-control" name="rfidcard.rfid_card_id"	value="<s:property value='rfidcard.rfid_card_id'/>" readonly />
								...
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-4">
<%-- 										<input type="hidden"   name="rfidcard.rfid_card_id"  value='<s:property value="rfidcard.rfid_card_id" />'  id="rfid_card_id" > --%>
											<input type="text" class="form-control" id="serial_number" maxlength="20" value='<s:property value="rfidcard.serial_number"/>'
												name="rfidcard.serial_number">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select class="form-control" id="status" name="rfidcard.status" <s:property value="rfidcard.status"/> >
											<option id="active" value="ACTIVE">ACTIVE</option>
											<option id="deactive" value="INACTIVE">INACTIVE</option>
										</select>
										<script>
															var status = "<s:property value="rfidcard.status"/>";
															if (status != undefined) {
																if (status == "ACTIVE"
																		|| status == "ACTIVE") {
																	document
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										...
										<input type="text" class="form-control" name="rfidcard.stringprocureddate"	value="<s:property value='rfidcard.stringprocureddate'/>" readonly /> <span
								...
								<div class="form-group">
									<label class="col-md-3 control-label">Vendor Name:<font color="red">*</font></label>
										<div class="col-md-4">
											<s:select list="Vendorlist" id="vendorId" name="rfidcard.vendor.id" 

...
function getData(){
 ...
 var divid=$("#divisionlist").val();
    ...
    var oTable = table.dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "Ajaxetmrepairstatus.action?divid="+divid+"&depot="+depotid+"&startdate="+strdate+"&enddate="+enddate,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Etm Repair Status Report
							</div>
						</div>
                           ...
                           <table class="table table-striped table-bordered table-hover"
								...
								<thead>
									...
									<!-- 	<th style="width1: 8px;"></th> -->
										<th>SN<br>No</th>
										<th>Depot<br>No </th>
										 <th>Repair<br>Depot</th>
										<th>Pick Up<br>FME</th>
								
										<th>Pick Up<BR>Verifone</th> 
										<th>Resolve<br>Verifone</th>
...
<b><font size="2"><label>Date: </label></font><font size="2"><b><span id="startdat" style="text-align:left;margin-left:50px;"></span></font></b>
  ...
  downloadLink.download = "Etm Repair Status.xls"; 

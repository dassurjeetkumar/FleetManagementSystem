...
function getData(){
	...
	$('#depotwisecausesummary').attr("style", "display:''");
	
    table = $('#depotwisecausesummaryTable');
    var oTable = table.dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "ajaxgetdepotandcausesummary.action?divid="+divid+"&depot="+depotid+"&startdate="+strdate+"&enddate="+enddate,
	...
	jQuery('#depotwisecausesummaryTabletable_wrapper .dataTables_filter input').addClass(
			"form-control input-xsmall input-inline"); // modify table
	// search input
	jQuery('#depotwisecausesummaryTabletable_wrapper .dataTables_length select').addClass(
...
function printDiv() {     
	  document.getElementById("depotwisecausesummary").style.visibility='visible';  
	     document.getElementById("header").style.display='block';
	     document.getElementById("header").style.visibility='visible'; 
	    
	     
	     var divElements = document.getElementById("header").innerHTML;
	     divElements+= document.getElementById("depotwisecausesummary").innerHTML;
    ...
    function tabletoExcel(btnExport){     
    	/*  document.getElementById("mapshow").style.visibility='hidden'; 
    		$(".mapClass").hide(); */
             ...
             inputHTML += "</tr>";
            inputHTML += "<tr>";
             inputHTML += "<th  align='Center'colspan='8'>Depot Wise & Cause Wise Summary</th>";
             inputHTML += "</tr>";
     ...
     try{
 		$("#depotwisecausesummaryTable table").each(function(){
 			noOfTableExist++;
 		});
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Depot And Cause Wise Summary Report
							</div>
						</div>
...
<!-- 						
			...
			<!-- END PAGE CONTENT-->
				...
				<div class="portlet-body" id="depotwisecausesummary" style="display: none; visibility: hidden;">
						
						
                           
                                   <table class="table table-striped table-bordered table-hover"
								id="depotwisecausesummaryTable">
 ...
 <h3 style="margin-left:350px;">Depot Wise & Cause Summary</h3>
<br />

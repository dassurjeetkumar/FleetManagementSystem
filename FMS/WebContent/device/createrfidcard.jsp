...
<script>
	...
	function goView()
	{
		document.forms[0].action = 'rfidcardlist.action';
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create RFID Card
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
							...
							<!-- BEGIN FORM-->
							<form action="createRFIDCardAction.action"  method="post" class="form-horizontal">

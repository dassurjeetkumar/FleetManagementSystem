...
function getData(){
	...
	$('#verifonependingetm').attr("style", "display:''");
	
    table = $('#verifonependingetmTable');
    var oTable = table.dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "ajaxgetverifonepending.action?divid="+divid+"&depot="+depotid+"&startdate="+strdate+"&enddate="+enddate,
	...
	jQuery('#verifonependingetmTabletable_wrapper .dataTables_filter input').addClass(
			"form-control input-xsmall input-inline"); // modify table
	// search input
	jQuery('#verifonependingetmTabletable_wrapper .dataTables_length select').addClass(
...
function printDiv() {     
	  document.getElementById("verifonependingetm").style.visibility='visible';  
	     document.getElementById("header").style.display='block';
	     document.getElementById("header").style.visibility='visible'; 
	    
	     
	     var divElements = document.getElementById("header").innerHTML;
	     divElements+= document.getElementById("verifonependingetm").innerHTML;
    ...
    function tabletoExcel(btnExport){     
    	/*  document.getElementById("mapshow").style.visibility='hidden'; 
    		$(".mapClass").hide(); */
             ...
             inputHTML += "</tr>";
            inputHTML += "<tr>";
             inputHTML += "<th  align='Center'colspan='8'>Verifone Repair Pending Etm List</th>";
             inputHTML += "</tr>";
     ...
     try{
 		$("#verifonependingetmTable table").each(function(){
 			noOfTableExist++;
 		});
    ...
    downloadLink.download = "verifone repair pending etms.xls";
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Verifone Repair Pending Etm  Report
							</div>
						</div>
...
<!-- 						
			...
			<!-- END PAGE CONTENT-->
				...
				<div class="portlet-body" id="verifonependingetm" style="display: none; visibility: hidden;">
						
						
                           
                                   <table class="table table-striped table-bordered table-hover"
								id="verifonependingetmTable">
 ...
 <h3 style="margin-left:350px;">Verifone Pending Etm  Report</h3>
<br />

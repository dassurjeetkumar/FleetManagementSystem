...
function getSummaryDetails(){
	...
	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "get",
            url: '<%=request.getContextPath()%>/AjaxCustomerSummary.action?startdate='+dd1+'&enddate='+dd2,
				...
				<div class="col-md-12">
					...
					<div class="form-body">
						...
						<div class="form-group">
								...
								<div class="form-group">
										<button type="submit" class="btn green" onClick="getSummaryDetails()">Submit</button>

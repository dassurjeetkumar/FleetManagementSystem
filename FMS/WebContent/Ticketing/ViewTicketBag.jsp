...
<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Ticket Bag Master</h4>
						</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Ticket Bag
							</div>
							<div class="actions">
			...
			<%if(delete.equalsIgnoreCase("Y")){ %>
						...
						<input type="hidden" name="requestType" id="requestType" value="text"/>
							<table class="table table-striped table-bordered table-hover" id="viewTicketBag">
		...
		if (cnt == 0) {
			...
			bootbox.confirm("Are you sure you want to delete?",
					function(result)
					{
						...
						if (result == true) 
						{
			document.forms[0].action = 'deleteTicketBag.action?ticketbagid='
				+ val;
	...
	function editTicketBag(){
				...
				if (cnt == 0) {
					...
					//alert(val);
					if(isEligibleForOpertion(val)){
					document.forms[0].action = 'editTicketBag.action?id='+ val;
					document.forms[0].submit();
					}else{
						bootbox.alert("Please Select Valid Record");
					}
	...
	/* function editShiftType()
	 ...
	 {
		 document.forms[0].action = "createTicketBag.action";
		 document.forms[0].submit();
	 }

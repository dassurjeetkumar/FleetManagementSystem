...
function check()
{
	if(document.getElementById("orgmaster").value=="0")
	{
	bootbox.alert("Depot/Division Name Cannot be Empty");
	return false;
	}
	
	if(document.getElementById("orgname").value=="")
	{
	bootbox.alert("Bus Station	Name Cannot be Empty");
	return false;
	}
	if(document.getElementById("orgcode").value=="")
		{
		bootbox.alert("Bus Station	Code Cannot be Empty");
		return false;
		}
	if(document.getElementById("orgnamekanada").value=="")
	{
	bootbox.alert("Bus Station	Name(Kannada) Cannot be Empty");
	return false;
	}
	if(document.getElementById("orgcodekanada").value=="")
		{
		bootbox.alert("Bus Station	Code(Kannada) Cannot be Empty");
		return false;
		}
	
	document.getElementById("form1").action="createnewBusstation.action";
	         ...
	         $.ajax({
	             ...
	             url: '<%=request.getContextPath()%>/deviceNameAjaxActionVen!getVendorName',
						success : function(result) {
							document.getElementById('orgmaster').innerHTML = result;
						}
					})
		}
	}
	function getOrgType(val)
	{
		//alert(val);
		document.getElementById("paredntid").value=val;
	
	         $.ajax({
	             type: "post",
	             url: '<%=request.getContextPath()%>/OrgAjaxAction!getOrgTypeName?id='+ val,
					success : function(result) {
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet  box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create New Bus Station
							</div>
						...
						<div class="portlet-body form">
							...
							<form action="" id="form1" method="post"
								...
								<div class="form-body">
									...
									<input type="hidden" id="paredntid" name="orgchart.orgType.org_type_id" value="4"/>
...
<!-- 												name="orgchart.org_name_kannada"  maxlength="100" -->
<!-- 												> -->
												<input class="form-control input-lg" placeholder=""
...
<!-- 												name="orgchart.org_code_kannada" > -->
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control"
											id="website" name="orgchart.website" maxlength="100"
											value='<s:property value="orgchart.website"/>'>
									</div>
									<s:if test="fieldErrors.get('website').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('website').get(0)" /></span>
											</s:if>
								</div>
								...
								<div class="form-group">
									<label class="control-label col-md-3">Bus Station
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
										<input type="text" class="form-control" maxlength="20"
											id="website" name="orgchart.country"
								...
								<%-- <div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Longitude:<font color="red"></font></label>

										<div class="col-md-4">
											<input type="text" class="form-control"
												id="logitude" name="orgchart.logitude" value="0.0" readonly="readonly"
												value='<s:property value="orgchart.logitude"/>'>
										</div>
									</div>
									<s:if test="fieldErrors.get('logitude').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('logitude').get(0)" /></span>
											</s:if>
								</div> --%>
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control"
												id="landmark" name="orgchart.landmark" maxlength="20"

...
function check()
{
	...
	document.getElementById("form1").action="saveeditBus.action";
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Bus Station
							</div>
						...
						<div class="portlet-body form">
							...
							<!-- BEGIN FORM-->
							<form action="saveeditBus.action" id="form1"  method="post"
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
<!-- 											<input type="text" class="form-control" id="orgname" maxlength="100" -->
<!-- 												name="orgchart.org_name" -->

...
function check()
{
	...
	document.getElementById("form1").action="saveeditDiv.action";
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Division
							</div>
						...
						<div class="portlet-body form">
							...
							<form action="" id="form1" method="post"
								...
								<input type="hidden" name="orgchart.org_chart_id" value="<s:property value="orgchart.org_chart_id"/>"/>
								
								<input type="hidden" id="paredntid" name="orgchart.parent_id" value="00000"/>
...
<%-- 												name="orgchart.org_name_kannada" value='<s:property value="orgchart.orgnamekannada"/>' --%>
<!-- 												 > -->
...
<%-- 												name="orgchart.org_code_kannada" value='<s:property value="orgchart.orgcodekannada"/>' --%>
<!-- 												> -->
										...
										</div><s:if test="fieldErrors.get('org_code_kannada').size() > 0">
								...
								<%-- <div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<textarea rows="3" class="form-control" id="address" maxlength="200"
												name="orgchart.address">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" maxlength="20"
											id="phone_number" name="orgchart.phone_number"
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
										<input type="text" class="form-control"
											id="city" name="orgchart.city" maxlength="20"
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control"
												id="state" name="orgchart.state" maxlength="20"
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
										<input type="text" class="form-control"
											id="country" name="orgchart.country" maxlength="20"
								...
								<%-- <div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Latitude:<font color="red"></font></label>

										<div class="col-md-4">
											<input type="text" class="form-control"
												id="latitude" name="orgchart.latitude" value="0.0" readonly="readonly"
						...
						<form class="form-horizontal" role="form" action="#" method="post">
							...
							<div style="position: center" >
								<center><button type="button" class="btn green"
									...
									onclick="clearMapForm()" id="clearMap" onclick="clearForm()" >Clear Map</button>

...
function check()
{
	...
	{
	bootbox.alert("Depot Name Cannot be Empty");
	return false;
	}
	if(document.getElementById("orgcode").value=="")
		{
		bootbox.alert("Depot Code Cannot be Empty");
		return false;
		}
	if(document.getElementById("orgnamekanada").value=="")
	{
	bootbox.alert("Depot Name(Kannada) Cannot be Empty");
	return false;
	}
	if(document.getElementById("orgcodekanada").value=="")
		{
		bootbox.alert("Depot Code(Kannada) Cannot be Empty");
		return false;
		}
	
	document.getElementById("form1").action="saveeditDepot.action";
...
google.setOnLoadCallback(onLoad);
	...
	function goView() {
		document.forms[0].action = 'AllDepots.action';
		document.forms[0].submit();
	}
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Depot
							</div>
							...
							<form action="" id="form1" method="post"
								...
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Depots
...
<!-- 										</div> -->
								...
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Depot
...
<%-- 												value='<s:property value="orgchart.orgcodekannada"/>'> --%>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" maxlength="100"
											id="website" name="orgchart.website"
								...
								<div class="form-group">
									<label class="control-label col-md-3">Depot

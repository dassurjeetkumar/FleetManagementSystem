...
function check()
{
	...
	document.getElementById("form1").action="createnewDepots.action";
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet  box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create New Depot
							</div>
						...
						<div class="portlet-body form">
							...
							<form action="" id="form1" method="post"
								...
								<div class="form-body">
									...
									<input type="hidden" id="paredntid" name="orgchart.orgType.org_type_id" value="3"/>

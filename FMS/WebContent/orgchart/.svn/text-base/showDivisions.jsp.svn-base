				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Divisions
							</div>
							<div class="actions">
							 ...
							 <table class="table table-striped table-bordered table-hover"
								...
								<thead>
									<tr>
										...
										<th>Divisions Name(Kannada)</th>
										<th>Divisions Code</th>
										<th>Divisions Code(Kannada)</th>
										<th>Corporation Name</th>
										<th>Divisions Website</th>
										<th>Divisions Address</th>
										<th>Divisions Phone Number</th>
										<th>City</th>
										<th>State</th>
										<th>Country</th>
     									<th>Landmark</th>
...
<%}%>
	...
	function callEdit(){
		...
		if (cnt == 0) {
			...
			/* document.forms[0].action = "editdivision.action?orgid="+ val;
	...
	function callCreate() {
		document.forms[0].action = "createdivision.action";
		document.forms[0].submit();
	}
	$(document).ready(function() {
		   window.history.pushState("","", "AllDivision.action");
...
<form name="form1" id="form1" action="editdivision.action" method="POST">
<input type="hidden" name="orgid" id="orgid" value=""/>
</form>
<form name="form2" id="form2" action="deleteDiv.action" method="POST">

...
<script>
	...
	function initialize() {
		...
		var geoString = window.opener.document.getElementById('geodata').value;
		if (geoString != "") {
			...
			for ( var x = 0; x < arr.length - 1; x++) {
				...
				if (x == 0) {
					map.setCenter(new google.maps.LatLng(finalarr[0],
							finalarr[1]));
				}
			}
...
// 	  
		window.opener.document.getElementById('geodata').value = "";
...
<body>
	...
	<form class="form-horizontal" role="form" action="#" method="post">
		...
		<div style="position: center">
			<center>
				<button type="button" onclick="submitMapForm()" class="botton">Save</button>
				<button type="button" class="botton" onclick="clearMapForm()"
					id="clearMap">Clear Map</button>
				<button aria-hidden="true" data-dismiss="modal" class="botton"
					onclick="closeWin()">Cancel</button>
			</center>

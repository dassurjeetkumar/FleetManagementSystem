				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body form">
							...
							<form action="updateAd.action" class="form-horizontal"
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											...
											<input type="hidden" name="advetisement.advertisement_id"
												id="advertisement_id"
												value="<s:property value="advetisement.advertisement_id" />">
										...
										<div class="col-md-4">
											<div class="input-group">
												...
												<select class="select2_category form-control"
													...
													style="width: 200px;">
													<option
														value="<s:property value="advetisement.cust.id" />">
														<s:property value="advetisement.cust.name" />
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Start Date<sup><font color="red">*</font></sup></label>
										<div class="col-md-3">
											<div class="input-group input-medium date date-picker"
												data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
												<input type="text" class="form-control" readonly
													name="advetisement.start_date" id="startdate"
													value="<s:property value="advetisement.start_date"/>">
													<s:if
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<div class="input-group input-medium date date-picker"
												data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
												<input type="text" class="form-control" readonly
													name="advetisement.end_date" id="enddate"
													value="<s:property value="advetisement.end_date"/>">
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													...
													<option
														value="<s:property
															value="advetisement.advetisetype.advertisement_type_id" />"><s:property value="advetisement.advetisetype.advertisement_type_name" />
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											...
											<select class="form-control" name="advetisement.status"
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Duration<sup><font color="red">*</font></sup></label>
										<div class="col-md-3">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Frequency<sup><font color="red">*</font></sup></label>
										<div class="col-md-3">
											...
											Hour</label>
													<div class="col-md-9">
														<div class="radio-list">
															<label>
															<input type="radio" id="Y" name="advetisement.display_peak_hour" value="1" checked="checked"/>
															Yes </label>
															<label>
															<input type="radio" id="N" name="advetisement.display_peak_hour" value="0"/>
															No </label>
												...
												<script>
															...
															var airtime= "<s:property value="advetisement.display_peak_hour"/>";
															if (airtime != undefined) {
																if (airtime == "Yes"
																		|| airtime == "Yes") {
																	document
																			.getElementById("Y").checked = "checked";
																} else {
																	document
																			.getElementById("N").checked = "checked";
																}
															} 
												</script>
									<%-- <div class="form-group">
										...
										<div class="col-md-3">
											...
											<div class="input-group date form_datetime">
												<input type="text" size="16" readonly
													name="advetisement.airtime" id="startdate"
													class="form-control"

...
function goView() {
	document.forms[0].action = 'showOnlineDepotGprs.action?ticket_date=<s:property value="ticketDate" />&ticketdate=<s:property value="ticketDate" />&depotId=<s:property value="depotId" />&divisionId=<s:property value="divisionId" />';
							...
							<tbody>
								...
								<s:iterator value="showWaybill" var="trips" status="ctr">
									...
									<tr>
										...
										<td align="center"><a href='ShowLcWaybillWiseDayWise.action?waybillno=<s:property value="waybillNo" />&ticketdate=<s:property value="ticketDate" />&depotId=<s:property value="depotId" />&divisionId=<s:property value="divisionId" />&tripno=<s:property value="tripno" />&shiftno=<s:property value="shift_No" />'><s:property value="waybillNo" /></a></td>
										...
										<td align="center">
<%-- 										<a href='showOnlineWaybillsLCwaybillwise.action?waybillno=<s:property value="waybillNo" />&ticketdate=<s:property value="ticketDate" />&depotid=<s:property value="depotId" />'><s:property value="noOfTickets" /></a> --%>
										<s:property value="noOfTickets" />
										</td>
									</tr>
								</s:iterator>
								<tr>

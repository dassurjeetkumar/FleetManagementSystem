...
function goView() {
	document.forms[0].action = 'Showlcdepotwaybill.action?ticket_date=<s:property value="ticketDate" />&depotId=<s:property value="depotId" />';
							...
							<tbody>
								...
								<s:iterator value="showWaybill" var="trips" status="ctr">
									...
									<tr>
										...
										<td align="center">
										<%-- <a href='showOnlineWaybillsGprsTripwise.action?

				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Concession 
							</div>
							<div class="actions">
							<%if(create.equalsIgnoreCase("Y")){ %>
								<a href="#" class="btn green" id="addConcession"
									onclick="callCreate()"> <i class="fa fa-plus"></i> Create
								</a> 
								<%}%>
<%if(edit.equalsIgnoreCase("Y")){ %>
								<a href="#" class="btn blue" id="editConcession"
									> <i class="fa fa-pencil"></i>
									Edit
								</a>
								<%}%>

<%if(delete.equalsIgnoreCase("Y")){ %> <a href="#" class="btn red" id="deleteConcession"
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right ">
										...
										<%if(status.equalsIgnoreCase("ACTIVE")){ %>
											<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=CONCESSIONRPT'">
...
<%}%>
	...
	<script>
					...
					.click(
							function() {
								...
								if (cnt == 0) {
									...
									//alert(val);
									/* document.forms[0].action = 'ConcessionAction!edit?cid='+ val;
					...
					.click(
							function() {
								...
								if (cnt == 0) {
									...
									/* document.forms[0].action ='DeleteConcessionAction.action?cid='+ val ;
									document.forms[0].submit(); */
			...
			function callCreate() {
				document.forms[0].action = "ConcessionAction!add";
				document.forms[0].submit();
			}
			
			$(document).ready(function() {

				window.history.pushState("", "", "ConcessionAction!view");
...
<form name="form1" id="form1" action="DeleteConcessionAction.action" method="POST">
 	<input type="hidden" name="cid" id="did" value="" /> 

 </form>
<form name="form2" id="form2" action="ConcessionAction!edit" method="POST">

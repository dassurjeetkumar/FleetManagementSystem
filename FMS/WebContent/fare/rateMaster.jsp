  ...
  <script>
			...
			function callEdit(btn) {
				...
				if (cnt == 0) {
					...
					if (btn == 1) {
						/* document.forms[0].action = 'RateMasterAction!edit?id='
								+ val;
						...
						document.forms[0].submit(); */
						if(isEligibleForOpertion(val)){
						document.getElementById("eid2").value = val;
			...
			function callDelete() {
					...
					if (cnt == 0) {
						...
						//document.forms[0].action ='RateMasterAction!deleteRate?id='+ val;
						//document.forms[0].submit();
			...
			function callCopy() {
				...
				if (cnt == 0) {
					...
					$("input[type='checkbox']:checked").each(function() {
						...
						/* document.forms[0].action = 'RateMasterAction!rateDetail?id='+ val;
						document.forms[0].submit(); */
						if(isEligibleForOpertion(val)){
			...
			$(document).ready(function() {
				...
				window.history.pushState("", "", "RateMasterAction.action");
...
<div class="page-content-wrapper">
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Rate Master
							</div>
							<div class="actions">
							<%-- <s:if test="formType==1"> --%>
							<%if(create.equalsIgnoreCase("Y")){ %>
							    <a href="RateMasterAction!add" class="btn green"  id="add"> <!-- //onclick="callEdit()" -->
								<i class="fa fa-plus"></i> Create </a>
								<%}%>
								<%if(edit.equalsIgnoreCase("Y")){ %>
								<a href="#" class="btn blue"  id="edits" onclick="callEdit(1)"> 
  ...
  <%}%>
								...
								<a href="#" class="btn red"  id="deletes" onclick="callDelete()"> <!-- onclick="callDelete()" -->
							...
							<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right ">
										...
										<%if(status.equalsIgnoreCase("ACTIVE")){ %>
											<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=RATEMASTERRPT'">
	...
	<form name="form1" id="form1" action="RateMasterAction!deleteRate" method="POST">
 	<input type="hidden" name="id" id="did" value="" /> 

 </form>
<form name="form2" id="form2" action="RateMasterAction!edit" method="POST">
	<input type="hidden" name="id" id="eid" value="" />

</form>

<form name="form3" id="form3" action="RateMasterAction!rateDetailEdit" method="POST">
	<input type="hidden" name="id" id="eid2" value="" />

</form>

<form name="form4" id="form4" action="RateMasterAction!rateDetail" method="POST">

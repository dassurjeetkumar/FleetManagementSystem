...
$(document).ready(function() {
	...
	window.history.pushState("", "", "LuggageTypeAction!add");
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create Luggage Type
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="AddLuggageTypeAction.action" class="form-horizontal" method="post">
							  ...
							  <div class="form-group">
										...
										<div class="col-md-3">
											<select class="form-control" name="luggageType.status" >

				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Revenue Type 
							</div>
							<div class="actions">
							<%if(create.equalsIgnoreCase("Y")){ %>
							
								<a href="#" class="btn green" id="addRevenue"
									onclick="callCreate()"> <i class="fa fa-plus"></i> Create
								</a><%}%>
                           <%if(edit.equalsIgnoreCase("Y")){ %> 
                             <a href="#" class="btn blue" id="editRevenue"
                        ...
                        <%if(delete.equalsIgnoreCase("Y")){ %>
								...
								<a href="#" class="btn red" id="deleteRevenue"
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right ">
										...
										<%if(status.equalsIgnoreCase("ACTIVE")){ %>
											<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=REVENUETYPERPT'">
	...
	<script>
					...
					.click(
							function() {
								...
								if (cnt == 0) {
									...
									//alert(val);
									/* document.forms[0].action = 'RevenueTypeAction!edit?cid='+ val;
			...
			function() {
				...
				if (cnt == 0) {
					...
					/* document.forms[0].action ='DeleteRevenueTypeAction.action?cid='+ val ;
					document.forms[0].submit(); */
			...
			function callCreate() {
				document.forms[0].action = "RevenueTypeAction!add";
				document.forms[0].submit();
			}
			
			$(document).ready(function() {

				window.history.pushState("", "", "RevenueTypeAction!view");
...
<form name="form1" id="form1" action="DeleteRevenueTypeAction.action" method="POST">
 	<input type="hidden" name="cid" id="did" value="" /> 

 </form>
<form name="form2" id="form2" action="RevenueTypeAction!edit" method="POST">

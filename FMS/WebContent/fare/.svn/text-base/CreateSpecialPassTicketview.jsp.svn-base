...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Create Special Pass Ticket
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="createspecialPassTicketAction.action" class="form-horizontal" method="POST"  name ="frm" >
						
												<div class="form-group">
													<label class="col-md-3 control-label">Service Type :</label>
													<div class="col-md-2">
													<s:select list="servicetype" id="type" name="servicetypelist"  cssClass="form-control input-medium select2me" ></s:select>
								</div>
												</div>
												<div class="form-group">

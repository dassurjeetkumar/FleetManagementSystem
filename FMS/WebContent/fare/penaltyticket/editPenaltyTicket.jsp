...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="penaltyTicket.status"/>');
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Penalty Ticket Type
							</div>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><span id="integerVal"></span></font>
							...
							<form action="EditPenaltyTicketAction.action" class="form-horizontal" method="post">
								<font color="red"><s:actionerror/></font>  
								<font color="red"><span id="integerVal"></span></font>
							
								
								<div class="form-group">
								<label class="col-md-3 control-label">Penalty Id:</label>
								<div class="col-md-4">
									<input type="text" name="penaltyTicket.id" readonly="readonly" class="form-control" value="<s:property value='penaltyTicket.id'/>" />
								</div>
							    </div>
							   ...
							   <div class="form-group">
										...
										<div class="col-md-3">
											<select class="form-control" name="penaltyTicket.status"  id="status">

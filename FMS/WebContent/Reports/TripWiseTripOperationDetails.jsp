...
function getDepot(){
	 ...
	 if (var1 <= var2){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getTripWiseTripData.action?endate='+dd2+'&scheduleNo='+scheduleNo+'&date='+dd1+'&depotId='+depotId+'&divId='+divId,
            success: function(result) {
            	$('#pageLoader').hide();
//             	$('#scheduleDetail').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Trip Wise % Of Trip Operation Report
							</div>
						</div>

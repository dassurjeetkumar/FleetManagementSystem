...
//		alert(depot+scheduleno);
  ...
  var d3=Date.parse(var2);
    ...
    $.ajax({
        ...
        type: "get",
        url: '<%=request.getContextPath()%>/AjaxScheduleWiseEarning.action?startdate='+dd1+'&enddate='+dd2+'&schedule='+scheduleno+'&divisionlist1='+division+'&depotlist1='+depot,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Schedulewise Earnings Report 
							</div>
						</div>
						...
						<div class="form-group">
								...
								<select id="scheduleid" name="schedule"  class="select2-container select2_category form-control" >
											<s:iterator value="schedulelist" >
												<option id="<s:property   value="schedule_id" />" value='<s:property value="schedule_id" />'>
													<s:property value="scheduleNumber" />
												</option>
											</s:iterator>
										</select>
										<script> 
 											var scheduleno ="<s:property value='schedule'/>";
 											if(scheduleno!=""){ 
 												document.getElementById(scheduleno).selected= true; 
 											} 
 											getDepot();
										</script> </div>
									</div>
...
// 													}
   	      ...
   	      try{
   	  	    ...
   	  	    console.log("ExceptionCaught : " + err);
   	            ...
   	            downloadLink.download = "Schedulewise Earnings Report";

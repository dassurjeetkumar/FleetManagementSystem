...
function printDiv() {     
	...
	function getSummary()
	{
		...
		$('#pageLoader').show();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxDepotwiseScheduleSummary.action?divison='+ divisonNo+'&startDate='+startDate+'&enddate='+endDate,
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							DEPOT WISE SCHEDULE SUMMARY <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Depot Wise Schedule Summary Report
							</div>
...
<!-- 								<div class="col-md-4"> -->
												<div class="input-group input-medium date date-picker"
													...
													<input id="startDate" class="form-control"
														...
														name="rateMaster.effectiveStartDate"
...
<!-- 								</div> -->
							...
							<div class="input-group input-medium date date-picker"
								...
								<div align="Center">
								<button type="button" class="btn green" onclick="getSummary()" style="position: static;">Submit</button>	
								</div>
	...
	<script type="text/javascript">
      function tabletoExcel(btnExport){     
		...
		var divElements = document.getElementById("tripstatus").innerHTML;
			...
			downloadLink.download = "Early Duty End From Halting Location Report.xls";

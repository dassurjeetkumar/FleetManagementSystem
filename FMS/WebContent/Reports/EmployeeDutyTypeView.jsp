...
<%-- 		<%if (access.equalsIgnoreCase("Y")){%> --%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Employee Duty Type   <small></small>
					</h3>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body" id="dutytypeview">
	...
	document.forms[0].action = 'editemployeeDutyType.action?val='+val,
	...
	function callCreate() {
		document.forms[0].action = "employeeDutyType.action";
		document.forms[0].submit();
	}
	...
	$(document).ready(function() {
		getData();
		getheader();
		   window.history.pushState("","", "employeeDutyTypeview.action");
	 ...
	 function getData(){
		...
		// alert(orgchartdid);
	     $('#employeedutytypeView').dataTable({
				...
				"bProcessing" : true,
				"bServerSide" : true,
				"sAjaxSource" : "employeeDutyTypeviewList.action?orgchartdid="+ orgchartdid,
			...
			jQuery('#employeedutytypeView_wrapper .dataTables_filter input').addClass("form-control input-small input-inline"); // modify table search input
	  jQuery('#employeedutytypeView_wrapper .dataTables_length select').addClass("form-control input-xsmall input-inline"); // modify table per page dropdown
	     }
	</script>
	 <!--  ended by rama -->
</form>
...
function printDiv() {     
    ...
    function tabletoExcel(btnExport){     
    	/*  document.getElementById("mapshow").style.visibility='hidden'; 
    		$(".mapClass").hide(); */
             ...
             inputHTML += "</tr>";
            inputHTML += "<tr>";
             inputHTML += "<th  align='Center'colspan='8'>Employee Duty Type </th>";
             inputHTML += "</tr>";
     ...
     try{
 		$("#dutytypeview table").each(function(){
 			noOfTableExist++;
 		});
    ...
    downloadLink.download = "Employee Duty Type.xls";

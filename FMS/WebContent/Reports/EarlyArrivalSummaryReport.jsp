				...
				.dataTable(
						{
							...
							"iDisplayLength" : 20,
							"sAjaxSource" : "getEarlyArrivalReportSummaryData.action?scheduleNo="+depotNo+"&selectedDate="+choosenDate+"&range="+range,
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Early Arrival Summary Report
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>	<span><h4>Early Arrival Summary Report</h4></span>

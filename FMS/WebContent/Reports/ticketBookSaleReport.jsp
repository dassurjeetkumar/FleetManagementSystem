...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxTicketBookSaleReport.action?startdate='+dd1+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Ticket Book Sale Report
							</div>
						</div>
...
<!-- <table> -->
                   <form action="" method="post" class="form-horizontal">
 	                  ...
 	                  downloadLink.download = "Ticket Book Sale Report.xls"; 

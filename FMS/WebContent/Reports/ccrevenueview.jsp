			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i> CASUAL CONTRACT  SERVICE
						</div>
						<div class="actions">
							<a href="getCasualContractDetail" class="btn green"> 
										...
										<!-- <button type="button" class="btn default" onclick="callCancell()">Cancel</button> -->
													...
													<div class="portlet-body" id="createchart"
														...
														<table
															...
															<thead>
	<tr>
	<th>SN</th><th><center>Depot<br>No</center></th><th><center>Vehicle<br>No</center></th>
	<th><center>Logsheet<br> No</center></th><th><center>D Token</center></th><th><center>Departure<br>Date</center></th><th><center>Arrival<br>Date</center></th>
	<th><center>HRS/Day</center></th><th><center>Total KMS</center></th><th><center>Rent</center></th><th><center>OT or IT</center></th>
	<th><center>GST</center></th><th><center>Total <br>Amount</center></th>
...
function getdata(){
    ...
    var oTable = table.dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "ccrevenueview!getdata.action?depot="+depot+"&startdate="+startdate,

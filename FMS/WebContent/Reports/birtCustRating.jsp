...
//var dd2=$("#enddate").val();
	...
	var1=var1.split("/");
var1=var1[2]+"-"+var1[0]+"-"+var1[1];
	var var2=$("#datepicker1").val();
	var2=var2.split("/");
	var2=var2[2]+"-"+var2[0]+"-"+var2[1];
//alert(var1+""+var2);
...
<div   style="background-color: #428bca !important;height: 60px;">
	...
	<a style="color:white; " href="birtschedule"> Schedule
		...
		<input type="button" class="btn blue"  value="Customer FeedBack" onclick="window.location.href='birtcustfeedback'" />&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" class="btn blue"  value="Customer Response" onclick="window.location.href='birtcustresponse'" />&nbsp;&nbsp;&nbsp;&nbsp;
			
			<input type="button" class="btn blue"  value="Crew Ratings" onclick="window.location.href='birtcustrating'" />&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<span style="font-size: 13px;color:white; margin-top:10px;
    margin-bottom:10px;">
	<a   style="color:white;" href="getCustomerFeedBack">Back</a>
	</span>
	&nbsp;
...
<%
	...
	<form action="birtcustrating" method="post" id="submitid">
	
					<p>From Date: <input type="text" id="datepicker" name="fromdate" placeholder="pick here">
												To Date: <input type="text" id="datepicker1" name="todate" placeholder="pick here">

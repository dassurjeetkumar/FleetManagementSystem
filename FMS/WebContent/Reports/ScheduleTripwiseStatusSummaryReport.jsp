...
function getDepot(orgId){
		 ...
		 var val=document.getElementById('divisionlist').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getDepotAll?val=' + val,
...
function getShiftType(orgId){
		 var val=document.getElementById('depotlist1').value;
			 if(val!=0) {
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getShiftType?val=' + val,
				success : function(result) {
...
// 		 alert("from"+var1);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getScheduleTripwiseSummaryData.action?enddate='+dd2+'&startdate='+dd1+'&dutyType='+dutyType+'&depotlist1='+depotlist1+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Schedule Tripwise Status Summary Report
							</div>
						</div>
                               ...
                               <div class="form-group">
									...
									<div class="col-md-3">
										<select list="depotlist" id="depotlist1" class="select2_category form-control" name="depotlist1"
 											onchange="getShiftType(this.value)"> 

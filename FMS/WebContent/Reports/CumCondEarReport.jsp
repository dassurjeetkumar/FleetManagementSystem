	 ...
	 //$('#select2-chosen-3').html("Select");
		//alert('Here');
		 ...
		 var val=document.getElementById('depotlist1').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getCondTokenNo?val=' + val,
				success : function(result) {
...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxCondWiseEarningReport.action?enddate='+dd2+'&startdate='+dd1+'&depotlist1='+depotlist1+'&ctoken='+ctoken+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
...
<!--  								</div>   -->
							...
							<div class="form-group">
							  <label class="control-label col-md-3">From Month:</label>
								<div class="col-md-3">
 							...
 							<div class="form-group">
							<label class="control-label col-md-3">To Month:</label> 
 								<div class="col-md-3"> 
 								<div class="input-group input-medium date date-picker" 
 															style="width: auto" data-date-format="mm-yyyy" 
 															data-date-viewmode="years" ><!-- data-date-start-date="+0d"> --> 

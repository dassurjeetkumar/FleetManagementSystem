	 ...
	 $('#select2-chosen-3').html("Select");
		//alert('Here');
		 ...
		 var val=document.getElementById('depotlist1').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getPassFromDepot?val=' + val,
				success : function(result) {
					document.getElementById('passlist1').innerHTML = result;
...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxDailyPassSale.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div+'&passlist1='+passlist1,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Daily Pass Sale Report Report
							</div>
						</div>
...
<!-- <table> -->
                           ...
                           <div class="form-body">
								...
								<div class="form-group">
									<label class="col-md-3 control-label">Depot<font
										color="red">*</font></label>
									<div class="col-md-4">
										<select list="depotlist" id="depotlist1" class="select2_category form-control" name="depotlist1"  onchange="getPass(this.value)"> 
							...
							<select list="passlist" id="passlist1" class="select2_category form-control" name="passlist1"
 											> 
											<option value="0">--select--</option>
 										</select> 
								<script></script>
				...
				<div class="form-group">
 	                  ...
 	                  downloadLink.download = "Daily Pass Sale Report.xls"; 

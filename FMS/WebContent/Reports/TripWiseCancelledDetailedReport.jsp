...
function getDepot1(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxTripWiseCancelledDetailedReport.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&schedulelist1='+schedulelist1+'&shiftid='+shiftid,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Tripwise % of Zero Revenue Report
							</div>
						</div>
...
//                                         }
 	                  ...
 	                  downloadLink.download = "Trip Wise Cancelled Details Report.xls"; 

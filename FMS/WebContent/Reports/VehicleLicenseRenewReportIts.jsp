...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxvehiclelicenserenewIts.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Fitness Certificate(FC) Renewal Report
							</div>
						</div>
                   ...
                   <form action="" method="post" class="form-horizontal">
                           <div class="form-body">
							 ...
							 <div class="form-group">
							  ...
							  <td><label class="control-label col-md-3">To Date:</label>
								<div class="col-md-4">
								<div class="input-group input-medium date date-picker"
															style="width: auto" data-date-format="dd-mm-yyyy"
															data-date-viewmode="years" ><!-- data-date-start-date="+0d"> -->
 	                  ...
 	                  downloadLink.download = "Fitness Certificate(FC) Renewal Report.xls"; 

...
//alert(divisionid);
		...
		$.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getdepotdetails1.action?startdate1='+startdate1+'&enddate1='+enddate1+'&divisionid='+divisionid,
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>DepotWise DriverWise KMPL Report 
						</div>

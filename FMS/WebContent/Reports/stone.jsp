	 ...
	 $('#select2-chosen-4').html("Select");
		//alert('Here');
		 ...
		 var val=document.getElementById('divisionlist').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/stone!getdepot?val=' + val,
	 ...
	 $('#select2-chosen-4').html("Select");
		 ...
		 /*  		 var shiftid=document.getElementById('shiftid').value;*/
	        ...
	        $.ajax({
	            ...
	            url: '<%=request.getContextPath()%>/stone!getScheduleNo?val=' + val,
				success : function(result) {
...
/* 	else if(scheduleid==0){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/stone!getSTTwoReport.action?startdate='+dd1+'&depotlist1='+depot+'&scheduleid='+scheduleid,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Day Wise Schedule Wise Cancellation Report
							</div>
						</div>

...
$('#pageLoader').show();
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxgetSListReport.action',
	           success: function(result) {
	        	   $('#pageLoader').hide();
// 	        	   alert("hi"+result);
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View S List Report
							</div>
							<div class="actions">
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>S LIST REPORT</th>";
  	             inputHTML += "</tr>";
//   	             inputHTML += "<tr>";
...
//   	             inputHTML += "</tr>";
  	             ...
  	             downloadLink.download = "S LIST REPORT.xls";

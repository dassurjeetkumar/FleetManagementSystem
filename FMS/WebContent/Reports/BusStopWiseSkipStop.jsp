	...
	<div class="page-content">
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
					Bus Stop Wise Skip Stop Report
				</h3>
			...
			<div class="col-md-12">
				<div class="portlet box grey-cascade">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-bars"></i> Bus Stop Wise Skip Stop Report
						</div>
						<!-- <div class="tools">
					...
					<label class="col-md-2 control-label">Bus Stop :</label>
													<div class="col-md-3">
														<input class="form-control" tabindex="1" id="projectsource" placeholder="Enter Bus Stop Name to Search" 
														 name="projectsource" type="text"	onkeyup="getRoute(this.value)"  onChange="getShow(this.value)" />
							...
							<div class="form-actions fluid">
							  ...
							  <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Bus Stop Wise Skip Stop Report</h4>
									<br />
...
//		 alert("");
	...
	if(hDiff>24){
		 bootbox.alert("Start Time and End Time should not be greater than 24 hours");
		return false;
	}
...
// alert("busStopId"+busStopId+"---"+busStopName);
			...
			$('#showBusStopWiseSkipStop').dataTable({
						"aLengthMenu" : [ [ 5, 15, 20, -1 ], [ 5, 15, 20, "All" ] // change
						                  
						],   
						
						"iDisplayLength" : 5,
						"sAjaxSource" : "getbusStopWiseSkipStop.action?startdate="+dd1+"&enddate="+dd2+"&busStopId="+busStopId,
	...
	jQuery('#showBusStopWiseSkipStop_wrapper .dataTables_filter input').addClass("form-control input-small input-inline"); // modify table search input
	jQuery('#showBusStopWiseSkipStop_wrapper .dataTables_length select').addClass("form-control input-xsmall input-inline");
...
//		alert(dd1);
	...
	alert("busStopId"+busStopId+"---"+busStopName);
	 ...
	 if( busStopId == "0" )
        {
            bootbox.alert("Please select Bus Stop Name");
           return false;
        }
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getbusStopWiseSkipStop.action?startdate='+dd1+'&enddate='+dd2+'&busStopId='+busStopId,
...
//             inputHTML += "<th colspan='7' align='left'>" + $("#startdate").val() + " to " + $("#endate").val() + "</th>";
            ...
            downloadLink.download = "Bus StopWise Skip Stop.xls";

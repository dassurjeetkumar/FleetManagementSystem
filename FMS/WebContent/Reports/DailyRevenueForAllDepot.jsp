...
// var divisionlist=document.getElementById('divisionlisi1').value;
alert("Hi");
// if(divisionlist=="null"){
// document.forms[0].action = 'getEtmDeviceHistory.action';
// 	document.forms[0].submit();
// window.location.href="AjaxDailyRevenueForAllDepot.action";
getData();
...
// 		if (d1 <= d3){
        ...
        $.ajax({
            ...
            type: "get",
            url: '<%=request.getContextPath()%>/AjaxDailyRevenueForAllDepot.action',
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>DAILY REVENUE OF ALL DEPOTS
							</div>
						</div>
...
//                                         $('#enddate').val(curr_date);
 	                  ...
 	                  downloadLink.download = "Daily Revenue For All Depot.xls"; 

...
//	      });
			...
			var mywindow = window.open("<%=request.getContextPath()%>/getCancelledDivisionDetails.action?startdate="+startdate+"&enddate="+enddate);
...
// 			if (d1 <= d3){
	        $.ajax({
	            ...
	            type: "get",
	            url: '<%=request.getContextPath()%>/AjaxcancelledKMReportITS.action?startdate='+startdate+'&enddate='+enddate,
	            success: function(result) {
	            	$('#pageLoader').hide();
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Cancelled KM Report(Corporation)
							</div>
							<!-- <div class="tools">
...
<!-- 								</div> -->
   ...
   function tabletoExcel(btnExport){     
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='13'>Cancelled KM Report</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "Cancelled KM Report.xls";

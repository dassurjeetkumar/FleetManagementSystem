...
//alert(enddate1);
		$.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getcanceldivisiondetails2.action?startdate1='+startdate1+'&enddate1='+enddate1,
...
function jsFunction1(divisionid){
	...
	var enddate1 = $('#enddate').val();	
		...
		var mywindow = window.open("<%=request.getContextPath()%>/getcancelldepotvehicledetails.action?divisionid="+divisionid+"&startdate1="+startdate1+"&enddate1="+enddate1);
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>DivisionWise Cancelled KM Report
						</div>

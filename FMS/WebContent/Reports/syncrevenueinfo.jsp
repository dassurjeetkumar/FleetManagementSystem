...
//alert();
	...
	$('#syncrevenueinfo').attr("style", "display:''");
	
    table = $('#syncrevenueinfoTable');
    ...
    var oTable = table.dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "ajaxgetsyncrevenueinfo.action?date="+strdate,
...
function printDiv() {     
	  document.getElementById("syncrevenueinfo").style.visibility='visible';  
	     document.getElementById("header").style.display='block';
	     document.getElementById("header").style.visibility='visible'; 
	    
	     
	     var divElements = document.getElementById("header").innerHTML;
	     divElements+= document.getElementById("syncrevenueinfo").innerHTML;
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Sync Revenue Info
							</div>
						</div>
...
<!-- 						
			...
			<!-- END PAGE CONTENT-->
				...
				<div class="portlet-body" id="syncrevenueinfo" style="display: none; visibility: hidden;">
						
						
                           
                           <table class="table table-striped table-bordered table-hover"
								id="syncrevenueinfoTable"  border='1' width="500" >
...
<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
<table  width="500" border='1' ><tr ><td  colspan='4'>
<center><div width="500px">
	<h3><span>Sync Revenue Info</span></h3>
</div></center>
</td></tr>

<tr><td align='center'colspan='4'><center><b><font size="2"><label>Date: </label></font><font size="2"><b><span id="startdat" style="text-align:left;margin-left:50px;"></span></font></b></center></td>
</table></div>
	...
	function tabletoExcel(btnExport){
    	 ...
    	 var divElements = document.getElementById("header").innerHTML;
        divElements =divElements+ document.getElementById("syncrevenueinfo").innerHTML;
        
        var noOfTableExist = 0;
        try{
    		$("#syncrevenueinfo table").each(function(){
    			noOfTableExist++;
    		});
  ...
  downloadLink.download = "Sync Revenue Info.xls"; 

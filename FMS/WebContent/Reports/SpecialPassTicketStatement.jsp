...
// 			alert("hello");
	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "get",
            url: '<%=request.getContextPath()%>/AjaxSpecialPassTicketReport.action?startdate='+dd1+'&enddate='+dd2+'&division='+division+'&depot='+depot,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Rs.35/-SPECIAL PASS TICKET STATEMENT
							</div>
						</div>
 	                  ...
 	                  downloadLink.download = "Special Pass Ticket Report.xls"; 

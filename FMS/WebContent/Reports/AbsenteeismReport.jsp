	...
	//	var scheduleNo=$("#scheduleId").val();
	 ...
	 if (var1 <= var2){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxAbsenteeismReport.action?enddate='+dd2+'&startdate='+dd1+'&depotlist1='+depotId+'&divisionlist1='+divId,
            success: function(result) {
            	$('#pageLoader').hide();
//             	$('#scheduleDetail').hide();
...
function printDiv() {     
	...
	var headerVal=" Absenteeism Report ";
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Absenteeism Report
							</div>
						</div>

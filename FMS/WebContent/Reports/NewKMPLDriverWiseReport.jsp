...
function getDriverToken()
{
 ...
 $.ajax({
     ...
     type: "POST",
     url: '<%=request.getContextPath()%>/getDepotDriver?val=' + val,
...
function getDepot(){
	 ...
	 if (var1 <= var2){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getKMPLDriverWiseNewReport.action?endate='+dd2+'&driverToken='+driverToken+'&date='+dd1+'&depotId='+depotId+'&divId='+divId,
            success: function(result) {
            	$('#pageLoader').hide();
...
function exportToExcel(btnExport){   
   ...
   downloadLink.download = "DriverWise KMPL  Report.xls";
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Driver Wise KMPL Report
							</div>
						</div>
                               ...
                               <div class="form-group">
									...
									<div class="col-md-3">
										<select list="depotlist" id="depotlist1" class="select2_category form-control" name="depotlist1"
 											onChange="getDriverToken(this.value)"> 
 								 ...
 								 <div class="form-group">
									<label class="col-md-3 control-label">Driver Token<font
										color="red">*</font></label>
									<div class="col-md-3">
										<select  id="driverToken" class="select2_category form-control" name="driverToken"> 

...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getCashCollectionDetails.action?enddate='+dd2+'&startdate='+dd1+'&depotId='+depotId+'&divId='+divId,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Userwise Auditing/Cash Collecting Report
							</div>
						</div>

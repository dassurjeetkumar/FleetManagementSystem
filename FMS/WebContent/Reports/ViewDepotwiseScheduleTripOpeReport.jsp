...
// 	        $('#pageLoader').show();
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxDepotwiseScheduleTripOpReport.action?startdate='+dd1+'&depotlist1='+depotlist1+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Depot Wise Schedule Trips Operated Report
							</div>
						</div>
	...
	<script type="text/javascript">
      function tabletoExcel(btnExport){     
		...
		var divElements = document.getElementById("ticketconsuptionid").innerHTML;
			...
			downloadLink.download = "Depot wise Schedule Trips Operated Report.xls";

...
// 		$("#tripstatus").show();
  ...
  $('#pageLoader').show();  
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
// 	        	   alert("hi"+result);
	                document.getElementById('formVDivisioneData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionKilometersReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionTripReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
	                document.getElementById('formVTripData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionFormDataReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionFormSummaryReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionKilomiterSummaryReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionTripSummaryReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionCrewSummaryReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionSummaryDataReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionSummary1Report.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxFormVDivisionSummary2Report.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Form V Report
							</div>
							<div class="actions">
					...
					<div class="portlet-body" id="route_deviation_id1"
						...
						<div class="portlet-body" id="scheduleprint" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="formVDivisioneData" style="max-height: 60px;">
			...
			<div class="portlet box blue">
					...
					<div class="portlet-body" id="route_deviation_id"
						...
						<div class="portlet-body" id="scheduleprint2" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="formVTripData" style="max-height: 60px;">

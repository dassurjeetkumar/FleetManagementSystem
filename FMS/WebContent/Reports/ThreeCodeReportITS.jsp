...
function getDepot1(){
	...
	if(div==0){
		alert("Please Select The Devision");
	}else if(depot==0){
		...
		alert("T0 Date Should Be greater Than Start Date");
		}else{
			$('#pageLoader').show();
        $.ajax({
        	
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxThreeCode.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Three Code Report
							</div>
						</div>
...
<!-- <table> -->
                   <form action="" method="post" class="form-horizontal">
                    <b>
 	                  ...
 	                  downloadLink.download = "Three Code Report.xls"; 

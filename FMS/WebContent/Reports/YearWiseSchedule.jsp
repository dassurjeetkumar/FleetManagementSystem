...
$(document).ready(function() {
 ...
 function printDiv1() {     
	    ...
	    try{
			$("#detailsOfSchedulesData table").each(function(){
				noOfTableExist++;
			});
			$("#detailsOfSchedulesData1 table").each(function(){
				noOfTableExist++;
			});
...
// 		validateflag=validateTripStatusReportFields(date,orderno);
...
// 		$("#tripstatus").show();
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxDetailsOfSchedulesReport.action',
	           success: function(result) {
	        	   $('#pageLoader').hide();
// 	        	   alert("hi"+result);
	                document.getElementById('detailsOfSchedulesData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxDetailsOfSchedulesDataReport.action',
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
	                document.getElementById('detailsOfSchedulesData1').innerHTML=result;
	                fixHeader();
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							YEAR WISE SCHEDULES REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Year Wise Schedules Report
							</div>
							<div class="actions">
...
<!-- 								</div> -->
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>YEAR WISE SCHEDULE REPORT</th>";
  	             inputHTML += "</tr>";
//   	             inputHTML += "<tr>";
...
//   	             inputHTML += "</tr>";
  	             ...
  	             downloadLink.download = "YEAR WISE SCHEDULE REPORT.xls";
...
<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Details Of Schedules
						</div>
						<div class="tools">
					...
					<div class="portlet-body" id="route_deviation_id1"
						...
						<div class="portlet-body" id="scheduleprint" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="detailsOfSchedulesData" style="max-height: 60px;">
				...
				<div class="portlet box blue">
					...
					<div class="portlet-body" id="route_deviation_id"
						...
						<div class="portlet-body" id="scheduleprint2" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="detailsOfSchedulesData1" style="max-height: 60px;">

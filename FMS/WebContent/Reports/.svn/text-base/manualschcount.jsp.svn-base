...
function getData(){
    ...
    var oTable = table.dataTable({
		...
		// set the initial value
		"iDisplayLength" : 5,
		"sAjaxSource" : "ajaxgetmanualschcount.action?startdate="+startdate+"&enddate="+enddate,
		"sPaginationType" : "bootstrap",
		"bDestroy" : true,
		"bSort" : true,
		"bFilter" : true,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Manual Schedule Summary Report
							</div>
						</div>
					...
					<!-- END EXAMPLE TABLE PORTLET-->
							...
							<div class="portlet-body" id="manualschcount"
														...
														<table
															...
															<thead>
	<tr>
	<th>SN</th><th><center>Depot</center></th><th><center>Total Audited<br>schedules</center></th>
	<th><center>Manual<br>Schedules</center></th><th><center>Manual %</center></th>

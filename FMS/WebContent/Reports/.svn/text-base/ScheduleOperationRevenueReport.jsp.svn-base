...
// 	alert("depotNo..."+depotNo+"....divisonNo...."+divisonNo+"....startdate...."+startdate+"....enddate...."+enddate+"...servicetype..."+servicetype);
...
// 			if (d1 <= d3){
	        $.ajax({
	            ...
	            type: "post",
	            url: '<%=request.getContextPath()%>/AjaxSchedueloperationRevenueReport.action?startdate='+startdate+'&enddate='+enddate+'&depotNo='+depotNo+'&divisonNo='+divisonNo+'&servicetype='+servicetype,
	            success: function(result) {
	            	$('#pageLoader').hide();
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							SCHEDULE OPERATION AND REVENUE REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Schedule Operation & Revenue Report
							</div>
							<!-- <div class="tools">
...
<div class="form-group">
										<label class="col-md-3 control-label">Service Type<font
											color="red">*</font></label>
										<div class="col-md-4">
											<s:select list="servicetypelist" id="servicetype" name="servicetype.service_type_id"
												cssClass="form-control select2me" headerKey="0"

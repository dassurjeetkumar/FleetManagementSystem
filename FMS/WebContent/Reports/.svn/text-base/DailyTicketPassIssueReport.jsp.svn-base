...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getDailyTicketPassIssueReportData.action?enddate='+dd2+'&startdate='+dd1+'&depotId='+depotId+'&divId='+divId,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Daily Ticket/Pass Issue Report
							</div>
						</div>
...
<!-- 						<div class="table-scrollable"> -->
  ...
  <form action="" method="post" class="form-horizontal">
					 ...
					 <div align='center'>
					<button type="submit" class="btn green" onClick="getDailyTicket()">Submit</button>

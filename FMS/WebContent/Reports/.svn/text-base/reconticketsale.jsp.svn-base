...
function getData(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/ajaxgetrecon.action?startdate='+dd1+'&enddate='+dd2,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Recon Of Ticket Sale 
							</div>
						</div>
...
//                                         }
 	                  ...
 	                  downloadLink.download = "Recon Of Ticket Sale.xls"; 

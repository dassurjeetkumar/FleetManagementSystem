...
$('#pageLoader').show();
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxgetWeeklyReport.action?startdate='+date+'&orderno='+orderno,
	           success: function(result) {
	        	   $('#pageLoader').hide();
// 	        	   alert("hi"+result);
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Weekly Report
							</div>
							<div class="actions">
...
<%--  										</select>  --%>
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>WEEKLY REPORT</th>";
  	             inputHTML += "</tr>";
  	             inputHTML += "<tr>";
  	             inputHTML += "<th colspan='2' align='left'>Date:</th>";
  	             inputHTML += "<th colspan='7' align='left'>" + $("#startdate").val() + "</th>";
  	             inputHTML += "</tr>";
  	             inputHTML += "</table>";
  	             ...
  	             downloadLink.download = "WEEKLY REPORT.xls";

...
//alert(enddate1);
		$.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getdivisiondetails2.action?startdate1='+startdate1+'&enddate1='+enddate1,
...
function jsFunction1(divisionid){
	...
	var enddate1 = $('#enddate').val();	
		...
		var mywindow = window.open("<%=request.getContextPath()%>/getdepotvehicledetails.action?divisionid="+divisionid+"&startdate1="+startdate1+"&enddate1="+enddate1);
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>DivisionWise VehicleWise KMPL Report
						</div>

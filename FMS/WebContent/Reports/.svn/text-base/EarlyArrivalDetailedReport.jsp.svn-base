...
<script type="text/javascript">
 ...
 function getDepot(orgId){
	...
	alert("depotNo..."+depotNo+"....divisonNo...."+divisonNo+"....startdate...."+startdate+"....enddate...."+enddate+"...time..."+time);
...
// 			if (d1 <= d3){
	        $.ajax({
	            ...
	            type: "post",
	            url: '<%=request.getContextPath()%>/AjaxEarlyArrivalDetailed.action?startdate='+startdate+'&enddate='+enddate+'&depotNo='+depotNo+'&divisonNo='+divisonNo+'&time='+time,
	            success: function(result) {
	            	$('#pageLoader').hide();
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Early Arrival Detailed Report
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="" method="post" class="form-horizontal">
								...
								<div class="form-group">
													<label class="col-md-3 control-label">Early Arrival Time :<span class="required"> * </span></label>
													<div class="col-md-4">
												<select class="form-control input-medium select2me" data-placeholder="Select..." id="time">
												<option value="1">>30min &< 60min</option>
												<option value="2">> 60min & <120min</option>
												<option value="3">>120min&<180min</option>
												<option value="4">>180min</option>
											</select>

	 ...
	 $('#select2-chosen-4').html("Select");
		//alert('Here');
		 ...
		 var val=document.getElementById('divisionlist').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/sttwoits!getPerticularDepotForDepot?val=' + val,
	 ...
	 $('#select2-chosen-4').html("Select");
		 ...
		 /*  		 var shiftid=document.getElementById('shiftid').value;*/
	        ...
	        $.ajax({
	            ...
	            url: '<%=request.getContextPath()%>/getScheduleFromDepot?val=' + val,
				success : function(result) {
	...
	document.getElementById("depoid").innerHTML = depot;
 	if(div==0){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getsttwoReportIts.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&scheduleid='+scheduleid+'&days='+days,
            success: function(result) {
            	$('#pageLoader').hide();
...
<!--                                      </div> -->
                       ...
                       <div class="form-group">
						...
						<!-- end -->
 	                    ...
 	                    divElements=divElements+divElements1;
 	                        var noOfTableExist = 0;
 	                        try{
 	                    		$("#ticketconsuptionid table").each(function(){
 	                    			noOfTableExist++;
...
<tr ><td  align='center' colspan='51'>
<center><div width="2210px">
		<font size="5"><span>ST--2</span></font></center><br><center><b><font size="5">Depot:<span id="depoid" ></span></font></b>
</div></center>
</td></tr>

<tr><td align='center'colspan='26'><center><b><font size="4"><label>From Date: </label></font><font size="2"><b><span id="startdat" style="text-align:left;margin-left:50px;"></span></font></b></center></td>

<td align='center'colspan='25'><center><b><font size="4"><label>To Date: </label></font><font size="2"><b><span id="enddat" style="text-align:left;margin-left:50px;"></span></font></b></center></td></tr>
</table></div><BR /><BR />
</div>
	</head>
	</html>

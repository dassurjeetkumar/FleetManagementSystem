	...
	var d3=Date.parse(var2);
	 ...
	 $('#pageLoader').show();
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxConductorWisePercentETM.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Conductor Wise % Of ETM Usage Report
							</div>
						</div>
...
<!-- 						end -->
 	                  ...
 	                  downloadLink.download = "Conductor Wise % Of ETM Usage Report.xls"; 

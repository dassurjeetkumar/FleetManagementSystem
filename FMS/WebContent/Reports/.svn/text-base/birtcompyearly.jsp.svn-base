...
<%
	...
	<form action="birtcompyearly" method="post" id="submitid">
	
					<p>Year: <input type="text" id="datepicker" name="fromdate" placeholder="pick here">
												Comparison Year: <input type="text" id="datepicker1" name="todate" placeholder="pick here">
...
<iframe id="viewer"  class="page-content" style="height:600px;width:100%;border:1px solid #C0C0B8;"  src="<%=url%>">

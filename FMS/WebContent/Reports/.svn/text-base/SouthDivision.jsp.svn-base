...
// });
 ...
 function printDiv1() {     
	    ...
	    try{
			$("#southDivisioneData table").each(function(){
				noOfTableExist++;
			});
			$("#kilometersData table").each(function(){
				noOfTableExist++;
			});
			$("#southTripData table").each(function(){
				noOfTableExist++;
			});
...
$('#pageLoader').show();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
// 	        	   alert("hi"+result);
	                document.getElementById('southDivisioneData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionKilometersReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionTripReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
	                document.getElementById('southTripData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionFormDataReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionFormSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionKilomiterSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionTripSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionCrewSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionSummaryDataReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionSummary1Report.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxSouthDivisionSummary2Report.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
			 ...
			 <div id="pageLoader" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="false">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							SOUTH DIVISION FORM V REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View South Division Form V Report
							</div>
							<div class="actions">
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>SOUTH DIVISION REPORT</th>";
  	             inputHTML += "</tr>";
//   	             inputHTML += "<tr>";
...
//   	             inputHTML += "</tr>";
  	             ...
  	             downloadLink.download = "SOUTH DIVISION REPORT.xls";
...
<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>South Division Form V
						</div>
						<div class="tools">
					...
					<div class="portlet-body" id="route_deviation_id1"
						...
						<div class="portlet-body" id="scheduleprint" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="southDivisioneData" style="max-height: 60px;">
			...
			<div class="portlet box blue">
					...
					<div class="portlet-body" id="route_deviation_id"
						...
						<div class="portlet-body" id="scheduleprint2" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="southTripData" style="max-height: 60px;">

...
//alert(divisionid);
		...
		$.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getcancelldepotvehicledetails1.action?startdate1='+startdate1+'&enddate1='+enddate1+'&divisionid='+divisionid,
          success: function(result) {
       	 document.getElementById('depotss').innerHTML=result;
          }
     });
}
// function jsFunction1(divisionid){
// 	//var monthyear = $('#monthyear').val();	
// 	var startdate1 = $('#startdate').val();	
// 	var enddate1 = $('#startdate').val();	
	
<%-- 		var mywindow = window.open("<%=request.getContextPath()%>/getdepotdetails.action?divisionid="+divisionid+"&startdate1="+startdate1+"&enddate1="+enddate1); --%>
...
function jsFunction3(depotid){
	...
	//alert(depotid);
		...
		var mywindow = window.open("<%=request.getContextPath()%>/getcancelleddetailsname.action?depotid="+depotid+"&startdate1="+startdate1+"&enddate1="+enddate1);
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>DepotWise Cancelled KM Report
						</div>

...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxmonthlyTicketIssue.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Ticket Issue Register
							</div>
						</div>

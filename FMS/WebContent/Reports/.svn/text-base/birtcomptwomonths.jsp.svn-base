...
<html>
<head>
<title>Comparision 2Months</title>
<%--
...
<%
	...
	<form action="birtcomptwomonths" method="post" id="submitid">
	
					<p>Month: <input type="text" id="datepicker" name="fromdate" placeholder="pick here">
												Comparison Month: <input type="text" id="datepicker1" name="todate" placeholder="pick here">

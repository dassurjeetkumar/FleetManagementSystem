...
<div class="page-content-wrapper">
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i> Dedicated Service
						</div>
						<div class="actions">
							<a href="dedicated" class="btn green"> 
	...
	<th><center>Trip No</center></th><th><center>KMS Per<br>Day</center></th><th><center>Pass Rate</center></th><th><center>Amount/Day</center></th>
...
// 	var enddate=$("#enddate").val(); 
    ...
    var oTable = table.dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "dedicatedview!getdata.action?depot="+depot+"&startdate="+startdate,

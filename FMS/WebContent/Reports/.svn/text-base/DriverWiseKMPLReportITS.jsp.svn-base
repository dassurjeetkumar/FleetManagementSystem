...
//	      });
			...
			var mywindow = window.open("<%=request.getContextPath()%>/getALLdetails.action?startdate="+startdate+"&enddate="+enddate);
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Driver Wise  KMPL Report(Corporation)
							</div>
							<!-- <div class="tools">
...
<!-- 								</div> -->
          ...
          <script type="text/javascript"> 
 	                    ...
 	                    var html = document.getElementById("printid").innerHTML;
 	                   var downloadLink = document.createElement("a"); 
 	                  downloadLink.href = 'data:application/vnd.ms-excel,' + encodeURIComponent(html); 
 	                  downloadLink.download = "Driver Wise  KMPL Report.xls"; 

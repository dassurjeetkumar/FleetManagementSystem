...
function getDepot1(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxScheduleweekdaywiserevenue.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Schedules Weekday wise Revenue Report
							</div>
						</div>
...
//                                         }
 	                  ...
 	                  downloadLink.download = "Schedules Weekday wise Revenue Report.xls"; 

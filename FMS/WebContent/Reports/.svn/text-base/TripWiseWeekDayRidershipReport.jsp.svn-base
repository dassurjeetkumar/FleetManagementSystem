...
function getDepot1(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxTripWiseWeekDayRidership.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&scheduleid='+scheduleid+'&days='+days+'&shiftid='+shiftid+'&divisionlist1='+div+'&scheduletypeid='+scheduletypeid,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Trip Wise Weekday RiderShip Report
							</div>
						</div>
...
//                                         }
 	                  ...
 	                  downloadLink.download = "Trip Wise WeekDay RiderShip Report.xls"; 

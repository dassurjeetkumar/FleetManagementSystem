...
// 		{
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxEarlyDutyStartFromHalt.action?divison='+ divisonNo+'&selectedDate='+selecteddate,
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							Early Duty Start From Halting Location <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Early Duty Start From Halting Location Report
							</div>

	...
	// $('#select2-chosen-3').html("Select");
		alert('Here');
		 ...
		 var val=document.getElementById('depotlist1').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getDepotWiseSchdNo?val=' + val,
				success : function(result) {
...
// 	        return( true );
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxSchedEarReport.action?enddate='+dd2+'&startdate='+dd1+'&ctoken='+schdno+'&depotlist1='+depotlist1+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>ScheduleWise Earning Report
							</div>
						</div>

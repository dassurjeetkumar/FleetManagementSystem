	...
	var d1=Date.parse(var1);	 
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxDepotwiseSummeryofCardandCashTrasationReport.action?startdate='+dd1+'&enddate='+dd2,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>DepotWise Summary Of Cash And Card Trasations
							</div>
						</div>
...
//                                         }
 	                  ...
 	                  downloadLink.download = "DepotWise Summary Of Cash And Card Trasations.xls"; 

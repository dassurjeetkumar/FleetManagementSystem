...
function getSchedule()
{
 ...
 $.ajax({
     ...
     type: "POST",
     url: '<%=request.getContextPath()%>/getScheduleForDayWise?val=' + val,
		success : function(result) {
...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxDayWiseTripReportITS.action?startdate='+dd1+'&depot1='+depot+'&divisionlist1='+div+'&schedule='+schedulelist,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Day Wise Trip Report
							</div>
						</div>
...
<!-- <table> -->
                   <form action="" method="post" class="form-horizontal">
 	                  ...
 	                  downloadLink.download = "Day Wise Trip Report.xls"; 

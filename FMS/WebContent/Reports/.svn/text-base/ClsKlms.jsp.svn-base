...
function printDiv() {     
	  document.getElementById("clskm").style.visibility='visible';  
	     document.getElementById("header").style.display='block';
	     document.getElementById("header").style.visibility='visible'; 
	    
	     
	     var divElements = document.getElementById("header").innerHTML;
	     divElements+= document.getElementById("clskm").innerHTML;
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>CLASSIFICATION OF KILOMETERS
							</div>
						</div>
...
<!-- 						
					...
					<!-- END EXAMPLE TABLE PORTLET-->
							...
							<div class="portlet-body" id="clskm"
														style="display: none">
 ...
 <h3 style="margin-left:350px;">CLASSIFICATION OF KILOMETERS</h3>
<br />
<b><font size="2"><label>Date: </label></font><font size="2"><b><span id="startdate" style="text-align:left;margin-left:50px;"></span></font></b>
    ...
    function tabletoExcel(btnExport){     
    	/*  document.getElementById("mapshow").style.visibility='hidden'; 
    		$(".mapClass").hide(); */
             ...
             inputHTML += "</tr>";
            inputHTML += "<tr>";
             inputHTML += "<th  align='Center'colspan='8'>CLASSIFICATION OF KILOMETERS</th>";
             inputHTML += "</tr>";
    ...
    downloadLink.download = "CLASSIFICATION OF KILOMETERS.xls";

...
function printDiv() {     
	...
	function getHaltData()
	{
		...
		$('#pageLoader').show();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxEarlyDutyEndData.action?divison='+ divisonNo+'&selectedDate='+selecteddate,
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							Early Duty End From Halting Location <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Early Duty End From Halting Location Report
							</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select id="divisionlist"
											class="select2_category form-control" name="">

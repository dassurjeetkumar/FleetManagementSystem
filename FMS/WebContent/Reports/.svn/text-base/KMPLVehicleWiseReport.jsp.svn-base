...
// 			if (d1 <= d3){
	        $.ajax({
	            ...
	            type: "post",
	            url: '<%=request.getContextPath()%>/AjaxKMPLVehicleWiseReport.action?startdate='+startdate+'&enddate='+enddate+'&depotNo='+depotNo+'&divisonNo='+divisonNo+'&vehiclelist='+vehiclelist,
	            success: function(result) {
	            	$('#pageLoader').hide();
...
<body>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View KMPL Vehicle Wise Report
							</div>
							<!-- <div class="tools">
   ...
   function tabletoExcel(btnExport){     
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='13'>View KMPL Vehicle Wise Report</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "View KMPL Vehicle Wise Report.xls";

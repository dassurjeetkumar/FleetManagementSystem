	 ...
	 $('#select2-chosen-2').html("Select");
		//alert('Here');
		 ...
		 var val=document.getElementById('divisionlist').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/AjaxgetDepotfrommissinglatedeparture?val=' + val,
...
function savereport(){
	...
	if (div ==0 ){
	   ...
	   document.getElementById("missinglatedeparture").submit();
   }
	}
</script>
 ...
 function callCancell() {
	...
	window.location.href = 'Queryformissinglatedeparture';
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Missing Late Departure
							</div>
						</div>
...
<!-- <table> -->
                   <form action="savemissinglatedeparture" method="post" class="form-horizontal" id="missinglatedeparture">
                   <b>

...
function reloadHeading(){
	...
	if(divisionId == '-1'){
		$("#heading").html("Monthly Pass Consumption Statement (G-3)");
	}else{
		$("#heading").html("Monthly Pass Consumption Statement (G-2)");
	}
			...
			<div class="col-md-12">
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i><b id='heading'>Monthly Pass Consumption Statement (G-3)</b>
						</div>
					</div> 
										...
										<div class="form-group" id='reportData'>
											<table class='table table-striped table-bordered table-hover' id='pass70Table'>
												<tr>
													...
													<th>O.B.</th>
													<th>Receipt from C.O</th>
													<th>From other depot/C.O</th>
													<th>Total receipts</th>
													<th>Issue to other depots</th>
													<th>Total consumption</th>
													<th>Consumption value</th>
													<th>Un sold passes</th>
													<th>Un sold passes return to C.O</th>
											...
											<!-- 	<tr>
													<th colspan="11" style="text-align: center" > Revenue realised</th>
													<th >0</th>		
												</tr> -->
											</table>

	...
	var d3=Date.parse(var2);
	 ...
	 $('#pageLoader').show();
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxManualOperated.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>100% Manual Operated Report
							</div>
						</div>
...
<!-- 						end -->
 	                  ...
 	                  downloadLink.download = "100% Manual Operated Report.xls"; 

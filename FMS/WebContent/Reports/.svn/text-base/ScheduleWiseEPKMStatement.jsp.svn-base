                           ...
                           <div class="form-body">
								...
								<div class="form-group">
									<label class="col-md-3 control-label">Depot<font
										color="red">*</font></label>
									<div class="col-md-4">
										<select  id="depotlist1" class="select3_category form-control" name="depotlist1" onchange="getSchedule(this.value)" 
 											> 
							 ...
							 <div class="form-group">
							  <label class="control-label col-md-3">Start Date:<font
								...
								<input id="startdate" class="form-control" type="text" readonly="" size="16" name="rateMaster.effectiveStartDate" onchange="getSchedule('')"

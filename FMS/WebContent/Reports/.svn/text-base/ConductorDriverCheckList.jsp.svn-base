...
// 		if (d1 <= d3){
	 $('#pageLoader').show();
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxConductorDriverCheckList.action?startdate='+dd1+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Conductor and Driver Check List Report
							</div>
						</div>
...
<!-- 								</div></td>  -->
 	                  ...
 	                  downloadLink.download = "Conductor and Driver Check List Report.xls"; 

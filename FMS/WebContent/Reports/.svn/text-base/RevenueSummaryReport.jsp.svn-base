...
<script type="text/javascript">
 ...
 window.addEventListener("load",function(){
	   var val = $("#divisionlist").val();
	   getDepot(val, true);
},false);
 
 function getDepot(orgId, defaultTrue){
		 ...
		 var val=document.getElementById('divisionlist').value;
	        ...
	        $.ajax({
				...
				success : function(result) {
					...
					if(defaultTrue != undefined && defaultTrue) {
						//alert($("#depotlist option:first").text())
						$("#depotlist").val($("#depotlist option:first").val()).trigger('change.select2');
					}
				}
			});
		}
 ...
 function printDiv() {     
	...
	function getScheduledTripStatusDataOnSubmit()
	{
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxRevenueSummaryReport.action?startdate='+dd1+'&enddate='+dd2+'&depot='+depotNo+'&division='+divisonNo+'&service='+servicelist,
            success: function(result) {
            	$('#pageLoader').hide();
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							Revenue Summary REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Revenue Summary Report
							</div>
							<!-- <div class="tools">
									...
									<div class="form-group">
										...
										<div class="col-md-4">										
											<s:select list="divisionlist" id="divisionlist"
												...
												headerValue="Division" onchange="getDepot(this.value)" name="division" 
												value="defaultdevisionnumber"></s:select>
										</div>
									</div>

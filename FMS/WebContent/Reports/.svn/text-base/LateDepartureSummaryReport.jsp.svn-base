				...
				.dataTable(
						{
							...
							"iDisplayLength" : 20,
							"sAjaxSource" : "getlateDepartureSummaryReportData.action?scheduleNo="+depotNo+"&selectedDate="+choosenDate+"&range="+range,
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
						LATE DEPARTURE  SUMMARY REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Late Departure Summary Report
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select id="range" class="select2_category form-control"
											...
											<option value="90">>120min&<180min</option>
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>
										<span><h4>Late Departure Summary Report</h4></span>

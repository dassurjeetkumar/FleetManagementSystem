...
<script type="text/javascript">
 ...
 function jsFunction(){
		//alert("region...."+divisionid);
		//var monthyear = $('#startdate').val();	
		//alert("monthyear...."+date1);
		var startdate=$("#startdate").val();
		var enddate=$("#enddate").val();
		//alert(startdate);
		//alert(enddate);
		//alert("monthyear...."+startdate);
		//alert("monthyear...."+enddate);
//	 		$.ajax({
//	         type: "post",
	<%--         url: '<%=request.getContextPath()%>/getresiondetails.action?divisionid='+divisionid+'&monthyear='+monthyear, --%>
//	           success: function(result) {
//	        	 document.getElementById('depotss').innerHTML=result;
//	           }
//	      });
			//var divElements = document.getElementById("depotss").innerHTML;
			var mywindow = window.open("<%=request.getContextPath()%>/getVehicleDivisionDetails.action?startdate="+startdate+"&enddate="+enddate);
...
// 			if (d1 <= d3){
	        $.ajax({
	            ...
	            type: "get",
	            url: '<%=request.getContextPath()%>/AjaxdriverWiseKMPLReportITS.action?startdate='+startdate+'&enddate='+enddate,
	            success: function(result) {
	            	$('#pageLoader').hide();
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Vehicle Wise  KMPL Report(Corporation)
							</div>
							<!-- <div class="tools">
...
<!-- 								</div> -->
   ...
   function tabletoExcel(btnExport){     
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='13'>Vehicle Wise  KMPL Report</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "Vehicle Wise  KMPL Report.xls";

...
//		alert(depot+scheduleno);
  ...
  var d3=Date.parse(var2);
    ...
    $.ajax({
        ...
        type: "get",
        url: '<%=request.getContextPath()%>/AjaxConductorWiseEarning.action?startdate='+dd1+'&enddate='+dd2+'&coundvtorr='+coundvtorr+'&divisionlist1='+division+'&depotlist1='+depot,
...
function getCoductorToken(depotId){
	// $('#select2-chosen-2').html("Select");
	 $('#select2-chosen-3').html("Select");
		//alert('Here');
		 /* var selectedValue = $('#form-control').val(); */
		 var val=document.getElementById('depotlist1').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getTokenNo?val=' + val,
				success : function(result) {
					document.getElementById('coundvtorr').innerHTML = result;
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Conductorwise Earning Report  
							</div>
						</div>
					...
					<div class="form-body">
                               ...
                               <div class="form-group">
									...
									<div class="col-md-3">
										<select list="depotlist" id="depotlist1" class="select2_category form-control" name="depotlist1"
 											onChange="getCoductorToken(this.value)"> 
						...
						<div class="form-group">
									<label class="control-label col-md-3">Conductor Token No:</label>
									<div class="col-md-3">
									<div class="input-group input-medium"  >
<%-- 								<s:select list="conductrtype" id="coundvtorr" name="coundvtorr" cssClass="form-control input-medium select2me" ></s:select> --%>
									
									<select list="conductrtype" id="coundvtorr" class="select2_category form-control" name="coundvtorr"> 
											<option value="0">--Select--</option>
 										</select> 
									</div>
							</div>
...
// 													}
   	      ...
   	      try{
   	  	    ...
   	  	    console.log("ExceptionCaught : " + err);
   	            ...
   	            downloadLink.download = "Conductorwise Earning Report";

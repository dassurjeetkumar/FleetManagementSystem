...
//alert(divisionid);
		...
		$.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getdepotvehicledetails1.action?startdate1='+startdate1+'&enddate1='+enddate1+'&divisionid='+divisionid,
...
function jsFunction3(depotid){
	...
	//alert(depotid);
		...
		var mywindow = window.open("<%=request.getContextPath()%>/getvehicledetailsname.action?depotid="+depotid+"&startdate1="+startdate1+"&enddate1="+enddate1);
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>DepotWise Vehiclewise KMPL Report 
						</div>

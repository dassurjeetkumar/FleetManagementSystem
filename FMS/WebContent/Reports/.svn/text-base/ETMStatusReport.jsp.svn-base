...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxETMStatusReport.action?enddate='+dd2+'&startdate='+dd1+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>ETM Status Report
							</div>
						</div>
						...
						<div class="portlet-body">
                         ...
                         <form action="" method="post" class="form-horizontal">
                              <div class="form-body">
								...
								<div class="form-group">
							  <td><label class="col-md-3 control-label"> From Date:</label>
								<div class="col-md-4">
								...
								<div class="form-group">
							  <td><label class="col-md-3 control-label">To Date:</label> 
								<div class="col-md-4"> 
								<div class="input-group input-medium date date-picker" 
															style="width: auto" data-date-format="dd-mm-yyyy" 
															data-date-viewmode="years" ><!-- data-date-start-date="+0d"> --> 

...
// 			if (d1 <= d3){
	$('#pageLoader').show();
	        $.ajax({
	            ...
	            type: "get",
	            url: '<%=request.getContextPath()%>/AjaxvehicleDeviceOnline.action?startdate='+startdate,
	            success: function(result) {
	            	$('#pageLoader').hide();
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Vehicle Online Device Report
							</div>
							<!-- <div class="tools">
...
<!-- 									</div> -->
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='4'>Vehicle Online Device Report</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    inputHTML += "<th colspan='2' align='left'>Date Range:</th>";
    inputHTML += "<th colspan='2' align='left'>" + $("#selecteddate1").val() + " to " + $("#selecteddate2").val() + "</th>";
    inputHTML += "</tr>";
    inputHTML += "</table>";
    ...
    downloadLink.download = "Vehicle Online Device Report.xls";

...
<Script>
 ...
 function printDiv1() {     
	    ...
	    try{
			$("#ticketconsuptionid1 table").each(function(){
				noOfTableExist++;
			});
	...
	function getsettlementreport(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjexAxisSettlementExceptionReport.action?startdate='+dd1+'&enddate='+dd2,
            success: function(result) {
            	$('#pageLoader').hide();
...
/* 	//consol.log(hi);
	...
	//$("#tripwiserevenuecummulativedata1").reset();
	$("#tripwiserevenuecummulativedata1").show();
	//$('#tripwiserevenuecummulativedata1').attr("style", "display:''");
	var oTable = $('#tripwiserevenuecummulative').dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "Alertdepotwiseaxissettlementreport.action?depotid=" + depotid
              ...
              <div id="pageLoader" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="false">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							TICKET SETTLEMENT  REPORT (ITS-AXIS) <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Axis Settlement  Report
							</div>
							<div class="actions">
...
//   	             inputHTML += "</tr>";
  	             inputHTML += "</table>";
  	             var htmltable = document.getElementById("ticketconsuptionid1");

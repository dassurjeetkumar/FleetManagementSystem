...
// });
 ...
 function printDiv1() {     
	    ...
	    try{
			$("#eastDivisioneData table").each(function(){
				noOfTableExist++;
			});
			$("#kilometersData table").each(function(){
				noOfTableExist++;
			});
			$("#eastTripData table").each(function(){
				noOfTableExist++;
			});
...
$('#pageLoader').show();
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxEastDivisionReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
// 	        	   alert("hi"+result);
	                document.getElementById('eastDivisioneData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxEastDivisionKilometersReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxEastDivisionTripReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
	                document.getElementById('eastTripData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxEastDivisionFormDataReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxEastDivisionFormSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxEastDivisionKilomiterSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxEastDivisionTripSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxEastDivisionCrewSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxEastDivisionSummaryDataReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxEastDivisionSummary1Report.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxEastDivisionSummary2Report.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
 ...
 <div id="pageLoader" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="false">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							EAST DIVISION FORM V REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View East Division Form V Report
							</div>
							<div class="actions">
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>EAST DIVISION REPORT</th>";
  	             inputHTML += "</tr>";
//   	             inputHTML += "<tr>";
...
//   	             inputHTML += "</tr>";
  	             ...
  	             downloadLink.download = "EAST DIVISION REPORT.xls";
...
<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>East Division Form V
						</div>
						<div class="tools">
					...
					<div class="portlet-body" id="route_deviation_id1"
						...
						<div class="portlet-body" id="scheduleprint" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="eastDivisioneData" style="max-height: 60px;">
			...
			<div class="portlet box blue">
					...
					<div class="portlet-body" id="route_deviation_id"
						...
						<div class="portlet-body" id="scheduleprint2" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="eastTripData" style="max-height: 60px;">

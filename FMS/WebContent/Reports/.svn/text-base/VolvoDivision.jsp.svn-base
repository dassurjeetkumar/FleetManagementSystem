...
// 		$("#tripstatus").show();
    ...
    $('#pageLoader').show();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
// 	        	   alert("hi"+result);
	                document.getElementById('volvoDivisioneData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionMonthReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
	                document.getElementById('volvoDivisioneData1').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionKilometersReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionTripReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
	                document.getElementById('volvoTripData').innerHTML=result;
	                fixHeader();
		 ...
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionFormDataReport.action?singledate='+date,
	           success: function(result) {
	        	   $('#pageLoader').hide();
//	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionFormSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionKilomiterSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionTripSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionCrewSummaryReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionSummaryDataReport.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionSummary1Report.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
...
// 		 $.ajax({
// 	           type: "get",
<%-- 	           url: '<%=request.getContextPath()%>/AjaxVolvoDivisionSummary2Report.action', --%>
// 	           success: function(result) {
// 	        	   $('#pageLoader').hide();
// //	        	   alert("hi"+result);
			 ...
			 <div id="pageLoader" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="false">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							VOLVO DIVISION FORM V REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Volvo Division Form V Report
							</div>
							<div class="actions">
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>TRIP WISE LATE DEPARTURE REPORT</th>";
  	             inputHTML += "</tr>";
  	             inputHTML += "<tr>";
...
<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Volvo Division Form V
						</div>
						<div class="tools">
					...
					<div class="portlet-body" id="route_deviation_id1"
						...
						<div class="portlet-body" id="scheduleprint" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="volvoDivisioneData" style="max-height: 60px;">
			...
			<div class="portlet box blue">	
				<div class="portlet-title">
					...
					<div class="portlet-body" id="route_deviation_id1"
						...
						<div class="portlet-body" id="scheduleprint" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="volvoDivisioneData1" style="max-height: 60px;">
			...
			<div class="portlet box blue">
					...
					<div class="portlet-body" id="route_deviation_id"
						...
						<div class="portlet-body" id="scheduleprint2" style='height:310px; overflow-y:scroll; display:block;'>
							<table class="table table-bordered sticky-thead"
								id="volvoTripData" style="max-height: 60px;">
...
<!-- 					<div class="portlet-title"> -->
<!-- 						<div class="caption"> -->
<!-- 							<i class="fa fa-gift"></i>Form V Summary  -->
<!-- 						</div> -->
<!-- 						<div class="tools"> -->
<!-- 							<a class="collapse" id="route_deviation_data" href="javascript:;"> </a> -->
<!-- 						</div> -->
...
<!-- 					<div class="portlet-body" id="route_deviation_id" -->
<!-- 						style="overflow: hidden;"> -->
<!-- 						<div class="portlet-body" id="scheduleprint4" style='height:310px; overflow-y:scroll; display:block;'> -->
<!-- 							<table class="table table-bordered sticky-thead" -->
<!-- 								id="formDivisionSummaryData" style="max-height: 60px;"> -->
								
<!-- 							</table><br> -->
							
<!-- 							<table class="table table-bordered sticky-thead" -->
<!-- 								id="kilomiterDivisionSummaryData" style="max-height: 60px;"> -->
								
<!-- 							</table><br> -->
							
<!-- 							<table class="table table-bordered sticky-thead" -->
<!-- 								id="tripDivisionSummaryData" style="max-height: 60px;"> -->
								
<!-- 							</table><br> -->
							
<!-- 							<table class="table table-bordered sticky-thead" -->
<!-- 								id="crewDivisionSummaryData" style="max-height: 60px;"> -->
...
<!-- 					<div class="portlet-title"> -->
<!-- 						<div class="caption"> -->
<!-- 							<i class="fa fa-gift"></i>Division Wise Form-V -->
<!-- 						</div> -->
<!-- 						<div class="tools"> -->
<!-- 							<a class="collapse" id="route_deviation_data" href="javascript:;"> </a> -->
<!-- 						</div> -->
...
<!-- 					<div class="portlet-body" id="route_deviation_id" -->
<!-- 						style="overflow: hidden;"> -->
<!-- 						<div class="portlet-body" id="scheduleprint5" style='height:310px; overflow-y:scroll; display:block;'> -->
<!-- 							<table class="table table-bordered sticky-thead" -->
<!-- 								id="summaryDivisionData" style="max-height: 60px;"> -->
								
<!-- 							</table><br> -->
							
<!-- 							<table class="table table-bordered sticky-thead" -->
<!-- 								id="summaryDivisionData1" style="max-height: 60px;"> -->
								
<!-- 							</table><br> -->
							
<!-- 							<table class="table table-bordered sticky-thead" -->
<!-- 								id="summaryDivisionData2" style="max-height: 60px;"> -->

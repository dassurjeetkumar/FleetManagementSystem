...
function getVehicle()
{
 ...
 $.ajax({
     ...
     type: "POST",
     url: '<%=request.getContextPath()%>/getDepotVehicles?val=' + val,
		success : function(result) {
			
			document.getElementById('vehicleId').innerHTML = result;
...
function getDepot(){
		...
		var2=var2[2]+"-"+var2[1]+"-"+var2[0];
		 $('#kmplVehData').dataTable({
 			"aLengthMenu" : [ [ 10, 15, 20, -1 ], [ 10, 15, 20, "All" ] // change
 			
 			],
 		
 			"sAjaxSource" : "getKMPLVehicleWiseNewReport.action?date="+dd1+"&vehicleNo="+vehicleName+"&depotId="+depotId+"&endate="+dd2,
 		...
 		jQuery(
 				'#kmplVehData_wrapper .dataTables_filter input')
 				.addClass("form-control input-small input-inline"); // modify
 		// table
 		jQuery(
 				'#kmplVehData_wrapper .dataTables_length select')
 ...
 <script>
	function getheader() {
		//alert("getheader");
		document.getElementById("startdateheader").innerHTML = new Date().toJSON().slice(0,10);
		}
 </script>
<script>
...
function exportToExcel(btnExport){   
   var htmltable = document.getElementById("kmplVehDatahead");
...
function printDiv() {     
    ...
    divElements += document.getElementById("kmplVehDatahead").innerHTML;
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Vehicle Wise KMPL Report
							</div>
						</div>
                        ...
                        <div class="form-body">
                               ...
                               <div class="form-group">
 								 ...
 								 <div class="form-group">
									<label class="col-md-3 control-label">Vehicle No.<font
										color="red">*</font></label>
									<div class="col-md-3">
										<select  id="vehicleId" class="select2_category form-control" > 
							...
							<div class="form-group">
                              ...
                              $('#endate').val(curr_date); 
								 ...
								 <div align='center'>
					<button type="submit" class="btn green" onClick="getDepot(),getheader()">Submit</button>
...
<!-- 					<div id="ticketconsuptionid"></div> -->
	<div id="kmplVehDatahead">		
							<table class="table table-striped table-bordered table-hover"
								...
								<thead>
									...
									<div style="display: none;" id="mymodal43" class="modal fade"
						...
						<div>
							...
							<div>
								<div class="portlet solid white">
									...
									<div class="portlet-body" id="modalclass43"
										>
 ...
 <h3 style="margin-left:350px;">Vehicle KMPL Report</h3>
<br />
<b><font size="2"><label>Date: </label></font><font size="2"><b><span id="startdateheader" style="text-align:left;margin-left:50px;"></span></font></b>

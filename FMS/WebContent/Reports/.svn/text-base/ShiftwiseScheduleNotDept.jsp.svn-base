...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxShiftwiseScheduleNotDepartedData.action?selectedDate='+dd1,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title" id="header">
							<div class="caption">
								<i class="fa fa-globe"></i>Shiftwise Schedule Not Departure Report
							</div>
						</div>
...
//  	                    var divElements = document.getElementById("header").innerHTML;
 	                 var divElements = document.getElementById("ticketconsuptionid").innerHTML;
 	                  ...
 	                  downloadLink.download = "Cumulative Revenue Report"; 
					 ...
					 <div align='center'>
					<button type="submit" class="btn green" onClick="getNotdepartedData()">Submit</button>&nbsp;
					<span><input type='button' class='btn green' id='button1' onclick='printDiv()' value='Print' /></span>&nbsp;
					<span><input type='button' class='btn green' id='button1' onclick='tabletoExcel()' value='Excel' /></span>&nbsp;

...
// 			if (d1 <= d3){
	        $.ajax({
	            ...
	            type: "get",
	            url: '<%=request.getContextPath()%>/AjaxKMPLDriverWise.action?startdate='+startdate+'&enddate='+enddate+'&depot='+depotNo+'&token='+token,
	            success: function(result) {
	            	$('#pageLoader').hide();
...
<!-- 				</div> -->
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View KMPL Driver Wise Report
							</div>
							<!-- <div class="tools">
   ...
   function tabletoExcel(btnExport){     
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='13'>View KMPL Driver Wise Report</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "View KMPL Driver Wise Report.xls";

		...
		//alert("ashu");
		 if( div == "0" )
	        ...
	        $('#KmCancellationTable').dataTable({
    			...
    			//"iDisplayLength" : 5,
    			"sAjaxSource" : "getZerolatLongDevicePackets.action?startdate="+dd1+"&depotlist1="+depotlist1,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Zero Lat/Long Devices Packets  
							</div>
						</div>
						</div>
						</div>
...
<%-- 					</script> --%>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>Zero KM Devices Report</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "ZeroLatLongDevicesTable.xls";

	...
	// var val=document.getElementById('vehicleidlistid').value;
	 ...
	 /* 		$('#pageLoader').show(); */
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/LicenseExpireCrewReport.action?startdate='+var1+'&divisionId='+var2+'&depotId='+var3,
            success: function(result) {
            	//alert(result);
    /*         	$('#pageLoader').hide(); */
                document.getElementById('licenseExpiredid').innerHTML=result;
            }
        });
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Driver License Expired Report
							</div>
							<!-- <div class="tools">

		...
		//alert("ashu");
		 if( div == "0" )
	        ...
	        $('#KmCancellationTable').dataTable({
    			...
    			//"iDisplayLength" : 5,
    			"sAjaxSource" : "getZeroKMDevicesReport.action?startdate="+dd1+"&depotlist1="+depotlist1,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Zero KM Devices
							</div>
						</div>
						</div>
						</div>
...
<%-- 					</script> --%>
    ...
    downloadLink.download = "ZeroKMDeviceReports.xls";

	...
	<div class="page-content">
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
					Peak and Non-Peak Hour Running Time Report
				</h3>
			...
			<div class="col-md-12">
				<div class="portlet box grey-cascade">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-bars"></i> View Peak and Non-Peak Hour Running Time Report
						</div>
						<!-- <div class="tools">
...
<!-- 							 <div class="form-group"> -->
							  <label class="control-label col-md-2">Till Date:</label>
								<div class="col-md-2">
								<div class="input-group input-medium date date-picker"
															style="width: auto" data-date-format="dd-mm-yyyy"
															data-date-viewmode="years" ><!-- data-date-start-date="+0d"> -->
						...
						<div class="col-md-3">
									<div class="input-group">
												<input type="text" class="form-control input-small timepicker timepicker-24" name="starttime" id="starttime" >
								...
								<div class="col-md-3">
									<div class="input-group">
												<input type="text" class="form-control input-small timepicker timepicker-24" name="endtime" id="endtime">
   ...
   <div class="form-group">
							...
							<div class="form-actions fluid">
                             ...
                             <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Peak and Non-Peak Hour Running Time Report</h4>
									<br />

...
// 		if (d1 <= d3){
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxShiftwiseLateDepartureData.action?selectedDate='+dd1,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title" id="header">
							<div class="caption">
								<i class="fa fa-globe"></i>Shiftwise Late Departure Report
							</div>
						</div>
...
//  	                    var divElements = document.getElementById("header").innerHTML;
					 ...
					 <div align='center'>
					<button type="submit" class="btn green" onClick="getLateDeptData()">Submit</button>&nbsp;

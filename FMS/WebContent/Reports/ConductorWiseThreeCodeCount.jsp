...
function getDetails(token,date1,date2,depot){
	//alert("date1..."+date1);
	document.forms[0].action = "conductorwisedetails.action?value="+ token+'&enddate='+date2+'&startdate='+date1+'&depotlist1='+depot;
	...
	var d3=Date.parse(var2);
	 ...
	 $('#pageLoader').show();
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxConductorWiseThreeCodeCount.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Conductor Wise 3-code Count Report
							</div>
						</div>
...
<!-- 						end -->
 	                  ...
 	                  downloadLink.download = "Conductor Wise 3 code Count Report.xls"; 

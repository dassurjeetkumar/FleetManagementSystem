...
function getAlertTripWisecummulative(schedulename,weekday,cnt,startdate,enddate,depot) {
	...
	var oTable = $('#tripwiserevenuecummulative').dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "AlertTripwiserevenuecummulative.action?schedulename=" + schedulename
...
function getDepot1(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxTripWiseWeekDayCummulative.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&scheduleid='+scheduleid+'&days='+days+'&shiftid='+shiftid+'&divisionlist1='+div+'&scheduletypeid='+scheduletypeid,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Trip Wise Weekday Cummulative Report
							</div>
						</div>
...
//                                         }
 	                  ...
 	                  downloadLink.download = "Trip Wise WeekDay Cummulative Report.xls"; 

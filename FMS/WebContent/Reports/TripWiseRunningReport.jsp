...
function getSchedule()
{
 ...
 $.ajax({
     ...
     type: "POST",
     url: '<%=request.getContextPath()%>/getScheduleListForTrip?val=' + val,
...
function getDepot(){
	 ...
	 if (var1 <= var2){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getTripWiseRunningTimeData.action?endate='+dd2+'&scheduleNo='+scheduleNo+'&date='+dd1+'&depotId='+depotId+'&divId='+divId,
            success: function(result) {
            	$('#pageLoader').hide();
//             	$('#scheduleDetail').hide();
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getScheduleDetailsForReport.action?scheduleNo='+scheduleNo,
            success: function(result) {
//             	$('#pageLoader').hide();
                document.getElementById('scheduleDetail').innerHTML=result;
                fixHeader();
            }
        });
...
function exportToExcel(btnExport){   
   ...
   downloadLink.download = "Tripwise Running Time Report.xls";
...
function printDiv() {     
	...
	var headerVal=" Trip wise Running Time Report ";
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Trip Wise Running Time
							</div>
						</div>
                        ...
                        <div class="form-body">
                               ...
                               <div class="form-group">
									<label class="col-md-3 control-label">Depot<font
										color="red">*</font></label>
									<div class="col-md-3">
										<select list="depotlist" id="depotlist1" class="select2_category form-control" name="depotlist1" onChange="getSchedule(this.value)"
 											> 
							  ...
							  <label class="control-label col-md-3">From:<font
								...
								<input id="startdate" class="form-control" type="text"  size="16" name="effectiveStartDate" onChange="getSchedule()"
...
<!-- 								</div> -->
								...
								<div class="form-group">
							  <label class="control-label col-md-1">To:<font
										color="red">*</font></label>
								<div class="col-md-3">

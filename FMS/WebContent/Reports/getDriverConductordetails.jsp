...
function jsFunction(){
	...
	var date1=$("#date1").val();
		$.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getDriverConductordetails1.action?depottype='+depottype+'&date1='+date1,
...
<input type='hidden' id="depottype"  value='<s:property value="depottype"/>'/>

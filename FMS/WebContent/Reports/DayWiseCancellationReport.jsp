	 ...
	 $('#select2-chosen-3').html("Select");
		//alert('Here');
		 ...
		 var val=document.getElementById('depotlist1').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getScheduleFromDepotForTrip?val=' + val,
				success : function(result) {
...
//	alert("hii");
	...
	// $('#select2-chosen-4').html("Select");
		//alert('Here');
		 ...
		 var scheduleid=document.getElementById('schedulelist1').value;
			
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getShifttypeFromDepot?depot='+depot+'&scheduleid=' + scheduleid,
				success : function(result) {
...
function getDepot1(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxDayWiseCancellationReport.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&schedulelist1='+schedulelist1+'&days='+days+'&shiftid='+shiftid,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Daywise % of zero Revenue trips Report
							</div>
						</div>
...
<!-- <table> -->
                   <form action="" method="post" class="form-horizontal">
                           <div class="form-body">
							...
							<select list="schedulelist" id="schedulelist1" class="select2_category form-control" name="schedulelist1" onchange="getShift(this.value)"> 
...
//                                         }
 	                  ...
 	                  downloadLink.download = "DayWise Cancellation Report.xls"; 

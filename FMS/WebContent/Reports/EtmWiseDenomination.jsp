	 ...
	 $('#select2-chosen-4').html("Select");
		//alert('Here');
		 ...
		 var val=document.getElementById('depotlist1').value;
	        ...
	        $.ajax({
	            type: "post",
	            url: '<%=request.getContextPath()%>/getETMNoForETMWise?depot=' + val,
				success : function(result) {
					document.getElementById('etmid').innerHTML = result;
...
function getDepot1(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxEtmWiseDenomination.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot+'&divisionlist1='+div+'&etmid='+etmid,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>ETM Wise Demomination Report
							</div>
						</div>
                           ...
                           <div class="form-body">
								...
								<div class="form-group">
									<label class="col-md-3 control-label">Depot<font
										color="red">*</font></label>
									<div class="col-md-4">
										<select list="depotlist" id="depotlist1" class="select2_category form-control" name="depotlist1"  onchange="getETMNo(this.value)"> 
...
//                                         }
 	                  ...
 	                  downloadLink.download = "ETM Wise Demomination Report.xls"; 

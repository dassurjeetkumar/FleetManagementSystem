...
//alert(depotid);
		...
		$.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getvehicledetailsname1.action?startdate1='+startdate1+'&enddate1='+enddate1+'&depotid='+depotid,
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>VehicleWise KMPL Report 
						</div>

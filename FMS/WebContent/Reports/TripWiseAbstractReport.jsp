...
function getDepot1(){
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxTripWiseAbstractReport.action?startdate='+dd1+'&enddate='+dd2+'&depotlist1='+depot,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Schedule wise % of Zero Revenue Trips  Report
							</div>
						</div>
...
//                                         }
 	                  ...
 	                  downloadLink.download = "Schedule wise % of Zero Revenue Trips  Report.xls"; 

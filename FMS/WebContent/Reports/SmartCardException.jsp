...
function getDepot1(){
 	...
 	/* 	var var1=$("#startdate").val();
		...
		var1=var1[2]+"-"+var1[1]+"-"+var1[0];
 		...
 		var var2 =AppDateFormat.format(d);
 		var2=var2.split("-");
	...
	/* 	  var d1 = Date.parse(var1);
 	...
 	var d3=Date.parse(var2);
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxSmartCardExceptionReport.action?startdate='+dd1,
...
function exportToExcel(btnExport){   
	   ...
	   downloadLink.download = "Absenteeism Report.xls";
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Smart Card Exception Report
							</div>
						</div>
...
<!-- <table> -->
                   <form action="" method="post" class="form-horizontal">
 	                  ...
 	                  downloadLink.download = "ETM EOD Report.xls"; 
 	                  document.body.appendChild(downloadLink); 
 	                  downloadLink.click(); 
 	                  document.body.removeChild(downloadLink);
 	                  }</script>	

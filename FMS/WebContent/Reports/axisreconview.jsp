...
//alert();
    ...
    var oTable = table.dataTable({
		...
		"iDisplayLength" : 5,
		"sAjaxSource" : "axisreconview!getdata.action?startdate="+strdate+"&enddate="+edate,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Axis Recon
							</div>
						</div>
			...
			<!-- END PAGE CONTENT-->
				...
				<div class="portlet-body" id="logsheetdashbord" style="display: none; visibility: hidden;">
                           ...
                           <table class="table table-striped table-bordered table-hover"
								id="axisrecontable"  border='1' width="500" >
...
<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
<table  width="675" border='1' ><tr ><td  colspan='11'>
<center><div width="500px">
	<h3><span>Axis recon</span></h3>
</div></center>
</td></tr>

<tr><td align='center'colspan='6'><center><b><font size="2"><label>From Date: </label></font><font size="2"><b><span id="startdat" style="text-align:left;margin-left:50px;"></span></font></b></center></td>
<td align='center'colspan='5'><center><b><font size="2"><label>To Date: </label></font><font size="2"><b><span id="todat" style="text-align:left;margin-left:50px;"></span></font></b></center></td>
  ...
  downloadLink.download = "axisrecon.xlsx"; 

...
// 	alert("depotNo..."+depotNo+"....divisonNo...."+divisonNo);
...
// 			if (d1 <= d3){
	        $.ajax({
	            ...
	            type: "post",
	            url: '<%=request.getContextPath()%>/AjaxCrewandStaffPosition.action?depotNo='+depotNo+'&divisonNo='+divisonNo,
	            success: function(result) {
	            	$('#pageLoader').hide();
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Crew And Staff Position Report
							</div>
							<!-- <div class="tools">

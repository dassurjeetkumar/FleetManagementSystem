				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Bay
							</div>
							<div class="actions">
...
<%}%>
	...
	<script>
			...
			$('#add').click(	
			function callCreate() {
				document.forms[0].action = "BayAction!add";
			...
			function() {
				...
				document.forms[0].action = 'BayAction!edit?id='+ val;
				document.forms[0].submit();
				}
			});
			...
			$('#delete_').click(
					function() {
						...
						if (cnt == 0) {
							...
							document.forms[0].action = 'DeleteBayAction?id='+ val;
							document.forms[0].submit();
							}

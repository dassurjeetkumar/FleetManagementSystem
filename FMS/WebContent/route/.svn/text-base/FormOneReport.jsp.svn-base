			...
			<div class="col-md-12">
				<div class="portlet box grey-cascade">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-bars"></i> View Form-1
						</div>
						<!-- <div class="tools">
		...
		.dataTable(
				{
					...
					"bProcessing" : true,
					"bServerSide" : true,
					 "sAjaxSource" : "FormOnelist.action?division="
							+ divisionlist + "&depot=" + depotlist1,
...
jQuery('#showFormOneTable_wrapper .dataTables_filter input').addClass("form-control input-small input-inline"); // modify table search input
jQuery('#showFormOneTable_wrapper .dataTables_length select').addClass("form-control input-xsmall input-inline");

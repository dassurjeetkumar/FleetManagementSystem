			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					...
					<div class="portlet-body form">
						...
						<form action="SaveRoutMapPisAction" class="form-horizontal form-row-seperated" method="post">
							<div class="form-body">
								<div class="form-group" >
									<label class="control-label col-md-3"> Route No :<span class="required"> * </span></label>
									<div class="col-md-3">
<%-- 								        <select id="routeid" name="routeid"  class="select2-container select2_category form-control"  onchange="getttmcdetails()" > --%>
<%-- 											<s:iterator value="routelist" > --%>
<%-- 												<option id="<s:property   value="route_id" />" value='<s:property   value="route_id" />'> --%>
<%-- 													<s:property value="route_number" /> --%>
<!-- 												</option> -->
<%-- 											</s:iterator> --%>
<%-- 										</select> --%>
                                    <input class="form-control" tabindex="1"  id="project" name="project" type="text"	onkeyup="JavaScript:getRoute(this.value)" onblur="getttmcdetails(this.value)"  value='<s:property value="routeNo"/>'  />
								...
								<div class="form-group">
									...
									<div class="col-md-3">
									<select class="select2_category form-control" name="bsstop" id="bsstop"  >
											<option value="0">Select</option>
									</select> 
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-3">
									<select class="select2_category form-control" name="floorid" id="floorid"  onchange="getbaydetails()">
											<option value="0">Select</option>
									</select> 
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-3">
									<select class="select2_category form-control" name="bayid" id="bayid" onchange="getplatformdetails()" >
											<option value="0">Select</option>
									</select> 
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-3">
									<select class="select2_category form-control" name="platformid" id="platformid" onchange="getservicedetails()">
											<option value="0">Select</option>
									</select> 
									</div>
								</div>
							...
							<div class="form-group">
									...
									<div class="col-md-3">
									 <select multiple  class="select2_category form-control" name="serviceid" id="serviceid">
                                           <option value="0">Select</option>
									</select> 
									</div>
								</div>

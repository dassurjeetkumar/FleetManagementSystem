...
<script type="text/javascript">
 function getsmartCardTopUpreportOnSubmit()
	{
		...
		var d3=Date.parse(var2);
	        ...
	        $.ajax({
	            ...
	            type: "post",
	            url: '<%=request.getContextPath()%>/AjaxsmartCardTopUpreport.action?startdate='+startdate+'&enddate='+enddate,
	            success: function(result) {
	            	$('#pageLoader').hide();
	                document.getElementById('smartCardTopUpreport').innerHTML=result;
	                fixHeader();
	            }
	        });
			}else{
	 			...
	 			$('#pageLoader').hide();
 	 			 document.getElementById('smartCardTopUpreport').innerHTML="";
 	 		}
	...
	function printDiv() {     
	    ...
	    divElements += document.getElementById("smartCardTopUpreport").innerHTML;
...
<div class="page-content-wrapper">
			...
			<div class="col-md-12">
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>Smart Card Top Up
						</div>
					</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='5'>Smart Card Top Up</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    inputHTML += "</tr>";
    inputHTML += "</table>";
    var htmltable = document.getElementById("smartCardTopUpreport");
    var html = inputHTML + htmltable.outerHTML;
    var downloadLink = document.createElement("a");
    downloadLink.href = 'data:application/vnd.ms-excel,' + encodeURIComponent(html);
    downloadLink.download = "Smart Card Top Up.xls";
    ...
    document.body.removeChild(downloadLink);
								...
								<label class="control-label col-md-3"></label>
									...
									<button type="button" class="btn green" onclick="getsmartCardTopUpreportOnSubmit()" >Submit</button>
								...
								<div id="smartCardTopUpreport"></div>
								</div>
								</div>

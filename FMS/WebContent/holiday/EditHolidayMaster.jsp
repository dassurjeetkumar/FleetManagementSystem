...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Edit Holiday Master
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="editHolidayMasterAction.action" class="form-horizontal" method="POST"  name ="frm" >
						
						
								<div class="form-group">
													<label class="col-md-3 control-label">Date :</label>
													<div class="input-group input-medium date date-picker"data-date-format="yyyy-mm-dd"  >
												<input type="text" class="form-control" name="holidayMasterModel.holiday_date" id="holiday_date" 
												onchange="findday()" value='<s:property value="holidayMasterModel.holiday_date" /> '> 
										...
										<div class="form-group">
									<input type='hidden' name="holidayMasterModel.holiday_master_id"  value='<s:property value="holidayMasterModel.holiday_master_id"/>'/>
								</div>

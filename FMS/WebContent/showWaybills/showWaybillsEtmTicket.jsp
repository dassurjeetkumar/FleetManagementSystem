				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body form">
							...
							<!-- BEGIN FORM-->
							<form action="showOnlineWaybillsGprsEtmTicket.action" method="post"
							...
							<tbody>
								...
								<s:iterator value="showWaybill" var="trips" status="ctr">
									...
									<tr>
										...
										<td align="left" width="140px"><a href='ShowGPRSWaybillWiseDayWiseEtmTicket.action?waybillno=<s:property value="waybillNo" />&ticketdate=<s:property value="ticketDate" />&depotid=<s:property value="depotId" />'><s:property value="waybillNo" /></a></td>
...
<!--                                   <a href="http://localhost:8080/hello.action" onclick="javascript:void window.open('http://localhost:8080/Strutslearning/hello.action','1379313271736','width=700,height=500,toolbar=0,menubar=1,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;">Pop-up Window</a> -->
										...
										<td align="center" width="130px"><a href='showOnlineWaybillsGprswaybillwiseEtmTicket.action?waybillno=<s:property value="waybillNo" />&ticketdate=<s:property value="ticketDate" />&vehicleNo=<s:property value='vehicleNo'/>&deviceser=<s:property value='device_serial_number' />&orgname=<s:property value='orgname'/>&depotid=<s:property value="depotId" />'><s:property value="noOfTickets" /></a></td>
									</tr>
								</s:iterator>
								<tr>

...
function goView() {
	document.forms[0].action = 'showOnlineWaybillsGprs.action?ticket_date=<s:property value="ticketDate" />&depotid=<s:property value="depotId" />';
		...
		<div class="page-content">
			<div class="portlet box grey-cascade">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i>Waybill Wise Trip Details
					</div>
					<div class="actions">
						...
						<table class="table table-striped table-bordered table-hover"
							...
							<thead>
								...
								<th scope="col" align="center">Sr. No.</th>
									...
									<th scope="col" align="center">Battery Status</th>
							...
							<tbody>
								...
								<s:iterator value="showWaybill" var="trips" status="ctr">
									...
									<tr>
										...
										<td align="center"><s:property value="pass_id_no" /></td>

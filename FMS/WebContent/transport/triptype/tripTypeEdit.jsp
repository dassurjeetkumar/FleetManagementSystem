				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Trip Type
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="EditTripTypeAction" class="form-horizontal" method="post">
							<span id="errorMsg" style="color:red;word-wrap: break-word;" ><s:actionerror/></span>
							<%-- <input type="hidden" name="tripType.id" value="<s:property value="tripType.id"/>" /> --%>
							
							<br><br>
							<div class="form-group">
								<label class="col-md-3 control-label">Trip Type Id:</label>
								<div class="col-md-4">
									<input type="text" name="tripType.id" readonly="readonly" class="form-control" value="<s:property value='tripType.id'/>" />
								</div>
							</div>

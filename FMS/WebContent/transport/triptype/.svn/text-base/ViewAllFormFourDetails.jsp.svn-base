...
<%@ taglib prefix="s" uri="/struts-tags"%>
 <%@ page import="com.trimax.its.transport.action.ViewAllFormFourAction" %>
 <%@ page import="java.util.List" %>
 <%@ page import="com.trimax.its.transport.model.ScheduleDetails" %>
...
// 	}
	...
	ViewAllFormFourAction obj = new ViewAllFormFourAction();
...
// 	HttpSession session=ServletActionContext.getRequest().getSession(false);  
	...
	List<Integer> formfour_id_list=obj.getAllFormFourID(id);
	System.out.println("formfour_id_list==="+formfour_id_list);
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="portlet box grey-cascade">
				...
				for (int j=0; j<formfour_id_list.size(); j++){
					out.println("formfourid is---"+formfour_id_list.get(j));
					ViewAllFormFourAction s=new ViewAllFormFourAction();
					s.display(formfour_id_list.get(j));
				out.println("after calling====="+s);
						...
						<div class="meet-our-team">
							<div class="team-info" align="center">
								<table>
									...
									<tr>
										<td><b>Schedule Number : </b><%= s.getSchedule()%><BR> </td>
									</tr>
								</table>
							</div>
						</div>
							...
							<div class="team-info" align="center">
								<table>
									<tr>
										...
										<%-- <s:property value="formfourname" /> --%><%= s.getFormfourname()%><BR></td>
									</tr>
									<tr>
						<td align="center"><%-- <s:property value="routeName" /> --%><%= s.getRouteName()%><BR></td>
						</tr>
						<tr>
						<td><b>Traffic Order No : </b>
						 <%-- <s:property value="traffic_order" /> --%>
						 <%= s.getTraffic_order()%><BR>
						</td></tr>
								</table>
							</div>
						</div>
						...
						<div class="meet-our-team">
							...
							<div class="team-info" align="center">
								...
								<table>
									<tr>
										<td><b>Division : </b>
										<%-- <s:property value="division" /> --%> <%= s.getDivision()%><BR></td>
									</tr>
									<tr>
										<td><b>Depot : </b>
									...
									<tr>
										...
										<%-- <s:property value="shift" /> --%><%= s.getShift()%><BR></td>
									</tr>
									<tr>
										<td><b>W.E.F : </b>
										<%-- <s:property value="effectstartdate" /> --%>
										<%= s.getEffectstartdate()%><BR>
										</td>
									</tr>
								</table>
							</div>
				...
				<div class="portlet-body">
					...
					<div class="table-scrollable">
						...
						<table class="table table-striped table-bordered table-hover"
							...
							<%ViewAllFormFourAction vaf=new ViewAllFormFourAction(); %>
								 <s:set var="crewchange" value="0"></s:set>
								<s:set var="nightchange" value="0"></s:set>
								<s:if test="scheduleCode == 1">
								<% List listd=vaf.getTripslist(); %>
								<c:forEach items="${listd}" var="trips">
									 <%-- <%if(vaf.getCrewChangeId()!=0){ System.out.println("*****"+vaf.getCrewChangeId());%> --%>
										<tr>
											<td colspan='14' align='center'>CREW CHANGE, FUELLING
												MAINTENANCE AT DEPOT</td>
										</tr>
									<%-- <%} %> --%>
									<%if(sch.getNightHalt()==1){%>
									<tr>
											<td colspan='14' align='center'>CREW CHANGE, FUELLING
												MAINTENANCE AT DEPOT</td>
										</tr>
									<%} %>
									<tr>
										<td align="center"><%-- <s:property value="listItemNumber" /> --%><c:out value="${listItemNumber}"/></td>
										<td align="center"><%-- <s:property value="#trips.tripNumber" /> --%><c:out value="${trips.tripNumber}"/>
										</td>

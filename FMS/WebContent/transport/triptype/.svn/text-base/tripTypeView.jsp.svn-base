...
<form>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Trip Type
							</div>
							<div class="actions">
							  ...
							  <%if(delete.equalsIgnoreCase("Y")){%>
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right ">
										<li>
										<%if(status.equalsIgnoreCase("ACTIVE")){ %>	<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=TRIPTYPERPT'">
	...
	<script>
			...
			$('#add').click(	
			function callCreate() {
				document.forms[0].action = "TripTypeAction!add";
			...
			function() {
				...
				/* document.forms[0].action = 'TripTypeAction!edit?id='+ val;
				document.forms[0].submit(); */
			...
			function() {
				...
				if (cnt == 0) {
					...
					/* document.forms[0].action ='DeleteTripTypeAction?id='+ val;
					document.forms[0].submit(); */
			...
			$(document).ready(function() {
				...
				window.history.pushState("", "", "TripTypeAction!view");
...
<form name="form1" id="form1" action="DeleteTripTypeAction" method="POST">
 	<input type="hidden" name="id" id="did" value="" /> 

 </form>
<form name="form2" id="form2" action="TripTypeAction!edit" method="POST">

...
function getServiceype(){
	 ...
	 if(document.getElementById("servType"+prevType).selected==true)
	{
		// alert("prevType"+prevType);
		 $.ajax({
	           type: "post",
	           url: '<%=request.getContextPath()%>/getRateMasterVersionForEdit?serviceid='+prevType,
	           async:false,
	           success: function(result) {
	        	 //  alert("result"+result);
...
function getRateMaster(){
    ...
    $.ajax({
        type: "post",
        url: '<%=request.getContextPath()%>/getRateMasterVersionForEdit?serviceid='+strUser,
        success: function(result) {
        	//alert("result"+result);
            document.getElementById('rateMasterId').innerHTML=result;
...
<!-- <body> -->
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">PEAK HOUR</h3>
				</div>
			</div>
				...
				<div class="tab-pane active" id="tab_0">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Peak Hours
							</div>
						...
						<div class="portlet-body form">
							...
							<!-- BEGIN FORM-->
							<form action="addEditPeakHourAction.action" method="post"
								id="createComplaintId" class="form-horizontal">
								<input type="hidden" name="peakhour.Peak_Slack_hour_Id"
									value="<s:property value="peakhour.Peak_Slack_hour_Id"/>" />
								<s:if test="%{updatestatus=='duplicate'}"><font color="red">Could not update Duplicate PeakHours</font></s:if>
							
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Peak/Slack Fare
											Type:<font color="red">*</font>
										</label>

										<div class="col-md-4">
											<input type="text" class="form-control" id="device_type_name"
												maxlength="50" name="peakhour.peak_Name"
												value='<s:property value="peakhour.peak_Name"/>'>
											<s:if test="fieldErrors.get('peak_Name').size() > 0">
												<span style="color: red;"><s:property
														value="fieldErrors.get('peak_Name').get(0)" /></span>
											</s:if>
										</div>
									</div>
									</div>
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Start Time<sup><font
												color="red">*</font></sup></label>
										<div class="col-md-3">
											<div class="input-group date form_datetime_bmtc_format">
												<input type="text" size="16" name="peakhour.start_time"
													id="starttimeStringid" class="form-control"
											...
											<s:if test="fieldErrors.get('starttimeString').size() > 0">
												<span style="color: red;"><s:property
														value="fieldErrors.get('starttimeString').get(0)" /></span>
											</s:if>
										</div>
										<%-- 	<div class="col-md-3">
											<div class="input-group">
												<input type="text" id="starttimeStringid"
													class="form-control input-small "
													name="peakhour.start_time"
													value="<s:property value="peakhour.start_time"/>"
								...
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">End Time<sup><font
												color="red">*</font></sup></label>
										<div class="col-md-3">
											<div class="input-group date form_datetime_bmtc_format">
												<input type="text" size="16" 
													name="peakhour.end_time" id="endtimeStringid"
													class="form-control"
													value='<s:property value="peakhour.end_time"/>'> <span
											...
											<s:if test="fieldErrors.get('endtimeString').size() > 0">
												<span style="color: red;"><s:property
														value="fieldErrors.get('endtimeString').get(0)" /></span>
											</s:if>
										</div>
										<%-- 	<div class="col-md-3">
											<div class="input-group">
												<input type="text" id="endtimeStringid"
													class="form-control input-small " name="peakhour.end_time"
									...
									<div class="form-group">
										...
										<div class="col-md-4"> 
 											<%-- <s:select list="servicelist" id="service_type_id" name="peakhour.servicetype.service_type_id"  
												...
												<input type="hidden" name="peakhour.servicetype.service_type_id" value="<s:property value="peakhour.servicetype.service_type_id"/>"/>
												<%-- <input type="text" class="form-control" id="service_type_id"
												maxlength="50" name="service_type_name" readonly="readonly"
												value='<s:property value="peakhour.servicetype.service_type_name"/>'> --%>
 											...
 											<script>$("#service_type_id").prop('disabled', true)</script>
										</div>
									</div>
								</div>
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">Rate Master
												Version:<font color="red">*</font>
											</label>
											<div class="col-md-4">

												 <select class="select2_category form-control"
													id="rateMasterId" name="peakhour.rateMaster.rateMasterId" >
													<option	value="0">Select</option>

												</select> 
												<input type="hidden" name="peakhour.rateMaster.rateMasterId" value="<s:property value="peakhour.rateMaster.rateMasterId"/>"/>
												
<!-- 												 <input type="text" class="form-control" id="rateMasterId" -->
<!-- 												maxlength="50" name="rateMasterId" readonly="readonly" -->
<%-- 												value='<s:property value="peakhour.rateMaster.versionNoServiceType"/>'> --%>
												<s:if test="fieldErrors.get('rateMasterId').size() > 0"> 
													<span style="color: red;"><s:property
															value="fieldErrors.get('rateMasterId').get(0)" /></span>
												</s:if>
												<script>$("#rateMasterId").prop('disabled', true)</script>
											</div>
										</div>
									</div>
									...
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">Percentage:<font
												color="red">*</font></label>
											<div class="col-md-2">
												<input type="text" class="form-control input-small"
													id="percentId" maxlength="5" name="peakhour.percentage"
													onblur="getLumsum()" onkeypress="getLumsum()"
													value='<s:property value="peakhour.percentage"/>'>
												<s:if test="fieldErrors.get('percentage').size() > 0">
													<span style="color: red;"><s:property
															value="fieldErrors.get('percentage').get(0)" /></span>
												</s:if>
											</div>
											<div class="col-md-1">
											...
											<div class="col-md-2">
												<label class="control-label">Lumpsum Amount:<font
													color="red">*</font></label>
											</div>
											<div class="col-md-2">
												<input type="text" class="form-control input-small"
													id="lumpsumId" maxlength="8" name="peakhour.lumpsum_amount"
													onblur="getPercent()" onkeypress="getPercent()"
													value='<s:property value="peakhour.lumpsum_amount"/>'>
												<s:if test="fieldErrors.get('lumpsum_amount').size() > 0">
													<span style="color: red;"><s:property
															value="fieldErrors.get('lumpsum_amount').get(0)" /></span>
												</s:if>
											</div>
										</div>
									</div>
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">Impact on Fare:<font
												color="red">*</font></label>
											<div class="col-md-4">
												<select class="select2_category form-control"
													id="increaseDecreaseId" name="peakhour.increase_decrease">
												...
												<s:if test="fieldErrors.get('increase_decrease').size() > 0">
													<span style="color: red;"><s:property
															value="fieldErrors.get('increase_decrease').get(0)" /></span>
												</s:if>
												<script>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<textarea rows="3" class="form-control" id="notes"
												name="peakhour.note" maxlength="60">
												<s:property value="peakhour.note" />
											</textarea>
									...
									<div class="col-md-4">
										<div class="input-group input-medium date date-picker"	data-date-format="dd/mm/yyyy" data-date-viewmode="years">
											<input class="form-control" type="text" size="16"
												...
												value='<s:property value="peakhour.Effective_start_date"/>' >
											<span class="input-group-btn">
												<button class="btn default date-set" type="button">
													<i class="fa fa-calendar"></i>
												</button>
									...
									<div class="col-md-4">
										<div class="input-group input-medium date date-picker"	data-date-format="dd/mm/yyyy" data-date-viewmode="years">
											<input class="form-control" type="text" size="16"
												...
												value='<s:property value="peakhour.Effective_end_date"/>' >
											<span class="input-group-btn">
												<button class="btn default date-set" type="button">
													<i class="fa fa-calendar"></i>
												</button>

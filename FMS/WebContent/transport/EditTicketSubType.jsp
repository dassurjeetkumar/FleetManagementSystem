...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="ticketsubtype.status"/>');
...
function check()
{
	...
	document.getElementById("form1").action="editTicketSubTypeAction.action";
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Edit Ticket Sub Type
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="" class="form-horizontal" method="POST"  name ="frm" id="form1" >
						...
						<input type="hidden" name="ticketsubtype.id" 
								value="<s:property value='ticketsubtype.id'/>" />
...
<%-- 												<input type="text" class="form-control" name="passduration.pass_type_id" id="pass_type_id" value='<s:property value="passduration.pass_type_id" /> '> --%>
											...
											name="ticketsubtype.ticket_type_id"  value='<s:property value="ticketsubtype.ticket_type_id" />'
												...
												<s:if test="fieldErrors.get('ticket_type_id').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('ticket_type_id').get(0)" /></span>
											</s:if>	 
                                       	<script>
											var orgTypeId ="<s:property value='ticketsubtype.ticket_type_id'/>";
											console.log("orgTypeId : " + orgTypeId);
											if(orgTypeId!=""){
												//$("#ticket_type_id").val(orgTypeId);
 												//document.getElementById(orgTypeId).selected= true; 
												document.getElementById("ticket_type_id").value= orgTypeId;
											}
					...
					<div class="form-group">
											...
											<s:property	value="%{fieldErrors.get('ticket_sub_type_code').get(0)}" />
												...
												<div class="form-group">
													<label class="col-md-3 control-label">Ticket SubType Kannada Name<span class="required"> * </span></label>
													<div class="col-md-4">
												<input type="text" class="form-control" name="ticketsubtype.ticket_sub_type_name_kannada" id="ticket_sub_type_name_kannada" value='<s:property value="ticketsubtype.ticket_sub_type_name_kannada" /> '>
												<span class="help-block" style="color: red"> 

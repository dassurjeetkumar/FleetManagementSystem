...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="ticketType.status"/>');
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Ticket Type
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="EditTicketTypeAction" class="form-horizontal" method="post">
							<font color="red"><s:actionerror/></font>
							<input type="hidden" name="ticketType.id" value="<s:property value="ticketType.id"/>" />

...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="busStopType.status"/>');
				...
				<%if(edit.equalsIgnoreCase("Y")){ %>
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Bus Stop Type
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="EditBusStopTypeAction" class="form-horizontal" method="post">
							<font color="red"><s:actionerror/></font>
							<br><br>							
							<input type="hidden" name="busStopType.id" value="<s:property value="busStopType.id"/>" />
							   ...
							   <%--  <div class="form-group">
										...
										<div class="col-md-3">
											<select id="status" class="form-control" name="busStopType.status" >

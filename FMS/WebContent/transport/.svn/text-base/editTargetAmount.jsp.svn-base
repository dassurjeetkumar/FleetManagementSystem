...
function save(){
	...
	/* if(process(d1).setHours(0,0,0,0) < d2.setHours(0,0,0,0) ){
		...
		if(process(d3).setHours(0,0,0,0) < d2.setHours(0,0,0,0)){
				bootbox.alert("Please create new form four for Active Schdule", function() {
	    		 document.f1.action = 'UpdateSchedule.action';
	    		 document.f1.submit(); 
               });  
		}
		else{ */
			document.f1.action = 'UpdateTargetAmountchanges.action';
   		 	document.f1.submit();
   		 /*}
...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				<div class="portlet box grey-cascade">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Edit Schedule Target Amount
						</div>
   ...
   <div class="alert alert-success alert-dismissable">
						...
						<!-- BEGIN FORM-->
						<form action="UpdateTargetAmountchanges.action" class="form-horizontal" method="post" name="f1">
...
<%-- 							s<input type="text" value="<s:property value="scheduletypeId"/>"/> --%>
							<input type="hidden" name="edittargetamt" value="getEdittargetamt"/>
							...
							<div class="form-group">
										...
										<div class="col-md-4">
								<s:textfield cssClass="form-control input-medium" name="schedule.scheduletype.scheduleName" id="scheduleNumber" theme="simple" readonly="true"></s:textfield>
								<s:hidden id="scheduletype" name="schedule.scheduletype.schedule_type_id"></s:hidden>
								</div>
										<div class="col-md-3">
<%-- 										<s:select list="scheduleTypeMap"  id="scheduletype" name="schedule.scheduletype.schedule_type_id" cssClass="select2_category form-control" ></s:select>  --%>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
								<s:textfield  cssClass="form-control input-medium" name="schedule.servicetype.serviceTypeName" id="service_type_id" theme="simple" readonly="true"></s:textfield>
								<s:hidden id="servicetype" name="schedule.servicetype.service_type_id"></s:hidden>
								</div>
										<%-- <div class="col-md-3">
							...
							<%-- <div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Brand Type<sup><font color="red">*</font></sup></label>
										<div class="col-md-3">
<%-- 										<select id="brandtype" class="form-control input-medium" name="schedule.brand.brand_type_id" tabindex="-1" title="" contenteditable="true" > --%>
<!-- 										<option value="0">Select</option> -->
<%-- 										</select> --%>
										<s:textfield cssClass="form-control input-medium" name="schedule.brand.brand_type_name" id="chart_id" theme="simple" readonly="true"></s:textfield>
										<s:hidden id="brandtype" name="schedule.brand.brand_type_id"></s:hidden>
...
<!-- 										<div class="col-md-3"> -->
<%-- 										<s:select list="depotMap" id="depot" name="schedule.depot.org_chart_id" cssClass="select2_category form-control" contenteditable="true" ></s:select> --%>
<!-- 											</div> -->
								<div class="col-md-4">
								<s:textfield cssClass="form-control input-medium" name="schedule.depot.org_name" id="chart_id" theme="simple" readonly="true"></s:textfield>
								<s:hidden id="depot" name="schedule.depot.org_chart_id"></s:hidden>
								</div>
									</div>
...
<%-- 										<s:select list="#{'Y':'Regular', 'N':'Feeder'}" name="schedule.isTrunkSchedule" id="trunk1" cssClass="form-control" ></s:select> --%>
							<s:textfield theme="simple" cssClass="form-control input-medium"  id="trunk1" maxlength="59" readonly="true"></s:textfield> 
										
 								<s:hidden theme="simple" cssClass="form-control input-medium" name="schedule.isTrunkSchedule" id="trunk2" maxlength="59" ></s:hidden> 
								...
								<div class="form-group">
										<label class="col-md-3 control-label">Target Start Date<sup><font color="red">*</font></sup></label>
										<div class="col-md-3">
											<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy">
											
												<s:textfield cssClass="form-control"  name="targetstartdate" id="targetstartdate"></s:textfield>
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
											<s:if test="fieldErrors.get('targetstartdate').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('targetstartdate').get(0)" /></span>
											</s:if>
										</div>
									</div>
								 <div class="form-group">
...
<!-- 											<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy"> -->
												...
												<s:textfield cssClass="form-control"  name="schedule.startdate" id="startdate" readonly="true"></s:textfield>
												<span class="input-group-btn">
<!-- 												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button> -->
												</span>
<!-- 											</div> -->
								...
								<div class="form-group">
										...
										<div class="col-md-3">
<!-- 											<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy"> -->
											<s:textfield cssClass="form-control"  name="schedule.endDate" id="enddate" readonly="true"></s:textfield>
												<span class="input-group-btn">
<!-- 												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button> -->
<%-- 												</span> --%>
<!-- 											</div> -->
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
										<s:textfield name="schedule.remarks" cssClass="form-control input-small" theme="simple" id="remarks" readonly="true"></s:textfield>

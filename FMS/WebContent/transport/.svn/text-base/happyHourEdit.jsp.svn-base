				...
				<div class="tab-pane active" id="tab_0">
					...
					<div class="portlet box grey-cascade">
						...
						<s:if test="hasActionErrors()">
							...
							<!-- BEGIN FORM-->
							<form action="addEditHappyHourAction.action" method="post"  id="createComplaintId" class="form-horizontal">
							<s:if test="%{insertstatus=='duplicate'}"><font color="red">Could not insert Duplicate HappyHours</font></s:if>
							<input type="hidden" name="happy.id" 
								value="<s:property value='happy.id'/>" />
							...
							<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" id="name"   readonly="readonly" maxlength="50"
								...
								<div class="col-md-3">					
						         <div class="input-group input-medium date form_datetime_bmtc_format" data-date-viewmode="years" data-date-start-date="+0d">
						        	<input type="text" size="16" name="happy.start_time"  readonly="readonly" id="starttimeStringid" class="form-control" 
							...
							<div class="form-body">	
								...
								<div class="col-md-3">					
						         <div class="input-group input-medium date form_datetime_bmtc_format" data-date-viewmode="years" data-date-start-date="+0d">
						        	<input type="text" size="16" name="happy.end_time"  readonly="readonly" id="endtimeStringid" class="form-control" 
									...
									<div class="form-group">
										...
										<div class="col-md-4"> 
 											<%-- <s:select list="servicelist" id="service_type_id" name="peakhour.servicetype.service_type_id"  
												...
												<s:select list="servicelist" cssClass="select2_category form-control" id="service_type_id" name="happy.service_type_id">
									
										</s:select>
<%-- 												<input type="hidden" name="happy.service_type_id" value="<s:property value="happy.service_type_id"/>"/> --%>
									...
									<div class="col-md-4">
										<div class="input-group input-medium date date-picker"	data-date-format="yyyy-mm-dd" data-date-viewmode="years" >
											<input class="form-control" type="text" size="16"
												name="happy.Effective_start_date" id="procuredDate1" readonly="readonly" 

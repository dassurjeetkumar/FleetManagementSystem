...
<script src="assets/admin/pages/scripts/busStop.js" type="text/javascript" varsion="2014061"></script>
...
<!-- 								</div> -->
									...
									<div class="form-group" id="busstopnudi">
										<label class="col-md-3 control-label">Bus Stop Name
											(Nudi) </label>
										<div class="col-md-6">
											<input class="form-control input-lg" placeholder=""
												id="bus_stop_name_nudi" name="bustops.bus_stop_name_nudi"
											...
											<div class="col-md-3">
												...
												<button class="btn purple" type="button" id="convert-button" onFocus="javascript:converter_data_init('bus_stop_name_nudi','busStopNameKannada')"
													>Convert</button>
<!-- 											</div> -->
...
<!-- 											</div> -->
								...
								<div class="form-group">busstopnudi
	    ...
	    success: function(data){
	      ...
	      //  document.getElementById("deviceCode").value=data[10].trim();
	       ...
	       /*  document.getElementById("code1").value=data[17].trim();
	        ...
	        if(data[44].trim()=="" || data[44].trim() == null){
	     	    document.getElementById("busstopnudi").style.display='';
// 	     	   locateMap();
	        }else{
	        	$("#busstopnudi").hide();
	        }
// 	        document.getElementById("busStopNames").value=$('<div/>').html(data[44].trim()).text();//data[27].trim();
...
$.ajax({
	...
	'&bustops.bus_stop_name_nudi='+  $("#bus_stop_name_nudi").val()+

				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Ticket Sub Type
							</div>
...
<%-- 									<%if(edit.equalsIgnoreCase("Y")){ %> --%>
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover"
								id="ticketSubTypeView">
								<thead>
									<tr>
										<th style="width1: 8px;"></th>
										<th>Ticket SubType Id</th>
										<th>Ticket SubType Code</th>
										<th>Ticket SubType Name</th>
										<th>Ticket SubType Kannada</th>
										<th>Ticket Type</th>
										<th>Notes</th>
										<th>Status</th>
										</tr>
	...
	function callEdit(){
		...
		if (cnt == 0) {
			...
			document.forms[0].action = "editTicketSubType.action?subid="+ val;
...
function callDelete(){
		...
		if (cnt == 0) {
			...
			if(isEligibleForOpertion(val)){
			document.forms[0].action = "deleteTicketSubType.action?subid="+ val;
			document.forms[0].submit();
			}else{
				bootbox.alert("Please Select Valid Record");
			}
	...
	function callCreate() {
		document.forms[0].action = "createTicketSubType.action";
		document.forms[0].submit();
	}
	
	$(document).ready(function() {
		   window.history.pushState("","", "TicketSubType.action");

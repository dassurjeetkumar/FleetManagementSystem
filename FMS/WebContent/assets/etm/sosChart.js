...
var sosChart = function() {
	...
	return {
		...
		initBarCharts : function() {
			...
			$("#barchartsos_alert").bind("plotclick", barClickalert);
			$("#barchartsos_alert").bind("plothover", barHoveralert);
...
function getBarChartInfo(baData, totalalertData) {
	...
	$.plot($("#barchartsos_alert"), data, options);
	var somePlot = $.plot($("#barchartsos_alert"), data, options);
...
function plotVehicleData(vehicleData) {
	...
	$('#totalActiveVehicle').text("Total Active Vehicles :"+(vehicleData["aaData"][0]["0"] + vehicleData["aaData"][4]["0"]));

...
var etmCharts = function() {
	...
	return {
		...
		initPieCharts : function() {
			function getEtmData() {
				var vehicleData = $.ajax({
					url : "getEtmDetails!getEtmPieChartDetails",
					dataType : 'json',
			...
			function pieClickalert(event, pos, obj) {
				...
				if(obj.series.status=='Active'){
				  ...
				  table.dataTable({
						...
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getGprsDetails?alertID="
								+ obj.series.status,
				  ...
				  table.dataTable({
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getInactiveDetails?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
		...
		initPieChartsvolvo : function() {
			//alert("in volvo1");
			function getEtmDataVolvo() {
				var vehicleData = $.ajax({
					url : "getEtmDetails!getEtmVolvoPieChartDetails",
					dataType : 'json',
					contentType : "application/json",
					global : false,
					async : true,
					success : function(response) {
						var plotVehicleResponseData = response;
						plotVehicleDataVolvo(plotVehicleResponseData);
						return response;
					}
				}).responseText;
			}
			...
			$("#alertspievolvo").bind("plothover", pieHoveralert);
			$("#alertspievolvo").bind("plotclick", pieClickalert);
			//alert("in volvo2");
			function pieHoveralert(event, pos, obj) {
				if (!obj)
					return;
			...
			function pieClickalert(event, pos, obj) {
				...
				if(obj.series.status=='Active'){
				  ...
				  table.dataTable({
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getVolvoGprsDetails?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
				  ...
				  table.dataTable({
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getInactiveVolvoDetails?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
		...
		initPieChartsingenico : function() {
			function getingenico() {
				var vehicleData = $.ajax({
					url : "getEtmDetails!getingenico",
					dataType : 'json',
					contentType : "application/json",
					global : false,
					async : true,
					success : function(response) {
						var plotVehicleResponseData = response;
						plotdataforingenico(plotVehicleResponseData);
						return response;
					}
				}).responseText;
			}
			...
			$("#alerteingenico").bind("plothover", pieHoveralert);
			$("#alerteingenico").bind("plotclick", pieClickalert);
			...
			function pieClickalert(event, pos, obj) {
				...
				if(obj.series.status=='Active'){
				  ...
				  $("#totalVehicleDetails").attr("style", "display:''");
				  $("#vstatus").html(
							"Ingenico ETIM"+ "(" + obj.series.status + ")");
				  $("#vehicle").attr("style", "display:''");
				  table.dataTable({
						"aLengthMenu" : [ [ 5, 15, 20, -1 ],
								[ 5, 15, 20, "All" ] // change
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getingenicodetails?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
		...
		initPieChartsverifone : function() {

			function getverifone(){

				
				var vehicleData = $.ajax({
					url : "getEtmDetails!getverifone",
					dataType : 'json',
					contentType : "application/json",
					global : false,
					async : true,
					success : function(response) {
						var plotVehicleResponseData = response;
						plotdataforverifone(plotVehicleResponseData);
						return response;
					}
				}).responseText;
			}
			...
			$("#alerteverifone").bind("plothover", pieHoveralert);
			$("#alerteverifone").bind("plotclick", pieClickalert);
			...
			function pieClickalert(event, pos, obj) {
				...
				if(obj.series.status=='Active'){
				  ...
				  $("#totalVehicleDetails").attr("style", "display:''");
				  $("#vstatus").html(
							"Verifone ETIM"+ "(" + obj.series.status + ")");
				  $("#vehicle").attr("style", "display:''");
				  table.dataTable({
						"aLengthMenu" : [ [ 5, 15, 20, -1 ],
								[ 5, 15, 20, "All" ] // change
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getverifonedetails?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
		...
		initPieChartsord : function() {
			function getEtmDataOrd() {
				var vehicleData = $.ajax({
					url : "getEtmDetails!getEtmOrdPieChartDetails",
					dataType : 'json',
					contentType : "application/json",
					global : false,
					async : true,
					success : function(response) {
						var plotVehicleResponseData = response;
						plotVehicleDataOrd(plotVehicleResponseData);
						return response;
					}
				}).responseText;
			}
			...
			$("#alertspieord").bind("plothover", pieHoveralert);
			$("#alertspieord").bind("plotclick", pieClickalert);
			...
			function pieClickalert(event, pos, obj) {
				...
				if(obj.series.status=='Active'){
				  ...
				  $("#totalVehicleDetails").attr("style", "display:''");
				  $("#vstatus").html(
							"Ordinary ETIM"+ "(" + obj.series.status + ")");
				  $("#vehicle").attr("style", "display:''");
				  table.dataTable({
						"aLengthMenu" : [ [ 5, 15, 20, -1 ],
								[ 5, 15, 20, "All" ] // change
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getOrdGprsDetails?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
				  ...
				  table.dataTable({
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getInactiveOrdDetails?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
		...
		initPieChartsetmping : function() {

			function getetmpingdata(){

				
				var vehicleData = $.ajax({
					url : "getEtmDetails!getetmpingdata",
					dataType : 'json',
					contentType : "application/json",
					global : false,
					async : true,
					success : function(response) {
						var plotVehicleResponseData = response;
						plotdataforetmpingdata(plotVehicleResponseData);
						return response;
					}
				}).responseText;
			...
			$("#alertetmping").bind("plothover", pieHoveralert);
			$("#alertetmping").bind("plotclick", pieClickalert);
			...
			function pieClickalert(event, pos, obj) {
				...
				if(obj.series.status=='Active'){
				  ...
				  table.dataTable({
						...
						// set the initial value
						"iDisplayLength" : 5,
						"sAjaxSource" : "getEtmDetails!getetmpingdepot?alertID="
								+ obj.series.status,
						"sPaginationType" : "bootstrap",
						"bDestroy" : true,
...
function plotVehicleData(vehicleData) {
	...
	$('#totalVehicle').text("Total ETIM:"+vehicleData["aaData"][2]["0"]);
	$
			.plot(
					$("#alertspie"),
					data,
					{
						...
						colors : [ "#FF8C00", "#708090",'#000000',"#4da74d","#cb4b4b",'#FF0FFF', "#afd8f8", 
								, "#9440ed",  '#000000' ],
						grid : {
							hoverable : true,
							clickable : true
...
function plotVehicleDataVolvo(vehicleData) {
	var data = [];
	// var series = Math.floor(Math.random() * 10) + 1;
	series = vehicleData["aaData"].length;
	...
	$('#totalVehiclevolvo').text("Total ETIM:"+vehicleData["aaData"][2]["0"]);
	$
			.plot(
					$("#alertspievolvo"),
					data,
...
function plotVehicleDataOrd(vehicleData) {
	var data = [];
	// var series = Math.floor(Math.random() * 10) + 1;
	series = vehicleData["aaData"].length;
	...
	$('#totalVehicleord').text("Total ETIM:"+vehicleData["aaData"][2]["0"]);
	$
			.plot(
					$("#alertspieord"),
					data,
...
function plotdataforingenico(vehicleData) {
	var data = [];
	// var series = Math.floor(Math.random() * 10) + 1;
	series = vehicleData["aaData"].length;
	...
	//alert(data.length);
	$('#totalingenico').text("Total ETIM:"+vehicleData["aaData"][2]["0"]);
	$
			.plot(
					$("#alerteingenico"),
					data,
...
function plotdataforverifone(vehicleData) {
	var data = [];
	// var series = Math.floor(Math.random() * 10) + 1;
	series = vehicleData["aaData"].length;
	...
	//alert(data.length);
	$('#totalverifone').text("Total ETIM:"+vehicleData["aaData"][2]["0"]);
	$
			.plot(
					$("#alerteverifone"),
					data,
...
function plotdataforetmpingdata(vehicleData) {
	var data = [];
	// var series = Math.floor(Math.random() * 10) + 1;
	series = vehicleData["aaData"].length;
	...
	//alert(data.length);
	$('#totaletmping').text("Total ETIM:"+vehicleData["aaData"][2]["0"]);
	$
			.plot(
					$("#alertetmping"),
					data,
...
function getVehicleSkipStopData(device_id) {
...
function jsFunctionForActiveVehicle(depotname,alertId){
	
	console.log(alertId);
	console.log(depotname);
	 $('#activevehicleDetails').attr("style", "display:''");
	//alert("here");
	$('#ActiveVehicleDetails').dataTable(
			{
				"aLengthMenu" : [ [ 5, 15, 20, -1 ], [ 5, 15, 20, "All" ] // change
				// per
				// page
				...
				// set the initial value
				"iDisplayLength" : 5,
				"sAjaxSource" : "getEtmDetails!getActiveVehicleDetails?&depotname="+depotname+"&alertId="+alertId,
				"sPaginationType" : "bootstrap",
				"bDestroy" : true,
				"oLanguage" : {
					"sLengthMenu" : "_MENU_ records",
	...
	jQuery('#ActiveVehicleDetails_wrapper .dataTables_filter input').addClass(
			"form-control input-medium input-inline"); // modify table
	// search input
	jQuery('#ActiveVehicleDetails_wrapper .dataTables_length select')
			.addClass("form-control input-xsmall input-inline");
	
	
}

function jsFunctionForInActiveVehicle(depotname,alertId){
	
	console.log(alertId);
	console.log(depotname);
	 $('#InactivevehicleDetails').attr("style", "display:''");
	//alert("here");
	$('#InActiveVehicleDetails').dataTable(
			{
				"aLengthMenu" : [ [ 5, 15, 20, -1 ], [ 5, 15, 20, "All" ] // change
				// per
				// page
	...
	jQuery('#InActiveVehicleDetails_wrapper .dataTables_filter input').addClass(
			"form-control input-medium input-inline"); // modify table
	// search input
	jQuery('#InActiveVehicleDetails_wrapper .dataTables_length select')
			.addClass("form-control input-xsmall input-inline");
...
function jsfunctioningenico(depotname,alertId){
		...
		$('#ActiveVehicleDetails').dataTable(
				{
					...
					// set the initial value
					"iDisplayLength" : 5,
					"sAjaxSource" : "getEtmDetails!ingenicodepot?&depotname="+depotname+"&alertId="+alertId,
					"sPaginationType" : "bootstrap",
					"bDestroy" : true,
					"oLanguage" : {
						"sLengthMenu" : "_MENU_ records",
...
function jsfunctionverifone(depotname,alertId){
		...
		$('#ActiveVehicleDetails').dataTable(
				{
					...
					// set the initial value
					"iDisplayLength" : 5,
					"sAjaxSource" : "getEtmDetails!verifonedepot?&depotname="+depotname+"&alertId="+alertId,
					"sPaginationType" : "bootstrap",
					"bDestroy" : true,
					"oLanguage" : {
						"sLengthMenu" : "_MENU_ records",
...
function jsfunctionetmping(depotname,alertId){
		...
		$('#ActiveVehicleDetails').dataTable(
				{
					...
					// set the initial value
					"iDisplayLength" : 5,
					"sAjaxSource" : "getEtmDetails!depotwisepingdetails?&depotname="+depotname+"&alertId="+alertId,
					"sPaginationType" : "bootstrap",
					"bDestroy" : true,
					"oLanguage" : {
						"sLengthMenu" : "_MENU_ records",

        	 ...
        	 // alert('inside click'+id);
        	  ...
        	  if(clickcounter==0){
        		  if($('#group_type').val()=="1"){
        			  ...
        			  $('#listbusstop tr').last().after('<tr id="rm'+clickcounter+'"><td class="srno"></td><td>'+marker.name+'(Towards:'+marker.dir+')</td><td class="busstopid" style="display:none">'+marker.id+'</td><td><button class="close" aria-hidden="true" data-dismiss="alert" type="button" onclick="removerow('+marker.id+')" ></button></td></tr>');  
        		  }else{
        		  $('#bus_stop_name').val(marker.name);
        		  $('#start_stop_id').val(marker.id);
        		  $('#listbusstop tr').last().after('<tr id="rm'+clickcounter+'"><td class="srno"></td><td>'+marker.name+'(Towards:'+marker.dir+')</td><td class="busstopid" style="display:none">'+marker.id+'</td><td><button class="close" aria-hidden="true" data-dismiss="alert" type="button" onclick="removerow('+marker.id+')" ></button></td></tr>');

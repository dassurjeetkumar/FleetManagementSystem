        ...
        initDashboardDaterange: function () {
            $('#dashboard-report-range').daterangepicker({
                ...
                function (start, end) {
                   ...
                   // alert("sai"+$('#dashboard-report-range span').html());
                    $("#daterange_id").val($('#dashboard-report-range span').html());
					...
					+ "&iDisplayStart=0&iDisplayLength=10&sSearch=",
     	 	           success: function(result) {
     	 	        	 ...
     	 	        	 if (obj != null) {
     	 	        		$("#Early").html("<B><center>Total Early "+parameter+" Vehicles:</center><h4><center>"+obj["countData"][1]+"</center>"); 
     	 	        		$("#Late").html("<B><center>Total Late "+parameter+" Vehicles:</center><h4><center>"+obj["countData"][0]+"</center>"); 
     	 	        		$("#Ontime").html("<B><center>Total Ontime "+parameter+" Vehicles:</center><h4><center>"+obj["countData"][2]+"</center>"); 
     	 	        	 }
            ...
            //alert("val is.."+$('#dashboard-report-range span').html());
            $("#daterange_id").val($('#dashboard-report-range span').html());

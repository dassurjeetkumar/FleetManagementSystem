...
function converter_data_init(path1,path2){
    ...
    $("#"+path1+"").focus();
    bind_events_data(path1,path2);
}
function bind_events_data(path1,path2){
    $("#clear-button").click(function(){
                                 $("#"+path1+"").val('').focus();
                             });
    
    $("#convert-button").click(function(){
                                   var unicode_output = kn_ascii2unicode($("#"+path1+"").val());
                                   if ($("#english-numbers").attr("checked")) {
                                       unicode_output = convert_to_english_numbers(unicode_output);
                                   }
                                   $("#"+path2+"").val(unicode_output); 
                               });

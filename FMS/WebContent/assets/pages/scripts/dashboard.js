    ...
    return {
        ...
        initCharts: function() {
            ...
            var vehicleData = $.ajax({
				url : "getRevenue!getWeeklyRevenue",
				dataType : 'json',
            ...
            //console.log("visitors"+vehicleData.responseText);
            function setVisitors(response){
            	for(var x=0;x<response.aaData.length;x++){
					console.log("vehicle Data"+response.aaData[x]);
					visitors.push(response.aaData[x]);
					}
            ...
            function setMonyhlyData(response){
            	for(var x=0;x<response.aaData.length;x++){
					console.log("MonthlyData"+response.aaData[x]);
					data1.push(response.aaData[x]);
					}
            ...
            if ($('#site_activities').size() != 0) {
                ...
                var vehicleData = $.ajax({
    				url : "getRevenue!getMonthlyevenue",
    				dataType : 'json',
    				contentType : "application/json",
    				global : false,
    				async : true,

...
<form>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Duty Type
							</div>
							...
							<%if(delete.equalsIgnoreCase("Y")){ %>
								...
								<div class="btn-group">
									...
									<%if(status.equalsIgnoreCase("ACTIVE")){ %>
										<li>
											<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=SHIFTTYPERPT'">
	...
	$('#add').click(	
			function callCreate() {
				document.forms[0].action = "createShiftType.action";
			...
			function() {
				...
				if(isEligibleForOpertion(val)){
					document.getElementById("shiftypeid").value = val;
			...
			$('#delete_').click(
					function() {
						...
						if (cnt == 0) {
							...
							//document.forms[0].submit();
							if (result == true) {
								document.getElementById("shiftypeiddetail").value = val;
...
<form name="form1" id="form1" action="editShiftType.action" method="POST">
	<input type="hidden" name="shiftypeid" id="shiftypeid" value="" />

</form>
<form name="form2" id="form2" action="deleteShiftType.action" method="POST">
	<input type="hidden" name="shiftypeiddetail" id="shiftypeiddetail" value="" />

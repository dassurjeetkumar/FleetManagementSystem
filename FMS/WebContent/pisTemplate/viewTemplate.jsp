...
function callEdit() {
	...
	if (cnt == 0) {
		...
		document.getElementById("templateid").value = val;
				...
				.confirm(
						...
						function(result) {
							...
							if (result == true) {
								...
								document.getElementById("delTemplateid").value = val;
...
function callCreate() {
	document.forms[0].action = "createPisTemplate.action";
			...
			<div class="col-md-12">
				...
				<div class="portlet box grey-cascade">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-globe"></i>View PIS Template Master
						</div>
						<div class="actions">
...
<form name="form1" id="form1" action="editPisTemplate.action"
	method="POST">
	<input type="hidden" name="templateid" id="templateid" value="" />
</form>
<form name="form2" id="form2" action="deletePisTemplate.action"
	method="POST">
	<input type="hidden" name="delTemplateid" id="delTemplateid" />
</form>
 <%}else{%>

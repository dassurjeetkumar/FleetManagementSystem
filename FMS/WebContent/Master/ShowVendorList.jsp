...
<%if (access.equalsIgnoreCase("Y")){%>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Vendor List
							</div>
							<div class="actions">
                      ...
                      <button class="btn blue dropdown-toggle"	data-toggle="dropdown"><i class="fa fa-gears"></i> Tools <i class="fa
                                    ...
                                    <a class="btn blue" href="javascript: void(0)"onclick="window.open('','_new').location.href='/its/generateReport?id=VENDORRPT'">
	...
	<script>
			...
			$('#add').click(	
			function callCreate() {
				document.forms[0].action = "ShowVendor.action";
			...
			function() {
				...
				if (cnt == 0) {
					...
					document.getElementById("vendoriddetails").value = val;
			...
			$('#delete_').click(
					function() {
						...
						var val;
						if (cnt == 0) {
							bootbox.alert("Please Select a Check box to Delete");
						} else if (cnt > 1) {
			...
			$(document).ready(function() {
				   window.history.pushState("","", "ShowVendorList.action");
...
<form name="form1" id="form1" action="DeleteRecord.action" method="POST">
<input type="hidden" name="vendorid" id="vendorid" value="" />

</form>
<form name="form2" id="form2" action="ModifyVendorDetails.action" method="POST">
	<input type="hidden" name="vendoriddetails" id="vendoriddetails" value="" />

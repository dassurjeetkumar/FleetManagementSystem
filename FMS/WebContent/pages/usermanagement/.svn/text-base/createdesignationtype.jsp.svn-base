...
function getAddDetail(){
	var name=document.getElementById('designation_type_name').value;
	if(name == ' '){
		alert("Please Enter Designation Type Name");
		return false;
	}
	
	document.forms[0].action="AddDesignationType.action";
...
<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								...
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Create Designation Type
										</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
										...
										<form class="form-horizontal" action="AddDesignationType.action" name="frm" method="post">
											...
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
													<input type="text" class="form-control" maxlength="30" style="text-transform: uppercase;" name="designationtype.designation_type_code" id="designation_type_code" value='<s:property value="designationtype.designation_type_code"/>'  >
												...
												<div class="col-md-4">
													<input type="text" class="form-control"  name="designationtype.status" id="status"  value="ACTIVE" readonly="readonly" > 
											</div>
											</div>

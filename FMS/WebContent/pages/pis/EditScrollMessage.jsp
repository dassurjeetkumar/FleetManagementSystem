	  ...
	  $.ajax({
          ...
          success: function(result) {
        	  ...
        	  if(prevType1!=""){
        			 ...
        			 var orgtypeid = document.getElementById("display_unit_id").value;
        			 var orgtype = display_unit_id.options[display_unit_id.selectedIndex].text;
...
<body onload="getBusStationNames();getDisplayUnit()">
	<%
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Scroll Message
							</div>
							<div class="tools"></div>
						</div>
						<div class="portlet-body form">
							...
							<form action="updateScrollMessage.action" class="form-horizontal"
								method="post" name="editscroll">
								<div class="form-body">
									<h1 class="intro">
...
<textarea name="pisScrollMessageModel.message" id="message" class="form-control" maxlength="100" rows="3" ><s:property value="pisScrollMessageModel.message" /></textarea>
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<s:if test="fieldErrors.get('font_color').size() > 0">
													<span style="color: red;"><s:property
															value="fieldErrors.get('font_color').get(0)" /></span>
												</s:if>
										...
										<div class="col-md-3">
											<a
												href="javascript:TCP.popup(document.forms['editscroll'].elements['pisScrollMessageModel.font_color'])">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<a
												href="javascript:TCP.popup(document.forms['editscroll'].elements['pisScrollMessageModel.background_color'])">
												<img width="15" height="13" border="0"
												alt="Click Here to Pick up the color" src="img/sel.gif">
											</a>
										</div>
										...
										<div class="col-md-4">
											<div class="input-group">
												...
												<select class="select2_category form-control"
													...
													<option
														value="<s:property value="pisScrollMessageModel.busstand.org_chart_id" />">
														<s:property
															value="pisScrollMessageModel.busstand.org_name" />
													</option>
												</select>
												...
												<input type="hidden" name="pisScrollMessageModel.pis_id"
													id="scrollmessage_id"
													value="<s:property value="pisScrollMessageModel.pis_id" />"
													maxlength="200">
												<%--  <script>
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													...
													<option
														value="<s:property value="pisScrollMessageModel.scroll_display_unit.pis_display_unit_id" />">
														<s:property
															value="pisScrollMessageModel.scroll_display_unit.pis_display_unit_name" />
													</option>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<div class="input-group input-medium date date-picker"
												...
												<input type="text" class="form-control" readonly
													...
													value="<s:property value="pisScrollMessageModel.effective_date" />">
                                        ...
                                        $('#startdate').val(curr_date);
											...
											<s:if test="fieldErrors.get('startdate').size() > 0">
												<span style="color: red;"><s:property
														value="fieldErrors.get('startdate').get(0)" />
														<script>
														$('#startdate').val("");
														</script></span>
											</s:if>
										...
										<div class="col-md-3">
											<div class="input-group input-medium date date-picker"
												...
												<input type="text" class="form-control" readonly
													...
													value="<s:property value="pisScrollMessageModel.end_date" />">
									...
									<div class="form-actions fluid">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn blue"
												onclick="return validateScrollMessage()">Save</button>

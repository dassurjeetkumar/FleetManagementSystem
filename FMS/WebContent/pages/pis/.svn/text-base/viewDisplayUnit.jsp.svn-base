...
accessrights=accessrightdao.accessRightsdetails(usrsessionid, "viewDisplayUnit.action");
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Display Unit Master</h4>
						</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
		 					<div class="caption">
								<i class="fa fa-globe"></i>View Display Unit
							</div>
							<div class="actions">
...
<%if(delete.equalsIgnoreCase("Y")){ %>
						...
						<input type="hidden" name="requestType" id="requestType" value="text"/>
							<table class="table table-striped table-bordered table-hover" id="viewDisplayUnit">
...
/* 	 $(document).ready(function() {
		...
		if (cnt == 0) {
			...
			bootbox.confirm("Are you sure you want to delete?",
					function(result)
					{
						...
						if (result == true) 
						{
			document.forms[0].action = 'deleteDisplayUnit.action?displayunitid='
				+ val;
	...
	function editDisplayMapping(){
				...
				if (cnt == 0) {
					...
					//alert(val);
					if(isEligibleForOpertion(val)){
					document.forms[0].action = 'editDisplayUnit.action?id='+ val;
					document.forms[0].submit();
					}else{
						bootbox.alert("Please Select Valid Record");
					}
	 ...
	 {
		 document.forms[0].action = "createDisplayUnit.action";
		 document.forms[0].submit();
	 }

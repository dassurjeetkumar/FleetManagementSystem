				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create Display Unit
							</div>
							<div class="tools"></div>
						</div>
						<div class="portlet-body form">
							...
							<form action="saveDisplayUnit.action" class="form-horizontal" onsubmit="return validSubmit()"
								method="post">
								<div class="form-body">
									<h1 class="intro">
									...
									<div class="form-group">
										...
										<input type="text" name="displayUnitModel.pis_display_unit_name" id="display_unitname"
													class="form-control"
													value="<s:property value="displayUnitModel.pis_display_unit_name" />" maxlength="11">
										...
										<div class="col-md-4"> 
											<div class="input-group">
												...
												<select class="select2_category form-control"
													name="displayUnitModel.display_bus_station_id.org_chart_id" id="bus_station_id"
													onchange="getFloorNames()" style="width: 200px;">
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													...
													id="floorName" style="width: 200px;" onchange="getBayNames()">
													<option value="0">Select</option>
												</select>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													name="displayUnitModel.display_bay.bay_id"
													id="bayName" style="width: 200px;" onchange="getPlatformNames()">
													<option value="0">Select</option>
												</select>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													name="displayUnitModel.platform"
													id="platformNo" style="width: 200px;" multiple="multiple">
													<option value="0">Select</option>
												</select>
									...
									<div class="form-group">
										...
										<input type="text" name="displayUnitModel.refresh_rate" id="refresh_rate"
													class="form-control"
													value="30" maxlength="6">
									 ...
									 <div class="form-group">
										...
										<div class="col-md-3">
											<select class="form-control" name="displayUnitModel.template_name" >

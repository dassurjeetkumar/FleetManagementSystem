...
function validSubmit(){
	var bus_stn=$("#bus_station_id option:selected").val();
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create Display Mapping
							</div>
							<div class="tools"></div>
						</div>
						<div class="portlet-body form">
							...
							<form action="saveDisplayMapping.action" class="form-horizontal" onsubmit="return validSubmit()"
								method="post">
								<div class="form-body">
									<h1 class="intro">
										...
										<div class="col-md-4"> 
											<div class="input-group">
												...
												<select class="select2_category form-control"
													name="displaymappingmodel.bus_station_id.org_chart_id" id="bus_station_id"
													onchange="getFloorNames(0)" style="width: 200px;">
...
<br>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													name="displaymappingmodel.floor.floor_id1"
													id="floorName" style="width: 200px;" onchange="getBayNames(0)">
													<option value="0">Select</option>
												</select>
...
<br>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													name="displaymappingmodel.bay.bay_id1"
													id="bayName" style="width: 200px;" onchange="getPlatformNames(0)">
													<option value="0">Select</option>
												</select>
...
<br>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group">
												<select class="select2_category form-control"
													name="displaymappingmodel.platform.platform_id1"
													id="platformNo" style="width: 200px;" onchange="getDisplayUnitNames(0)">
													<option value="0">Select</option>
												</select>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											...
											<select class="select2_category form-control"
												name="displaymappingmodel.display_unit.pis_display_unit_id1"
												id="display_unit_id" style="width: 200px;" onchange="onChangeDisplayUnitNames(0)">
												<option value="0">Select</option>
									...
									<input type="hidden" name="displaymappingmodel.floor.floor_id" id="f1"/>
									<input type="hidden" name="displaymappingmodel.bay.bay_id" id="b1"/>
									<input type="hidden" name="displaymappingmodel.platform.platform_id" id="p1"/>
									<input type="hidden" name="displaymappingmodel.display_unit.pis_display_unit_id" id="d1"/>

...
$(document).ready(function() {
	...
	window.history.pushState("", "", "AddCustomerAction.action");
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create PIS Customer
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="SaveCustomerAction.action" class="form-horizontal" method="post">

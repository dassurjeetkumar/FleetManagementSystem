			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							SCHEDULE WISE  TRIP  DISTANCE TRAVEL  REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Schedule Wise Trip Distance Travel
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>	<span><h4>Schedule Wise Trip Distance Travel Report</h4></span>
											...
											id="scheduleTripStatus" style="display: none" cellpadding="1">
												<thead>
													...
													<!-- 	<th style='text-align:center' rowspan="2">DUTY TYPE</th> -->
														<th style='text-align:center' rowspan="2">SCHEDULE_NAME</th>
														<th style='text-align:center' rowspan="2">VEHICLE_NO.</th>
														<th style='text-align:center'  colspan="3" >TRIPS(COUNTS)</th>
														<th style='text-align:center' colspan="3">DISTANCE</th>

														<th style='text-align:center' colspan="3">TRIP DURATION</th>

														<th style='text-align:center'  colspan="3">DEPARTURE FROM DEPOT</th>
														<th style='text-align:center'  colspan="3">ARRIVAL AT DEPOT</th>

		...
		.dataTable(
				{
					...
					"iDisplayLength" : 20,
					"sAjaxSource" : "getMissedTripsData.action?depotid="+depotNo+"&selectedDate="+choosenDate,
				...
				.dataTable(
						{
							...
							// set the initial value
							"iDisplayLength" : 20,
							"sAjaxSource" : "getMissedTripsData.action?scheduleNo="+scheduleNo+"&selectedDate="+selectedDate+"&busStopId="+busStopId,
							"sPaginationType" : "bootstrap",
							"bDestroy" : true,
							"oLanguage" : {
								"sLengthMenu" : "_MENU_ records",
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
					MISSED TRIPS  REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View  Missed Trips Report
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>	<h4>Missed Trips  Report</h4><br>
											...
											id="scheduleDepartureData" style="display: none" cellpadding="1">
												<thead>
													...
													<!-- 	<th style='text-align:center' rowspan="2">DUTY TYPE</th> -->
														...
														<th >FROM LOCATION</th>
														<th >TO LOCATION</th>
														<th >MISSED TRIPS DISTANCE(KMPH)</th>
											</tr>
												</thead>
											</table>
									</div>

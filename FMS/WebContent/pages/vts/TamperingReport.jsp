		...
		if(alertId==20||alertId==21){	
			var table;
		     ...
		     var oTable = table.dataTable({
				...
				"bSelect" : false,
                "bPaginate":false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 1
...
<body onload="getHide()">
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					BOX TAMPERING REPORT<small></small>
						</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Box Tampering Report
								</div>
							</div>
						</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>BOX TAMPERING REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "BOX TAMPERING REPORT.xls";
    ...
    document.body.removeChild(downloadLink);
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Box Tempering Report</h4>
									<br />

...
// 	}
// 	}
	function validateTripStatusReportFields(depotNo,divisonNo,selectedenddate)
	{
...
// 	     }
	...
	function getScheduledTripStatusDataOnSubmit()
	{
		...
		validateflag=validateTripStatusReportFields(depotNo,divisonNo,selectedenddate);
...
// 		alert(depotName);
	//alert("HII"+scheduleNo);
		document.getElementById("scheduleNotDeparted").style.display = '';
	//	$("#schdeviation").hide();
		document.getElementById("scheduleNotDeparted").style.display = '';
        ...
        document.getElementById('depotonheader').innerHTML=$("#depotlist option:selected").text();

		
        console.log("hiii");
		$('#scheduleNotDeparted').dataTable({
			...
			"sAjaxSource" : "schedulenotdepartedlist.action?selectedenddate="+selectedenddate+"&depotName="+depotName,
...
// 					},
		...
		jQuery(
				'#scheduleNotDeparted_wrapper .dataTables_filter input')
				.addClass("form-control input-small input-inline"); // modify
		// table
		jQuery(
				'#scheduleNotDeparted_wrapper .dataTables_length select')
...
<body>
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							SCHEDULE NOT DEPARTED REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Schedule Not Departed Report
							</div>
							<!-- <div class="tools">
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>SCHEDULE NOT DEPARTED REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "SCHEDULE NOT DEPARTED REPORT.xls";
...
<!-- 										</div> -->
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Schedule Not Departed Details</h4>
									<br />
									<div id="headerdetails" style="margin-left:0px;">
                            	        <table ID="mytable" style="width:60%;border:none;">
														<tr>
									 						<td ><b><label><font size="2">Depot:</font></label></b>
															<!-- <td style="text-align: left;"> -->
			 												<b><font size="2"><span  id="depotonheader" style="text-align: left;margin-left:10px;"></span></font></b></td>
														</tr>
														<tr>
															
															<td style="text-align: left;"><b><font size="2"><label>Date:</label></font><font size="2"><b><span id="toDate" style="text-align:left;margin-left:50px;"></span></font></b></td>
...
<!-- 								<div class="portlet-body" id="scheduleprint" style='height:310px; overflow-y:scroll; display:block;'> -->
								...
								<div id="tripstatus">
									<table class="table table-striped table-bordered table-hover"
										id="scheduleNotDeparted" style="display: none">
										<thead >
											<tr>
												<th>Sr. No</th>
												<th>Schedule No.</th>

...
"bFilter" : false,
				"bSelect" : false,
 "bPaginate":false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 24
...
<body onload="getHide()">
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					STATIONARY VEHICLE REPORT <small></small>
						</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Stationary Vehicle  Report
								</div>
							</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>STATIONARY VEHICLE REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "STATIONARY VEHICLE REPORT.xls";
    ...
    document.body.removeChild(downloadLink);
										...
										<div class="col-md-offset-3 col-md-9"> -->
											<button type="button" class="btn default" onclick="getData()">Submit</button>
										<!-- </div>
									</div> -->
									</div>
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Stationary Vehicle Report</h4>
									<br />
...
<!-- 							<div class="portlet-body" id="vtsAlertReportDivId" style='height:310px; overflow-y:scroll; display:block;display: none'> -->
							<div class="portlet-body" id="vtsAlertReportDivId" style=' display:block;display: none'>
							<div id="tripstatus">

		...
		table.dataTable({
			...
			//"iDisplayLength" : 5,
			  "bFilter" : false,
				"bSelect" : false,
                "bPaginate":false,
			"sAjaxSource" : "alertPerticular.action?alertID=18"
					,
			"sPaginationType" : "bootstrap",
			"bDestroy" : true,
		...
		var oTable1 = table1.dataTable({
			...
			//"iDisplayLength" : 5,
			 "bFilter" : false,
				"bSelect" : false,
                "bPaginate":false,
			"sAjaxSource" : "getDepotArrivalTime.action?alertID=18"
					+ "&depotID=",
			"sPaginationType" : "bootstrap",
			"bDestroy" : true,
		...
		var oTable2 = table2.dataTable({
			...
			//"iDisplayLength" : 5,
			 "bFilter" : false,
				"bSelect" : false,
                "bPaginate":false,
			"sAjaxSource" : "getDepotDepartureTime.action?alertID=18"
					+ "&depotID=",
			"sPaginationType" : "bootstrap",
			"bDestroy" : true,
		...
		//	],
			...
			//"iDisplayLength" : 5,
			 "bFilter" : false,
				"bSelect" : false,
                "bPaginate":false,
			"sAjaxSource" : "getSkippedStop.action?alertID=18"
					,
			"sPaginationType" : "bootstrap",
			"bDestroy" : true,
		...
		if(alertId==20||alertId==21){	
			var table;
		     ...
		     var oTable = table.dataTable({
				...
				"bSelect" : false,
                "bPaginate":false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 18
...
<body onload="getHide()">
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					LATE DEPARTURE REPORT <small></small>
						</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Late Departure Report
								</div>
							</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>LATE DEPARTURE REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    inputHTML += "<th colspan='2' align='left'>Date Range:</th>";
    inputHTML += "<th colspan='7' align='left'>" + $("#seldate").val() + " to " + $("#endate").val() + "</th>";
//     + " to " + $("#endate").val() + "</th>";
    inputHTML += "</tr>";
    inputHTML += "</table>";
    ...
    downloadLink.download = "LATE DEPARTURE REPORT.xls";
    ...
    document.body.removeChild(downloadLink);
  			 ...
  			 <div align='center'>
					<button type="submit" class="btn green" onClick="getAlertReportOnSubmit()">Submit</button>&nbsp;
...
<!-- 										</div> -->
										...
										<h4 style="margin-left:350px;">Late Deparature Report</h4>
									<br />
...
<!-- 													</table> -->
			 				...
			 				<br/><br/>
							<br/><br/>
							<div class="portlet-body" id="vtsAlertReportDivId" style=' display:block;'>

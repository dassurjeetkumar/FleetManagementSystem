		...
		.dataTable(
				{
					...
					"iDisplayLength" : 20,
					"sAjaxSource" : "getbusBreakDownData.action?depotid="+depotNo+"&selectedDate="+choosenDate,
				...
				.dataTable(
						{
							...
							// set the initial value
							"iDisplayLength" : 20,
							"sAjaxSource" : "getbusBreakDownData.action?scheduleNo="+scheduleNo+"&selectedDate="+choosenDate+"&busStopId="+busStopId,
							"sPaginationType" : "bootstrap",
							"bDestroy" : true,
							"oLanguage" : {
								"sLengthMenu" : "_MENU_ records",
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
                  BUS BREAKDOWN  REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View  Bus Breakdown Report
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>	<h4>Bus BreakDown Report</h4><br>

...
function getData(){
		...
		var depotName =$('#depotlist1').find(":selected").text();
		 if( div == "0" )
	        ...
	        $('#HarshbreakingData').dataTable({
    			"aLengthMenu" : [ [ 10, 15, 20, -1 ], [ 10, 15, 20, "All" ] // change
    			
    			],
    		
    			"sAjaxSource" : "getHarshBreaking.action?startdate="+dd1+"&depotlist1="+depotlist1+"&divisionlist1="+div+"&endDate="+dd2+"&depotName="+depotName,
    		...
    		jQuery(
    				'#HarshbreakingData_wrapper .dataTables_filter input')
    				.addClass("form-control input-small input-inline"); // modify
    		// table
    		jQuery(
    				'#HarshbreakingData_wrapper .dataTables_length select')
...
function printDiv() {     
    ...
    divElements += document.getElementById("HarshbreakingData").innerHTML;
    
    var noOfTableExist = 0;
	try {
		$("#HarshbreakingData table").each(function() {
			noOfTableExist++;
		});
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Driver Wise Harsh Breaking
							</div>
						</div>
...
<!-- 										<th>Depot Name</th> -->
					...
					<div style="display: none;" id="mymodal42" class="modal fade"
						...
						<div>
							...
							<div>
								<div class="portlet solid white">
									...
									<div class="portlet-body" id="modalclass42"
										style="display: none">
...
<!-- 												<th>schedule_name</th> -->
	...
	<script type="text/javascript">
      function tabletoExcel(btnExport){     
		...
		var divElements = document.getElementById("HarshbreakingData").innerHTML;
			var noOfTableExist = 0;
			try {
				$("#HarshbreakingData table").each(function() {
					noOfTableExist++;
			...
			downloadLink.download = "Driverwise Harsh Breaking Report.xls";

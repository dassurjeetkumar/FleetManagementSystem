...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="vtsalertmaster.dashboard_view"/>');

});

function SelectElement(valueToSelect)
{ 
var element = document.getElementById('dashboard_view');
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Vehicle Alert Configuration Master
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
                         <s:if test="hasActionErrors()">
							...
							<form action="updateAlertConfigMaster.action" class="form-horizontal"
								method="post">
								<div class="form-body">
								<h1 class="intro">
											...
											<div class="input-group">
												<input type="text" name="vtsalertmaster.packet_code" id="packet_code"
													...
													value="<s:property value="vtsalertmaster.packet_code" />" maxlength="11" >
													 <input type="hidden" name="vtsalertmaster.vts_id" id="alertconfigmast_id" value="<s:property value="vtsalertmaster.vts_id" />" maxlength="200">
									 ...
									 <div class="form-group">
										<label class="col-md-3 control-label">Alert Description<font color="red">*</font></label>
											<div class="col-md-4">
													...
													class="form-control"
													value="<s:property value="vtsalertmaster.alert_desc" />" maxlength="11">

...
$(document).ready(function() {
	...
	function getData() {
		console.log("inside deviated stopJSP0");
		...
		//console.log(dev);
			...
			console.log("inside deviated stopJSP");
		
			drawDeviatedRoutejsp(device_id, route_id, start_point, end_point,
				start_date,end_date);

		...
		if(alertId==20||alertId==21){	
			var table;
		     ...
		     var oTable = table.dataTable({
		            ...
		            "bSelect" : false,
		            "bPaginate":false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 12
					...
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View SoS Report
								</div>
							</div>
						 ...
						 <div class="portlet-body">
									...
									<div class="col-md-1"id="printbutton">
										...
										<div class="col-md-1"id="btn1">
											<input type='button' class="btn green" id='excel' onclick='tabletoExcel()' value='Export' />													
										</div>
										</div>
									</div>
										</div>
...
//   	           	var htmltable= document.getElementById('btnExport');   
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>Vehicle SOS Alert REPORT</th>";
  	             inputHTML += "</tr>";
  	             inputHTML += "<tr>";
  	             inputHTML += "<th colspan='2' align='left'>Date Range:</th>";
  	             inputHTML += "<th colspan='7' align='left'>" + $("#seldate").val() + "</th>";
  	             inputHTML += "</tr>";
  	             inputHTML += "</table>";
  	             ...
  	             downloadLink.download = "Vehicle SOS Alert REPORT.xls";
  	             document.body.appendChild(downloadLink);
  	             downloadLink.click();
  	             document.body.removeChild(downloadLink);
  	         }</script>
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">SOS Report details</h4>
									<br />
...
<!-- 														</tr> -->
														<tr>
															...
															<td nowrap style="text-align: left;"> <font size="2"><b><span id="selectedDate" style="text-align:left;margin-left:50px;"></span></font></b></td>
															</tr>

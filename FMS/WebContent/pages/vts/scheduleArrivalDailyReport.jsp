...
//	 alert("HEllo");
 ...
 function getDepot(orgId){
	...
	function getScheduledDepartureDataOnSubmit()
	{
		...
		//document.getElementById("scheduleArrivalDaily").style.display = '';
		//$("#schdeviation").hide();
		//document.getElementById("scheduleDepartureData").style.display = '';
		$('#scheduleArrivalDaily')
		.dataTable(
				{
					...
					"iDisplayLength" : 20,
					"sAjaxSource" : "getScheduleArrivalDataDaily.action?fromDate="+fromdate+"&tillDate="+tilldate+"&depotID="+depotID,
...
jQuery('#scheduleArrivalDaily_wrapper .dataTables_filter input').addClass(
		"form-control input-medium input-inline"); // modify table
// search input
jQuery('#scheduleArrivalDaily_wrapper .dataTables_length select').addClass(
				...
				.dataTable(
						{
							...
							// set the initial value
							"iDisplayLength" : 20,
							"sAjaxSource" : "getbusBreakDownData.action?scheduleNo="+scheduleNo+"&selectedDate="+selectedDate+"&busStopId="+busStopId,
							"sPaginationType" : "bootstrap",
							"bDestroy" : true,
							"oLanguage" : {
								"sLengthMenu" : "_MENU_ records",
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
           SCHEDULEWISE DAILY PUNCTUALITY (IN ARRIVAL) REPORT<small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View  ScheduleWise Daily Punctuality (In Arrival) Report
							</div>
						</div>
						<div class="portlet-body form">
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
							        	...
							        	<h4><span id="Depotname" ></span></b></h4>
							         	<%-- <span><h4>From Date:<font size="2"><b><span id="selectdate" ></span></b></h4></font>&nbsp;&nbsp;<h4>Till Date :<font size="2"><b><span id="tillDate" ></span></b></h4></font></span> --%>
								...
								<div class="portlet-body" id="scheduleprint"
									...
									<div id="scheduleDeparture">
											...
											id="scheduleArrivalDaily"  cellpadding="1">

...
function getData(){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getActiveVehicleList.action?startdate='+dd1+'&depotlist1='+depotlist1+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Active Vehicle Report
							</div>
						</div>

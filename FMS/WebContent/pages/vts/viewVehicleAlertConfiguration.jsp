...
<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">VEHICLE ALERT CONFIGURATION</h4>
						</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					VEHICLE ALERT CONFIGURATION <small></small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Vehicle Alert Configuration
							</div>
							<div class="actions">
						...
						<input type="hidden" name="requestType" id="requestType" value="text"/>
							<table class="table table-striped table-bordered table-hover" id="viewVehicleAlertConfig">
	...
	function editVehicleAlertConfig(){
				...
				//	alert(val);
					document.forms[0].action = 'editVehicleAlertConfig.action?alertconfigid='+ val;
					document.forms[0].submit();

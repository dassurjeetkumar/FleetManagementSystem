...
function getAlertReportOnSubmit()
{
	...
	if (givenDate != 00) {
		...
		var oTable = table.dataTable({
            ...
            "bSelect" : false,
           "bPaginate":false,
			"sAjaxSource" : "getAlertReport.action?alertID=" + 14
					+ "&depotID=" + depotID + "&givendate=" + givendate +"&todate="+todate,
			"sPaginationType" : "bootstrap",
			"bDestroy" : true,
...
window.addEventListener("load",function(){
	   $("#divisionlistid1").trigger('change.select2');
},false);
...
<body onload="getHide()">
					...
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Early Arrival  Report
								</div>
							</div>
						</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>EARLY ARRIVAL REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "EARLY ARRIVAL REPORT.xls";
			 ...
			 <div align='center'>
					...
					<span><input type='button' class='btn green' id='button1' onclick="printDiv()" value='Print' /></span>
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Early Arrival Report</h4>
									<br />

...
//$("#scheduleprint").hide();
 ...
 function printDiv() {     
	...
	//$(".mapClass").hide();
	   document.getElementById("tripstatus1").style.visibility='visible';  
 ...
 function getDepot(orgId){
	...
	function getScheduledTripStatusDataOnSubmit()
	{
		...
		//$("#scheduleprint").show();
	validateflag=validateTripStatusReportFields(depotNo,divisonNo,selecteddate);
	...
	//alert("HII"+scheduleNo);
				...
				.dataTable(
						{
							...
							"iDisplayLength" : 20,
							"sAjaxSource" : "extracttripreportlist.action?selectedDate="+selectedDate+"&depotNo="+depotNo,
		...
		jQuery('#ExtractTripStatus_wrapper .dataTables_filter input').addClass(
				"form-control input-medium input-inline"); // modify table
		// search input
		jQuery('#ExtractTripStatus_wrapper .dataTables_length select').addClass(
...
<body>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Extra Trip  Report
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Extra  Trip Report</h4>
									<br />
 								...
 								<div class="portlet-body"  style='height:310px; overflow-y:scroll; display:block;'> 
 								<div id="tripextrastatus">
									<table class="table table-striped table-bordered table-hover"
										id="ExtractTripStatus" >
										<thead>
											<tr>
												<th>#</th>
												<th>Schedule Name</th>
	...
	<div style="display: none;" id="mymodal123" class="modal fade"	tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"	aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content" style="width: 800px; height: 500px;"
				...
				<div>
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption" id="showschedulename">
								...
								<a href="javascript:;" class="collapse"> </a> 
								 <a href="javascript:;" class="reload"> </a> 
									...
									<div class="portlet-body" id="withoutbusstop">
										<table class="table table-striped table-bordered table-hover"
											id="tripExtractReportDetails123">
											<thead>
												<tr>
													<th>#</th>
													<th>Trip No:</th>

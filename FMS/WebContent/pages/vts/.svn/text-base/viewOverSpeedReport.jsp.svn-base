			...
			var table;
		     ...
		     var oTable = table.dataTable({
					...
					"bFilter" : false,
							"bSelect" : false,
							"bPaginate" : false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 6
...
<body onload="getHide()">
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					VEHICLE OVERSPEEDING REPORT <small></small>
						</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Vehicle OverSpeeding  Report
								</div>
							</div>
										...
										<div class="form-group">
											...
											<div class="col-md-3">
												<s:select list="divisionlist1" id="divisionlistid1"
													...
													headerValue="--Depot No.--" onchange="getAlertReport(this.value)">
												</s:select>
											</div>
										</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>VEHICLE OVERSPEEDING REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "VEHICLE OVERSPEEDING REPORT.xls";
    ...
    document.body.removeChild(downloadLink);
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Vehicle OverSpeeding Report</h4>
									<br />

	...
	<div class="page-content">
		<div class="row">
			<div class="col-md-6">
				...
				<h3 class="page-title">
					Scheduled Buses<small> current status</small>
				</h3>
			...
			<div class="col-md-12">
				...
				<div class="form-group" id="mapdiv">
					<table class="table table-striped">
						<tr>
						<img src="assets/images/BusIconRedFlag.png" > Start Point Of Tracking
					<img src="assets/images/busRotation/busN.png" > Current Postion Of Bus
					<img src="assets/images/Bus-Icon.png" > Bus Stops
						</tr>
						<tr>

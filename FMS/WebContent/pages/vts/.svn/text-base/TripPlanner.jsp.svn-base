				...
				<div class="tab-pane active">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Trip Planner
							</div>
						</div>
								...
								<div class="col-md-12">
									<div class="tabbable tabbable-custom tabbable-reversed">
										<ul class="nav nav-tabs">
											<li id='tab0' class='active'><a href="#tab_0" data-toggle="tab">Bus Stop Wise</a></li>
											<!-- <li id='tab1'><a href="#tab_1" data-toggle="tab">Source & Destination Wise </a></li> -->
										</ul>
										<div class="tab-content">
											<div class="tab-pane active"   id="tab_0">
												<div class="form-group">
													<label class="col-md-2 control-label">Source Stop</label>
													<div class="col-md-3">
...
function getRouteDataMap(valmap){
	...
	$plotvehicleRequest = $.ajax({
				url : "TripPlannerMapDisplayAction.action",
				data : "source="+det+"&dest="+det1,
				method : "post",
    	...
    	bootbox.alert("Source Stop and Destination Stop Can't be Same");
    	return false;
    }

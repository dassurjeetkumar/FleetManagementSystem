...
function getData(){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getVehicleMismatchFromETMToSchedule.action?startdate='+dd1+'&depotlist1='+depotlist1,
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Vehicle Mismatch Details
							</div>
						</div>

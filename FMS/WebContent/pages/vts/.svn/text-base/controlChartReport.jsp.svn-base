		...
		.dataTable(
				{
					...
					"iDisplayLength" : 20,
					"sAjaxSource" : "getbusControlChartData.action?depotid="+depotNo+"&selectedDate="+selectedDate,
...
<%--  $.ajax({
   ...
   document.getElementById('selectdate').innerHTML=choosenDate;
...
<body>
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
             CONTROL CHART  REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View  Control Chart Report
							</div>
							<!-- <div class="tools">
 ...
 --%>
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>	<h4>Control Chart Report</h4><br>
...
<!-- 												<thead> -->
													<!-- <tr bgcolor="#819FF7">
														<th style='text-align:center' rowspan="2">SR</th>
														<th style='text-align:center' rowspan="2">DUTY TYPE</th>
														<th style='text-align:center' rowspan="2">SCHEDULE_NO</th>
														<th style='text-align:center' rowspan="2">TRIP_NO</th>
														<th style='text-align:center' rowspan="2">ITS_CODE</th>
														<th style='text-align:center' rowspan="2">DEPOT</th>
														<th style='text-align:center'  colspan="2" >ROUTE</th>

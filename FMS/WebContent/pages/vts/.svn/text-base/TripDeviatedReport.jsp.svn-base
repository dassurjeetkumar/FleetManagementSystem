				...
				.dataTable(
						{
							...
							"iDisplayLength" : 20,
							"sAjaxSource" : "getDeviatedTripReportData.action?scheduleNo="+depotNo+"&selectedDate="+choosenDate+"&range="+range,
				...
				.dataTable(
						{
							...
							// set the initial value
							"iDisplayLength" : 20,
							"sAjaxSource" : "getDeviatedTripReportData.action?scheduleNo="+scheduleNo+"&selectedDate="+choosenDate+"&busStopId="+busStopId,
							"sPaginationType" : "bootstrap",
							"bDestroy" : true,
							"oLanguage" : {
								"sLengthMenu" : "_MENU_ records",
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
						TRIPS DEVIATED REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Trips Deviated Report
							</div>
							<!-- <div class="tools">

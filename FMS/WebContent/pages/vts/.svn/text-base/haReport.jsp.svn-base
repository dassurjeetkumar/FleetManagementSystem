...
<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Harsh Acceleration Report</h4>
									<br />
									</div>
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					HARSH ACCELARATION REPORT <small></small>
						</h3>
					</div>
				</div>
				<div class="row">
						...
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption" id="captionId">
									<i class="fa fa-globe"></i>Harsh Accelaration  Report
								</div>
							</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>HARSH ACCELARATION REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "HARSH ACCELARATION REPORT.xls";
...
<!-- 										 </div> -->
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<thead>
									<tr >
										<th style="width1: 8px;" align="center">Sr.No.</th>
				 						<th>Vehicle No.</th>
										<th>Depot No.</th>
										<th>Total Count</th>
									</tr>

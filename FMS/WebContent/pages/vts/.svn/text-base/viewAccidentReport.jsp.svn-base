...
<body onload="getHide()">
					...
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Accident Report
								</div>
							</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='5'>ACCIDENT REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "ACCIDENT REPORT.xls";
    ...
    document.body.removeChild(downloadLink);
										...
										<div class="col-md-offset-3 col-md-9"> -->
											<button type="button" class="btn default" onclick="getAlertReport()">Submit</button>
										<!-- </div>
									</div> -->
									</div>
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Accident Report</h4>
									<br />

...
// 		var dd2=$('#endate').val();
		...
		/* if(type==0){
			 alert("Select Type for KM Limit ");
			 return false;
		}
		if(km < 0){
			 alert("Enter kM ");
...
// 		}else{
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getExtremeKmDevices.action?startdate='+dd1+'&depotlist1='+depotlist1+'&divisionlist1='+div+'&km_limit='+km+'&type='+type,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Extreme KM Devices Report
							</div>
						</div>
...
<!-- 								</div> -->
					...
					<div class="form-group"> 
                           				...
                           				<div class="form-group">
									<label class="col-md-3 control-label">KM <font
										color="red"></font></label>
									<div class="col-md-2">
...
<!-- 									<div class="col-md-4"> -->
										<input type="text" class="form-control input-small" name="km_limit" id="km" placeholder="enter KM here">
									</div>
<!-- 								</div> -->
...
// 						console.log("Total no of tables : " + noOfTableExist);
					...
					downloadLink.download = "Extreme KM Devices Report.xls";

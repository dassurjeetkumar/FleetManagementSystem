		...
		.dataTable(
				{
					...
					"iDisplayLength" : 20,
					"sAjaxSource" : "getScheduleDepartureData.action?scheduleNo="+scheduleNo+"&selectedDate="+choosenDate+"&busStopId="+busStopId,
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							SCHEDULE DEPARTURE  REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Schedule Departure Report
							</div>
							<!-- <div class="tools">

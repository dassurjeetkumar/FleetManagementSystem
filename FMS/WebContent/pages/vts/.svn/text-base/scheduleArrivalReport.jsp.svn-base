...
//	 alert("HEllo");
 ...
 function printDiv() {     
	   ...
	   document.getElementById("scheduleArrival").style.visibility='visible';  
     document.getElementById("header").style.display='block';
     document.getElementById("header").style.visibility='none';     
     var divElements = document.getElementById("header").innerHTML;
     divElements+= document.getElementById("scheduleArrival").innerHTML;
 ...
 function getDepot(orgId){
	...
	function getScheduledArrivalDataOnSubmit()
	{
	...
	//alert("HII"+scheduleNo);
		document.getElementById("scheduleArrivalData").style.display = '';
		$("#schdeviation").hide();
		document.getElementById("scheduleArrivalData").style.display = '';
		var selectedDate=document.getElementById("selecteddate").value;
		...
		.dataTable(
				{
					...
					"iDisplayLength" : 20,
					"sAjaxSource" : "getScheduleArrivalData.action?scheduleNo="+scheduleNo+"&selectedDate="+selectedDate+"&busStopId="+busStopId,
					...
					"fnRowCallback" : function(nRow, aaData,
						...
						} else if (aaData[0] == "Daily Arrival Summary") {
					...
					"aoColumnDefs" : [ {
						...
						'aTargets' : [ 0, 1, 2, 3, 4 ]
					      ...
					      "fnCreatedCell": function (nTd, aaData, oData, iRow, iCol) {
					        ...
					        }else if ( aaData == "Daily Arrival Summary" ) {
						          $(nTd).css('color', 'red');
						          $(nTd).css('text-align', 'center');
						           $(nTd).css('font-family' ,'Times New Roman');
						           $(nTd).css('font-size' ,' 20px');
...
jQuery('#scheduleArrivalData_wrapper .dataTables_filter input').addClass(
		"form-control input-medium input-inline"); // modify table
// search input
jQuery('#scheduleArrivalData_wrapper .dataTables_length select').addClass(
...
<%--  $.ajax({
   ...
   document.getElementById('selectdate').innerHTML=selectedDate;
	...
	function getScheduledArrivalData(scheduleNo) {
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							SCHEDULE ARRIVAL  REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Schedule Arrival Report
							</div>
							<!-- <div class="tools">
						...
						<div class="portlet-body form">
							...
							$('#selecteddate').val(curr_date);
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select id="schedulelist" name="scheduleno" 
											...
											onchange="getScheduledArrivalData(this.value)">
							    ...
							    <div class="col-md-1" id="">
									<button type="button" class="btn default" onclick="getScheduledArrivalDataOnSubmit()" style="position: static;">Submit</button>
									</div> 
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>	<h4>Schedule Departure Report</h4><br>
								...
								<div class="portlet-body" id="scheduleprint"
									...
									<div id="scheduleArrival">
										
											<table class="table table-striped table-bordered table-hover" width="100%";
											id="scheduleArrivalData" style="display: none" cellpadding="1">
												<thead>
													<tr bgcolor="#819FF7">
														<th>SR.NO.</th>
													<!-- 	<th style='text-align:center' rowspan="2">DUTY TYPE</th> -->
														...
														<th >SCH. ARRIVAL TIME(HH:MM:SS)</th>
														
														<th >ACT. ARRIVAL TIME(HH:MM:SS)</th>

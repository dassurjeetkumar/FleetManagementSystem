...
<form>
	...
	<input type="hidden" id='DepotID' value="<%= session.getAttribute("orgchartid") %>" /> 
...
<!-- 									<input type="hidden" name="scheduleId" id="scheduleId" /></div>						 -->
										<div class="form-group">
											<label class="col-md-3 control-label">Device Id </label>
											<div class="col-md-4">
												<input type="text" class="form-control" id="deviceIdLate"
													name="deviceId" readonly="readonly" value=''></input>
											</div>
										</div>	 									
											<div class="form-group">
												<label class="col-md-3 control-label">Vehicle No.</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4" id="reason">
													<select id="vehicle_reason"
														...
														name="vehicle_reason">
														<option value="0">-----Select----</option>
														<option value="1">Crew OT(Dr/CR shortage)</option>
														<option value="2">Crew Late Arriva</option>
														<option value="3">Crew Late Book</option>
														<option value="4">Want of Crew(D/C)</option>
														<option value="5">Vehicle shortage</option>
														<option value="6">Vehicle repair</option>
										...
										<div class="form-group">
											<div class="form-actions fluid">
												<div class="col-md-offset-3 col-md-9">
													<button type="button" class="btn blue" onclick="getLateDeptReason()">Save</button>
													<button type="button" class="btn default" data-dismiss="modal" id="cancelLate"	aria-hidden="true">Cancel</button>
												</div>
											</div>
										</div>
									</div>
...
<!-- 									<input type="hidden" name="scheduleId" id="scheduleId" /></div>						 -->
										<div class="form-group">
											<label class="col-md-3 control-label">Device Id </label>
											<div class="col-md-4">
												<input type="text" class="form-control" id="deviceid1"
													name="deviceid1" readonly="readonly" value=''></input>
											</div>
										</div>										
											<div class="form-group">
												<label class="col-md-3 control-label">Vehicle No.</label>
											...
											<div class="form-group">
												...
												<div class="col-md-4" id="reason1">
													<select id="vehicle_reason1"
														...
														<option value="0">-----Select----</option>
														<option value="1">Crew Health Problem</option>
														<option value="2">Death News</option>
														<option value="3">Medical Reason</option>
														<option value="4">Road Free</option>
														<option value="5">Vehicle Repair</option>
														<option value="6">In N/O Schedule Morning & Late Night No Traffic</option>
														<option value="7">Other</option>
													</select>
												</div>
											</div>
										...
										<div class="form-group">
											<div class="form-actions fluid">
												<div class="col-md-offset-3 col-md-9">
													...
													<button type="button" class="btn default" data-dismiss="modal" id="cancelEarly"	aria-hidden="true">Cancel</button>
												</div>
											</div>
										</div>
									</div>
...
<!-- 									<input type="hidden" name="scheduleId" id="scheduleId" /></div>						 -->
										<div class="form-group">
											<label class="col-md-3 control-label">Device Id </label>
											<div class="col-md-4">
												<input type="text" class="form-control" id="device_ids"
													name="device_id" readonly="readonly" value=''></input>
											</div>
										</div>										
											<div class="form-group">
										...
										<div class="form-group">
											<div class="form-actions fluid">
												<div class="col-md-offset-3 col-md-9">
													...
													<button type="button" class="btn default" data-dismiss="modal" id="cancel"	aria-hidden="true">Cancel</button>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<div class="col-md-4" id="reason">
													<select id="vehicle_reason3"
														...
														<option value="2">Enountered another vehicle operating on the same route at the stop</option>
...
<!-- 									<input type="hidden" name="scheduleId" id="scheduleId" /></div>						 -->
										<div class="form-group">
											<label class="col-md-3 control-label">Device Id </label>
											<div class="col-md-4">
												<input type="text" class="form-control" id="deviceid5"
													name="deviceid5" readonly="readonly" value=''></input>
											</div>
										</div>										
											<div class="form-group">
												<label class="col-md-3 control-label">Vehicle No.</label>
										...
										<div class="form-group">
											<div class="form-actions fluid">
												<div class="col-md-offset-3 col-md-9">
													...
													<button type="button" class="btn default" data-dismiss="modal" id="canceldev"	aria-hidden="true">Cancel</button>
												</div>
											</div>
										</div>
									</div>
...
<!-- 									<input type="hidden" name="scheduleId" id="scheduleId" /></div>						 -->
										<div class="form-group">
											<label class="col-md-3 control-label">Device Id </label>
											<div class="col-md-4">
												<input type="text" class="form-control" id="deviceid7"
										...
										<div class="form-group">
											<div class="form-actions fluid">
												<div class="col-md-offset-3 col-md-9">
													...
													<button type="button" class="btn default" data-dismiss="modal" id="cancelNRD" aria-hidden="true">Cancel</button>
												</div>
											</div>
										</div>
									</div>
...
// 	 alert("  "+depotId);
	...
	var deviceId = document.getElementById('deviceIdLate').value;
...
$.ajax({
    type: "get",
    url: '<%=request.getContextPath()%>/insertLateDeptReason.action?vehicleId='+vehicleId+'&reason='+reason+'&reasonName='+text+'&desc='+desc+'&deviceNo='+deviceId,
    success: function(result) {
 	  
 	   alert("Reason inserted Successfully");
 	  jQuery('#cancelLate').click();
    }
...
function getEarlyArrivalReason(){
	...
	var depotId=document.getElementById('DepotID').value;
	var deviceNo = document.getElementById('deviceid1').value;
...
// Passing DeviceId as VehicleNo
	
	
$.ajax({
    type: "get",
    url: '<%=request.getContextPath()%>/insertEarlyArrReason.action?vehicleId='+vehicleId+'&reason='+reason+'&reasonName='+text+'&desc='+desc+'&deviceNo='+deviceNo,
    success: function(result) {
 	  
 	   alert("Reason inserted Successfully");
 	  jQuery('#cancelEarly').click();
...
function getStationaryReason(){
	...
	var deviceNo =document.getElementById('device_id').value;
...
$.ajax({
    type: "get",
    url: '<%=request.getContextPath()%>/insertStationaryReason.action?vehicleId='+vehicleId+'&reason='+reason+'&reasonName='+text+'&desc='+desc+'&deviceNo='+deviceNo,
    success: function(result) {
...
$.ajax({
    type: "get",
    url: '<%=request.getContextPath()%>/insertSkipStopReason.action?vehicleId='+vehicleId+'&reason='+reason+'&reasonName='+text+'&desc='+desc+'&deviceNo='+deviceNo,
    success: function(result) {
...
$.ajax({
    type: "get",
    url: '<%=request.getContextPath()%>/insertSOSReason.action?vehicleId='+device+'&reason='+reason+'&reasonName='+text+'&desc='+desc+'&deviceNo='+device,
    success: function(result) {
...
$.ajax({
    type: "get",
    url: '<%=request.getContextPath()%>/insertSchNotDeptReason.action?vehicleId='+vehicleId+'&reason='+reason+'&reasonName='+text+'&desc='+desc+'&deviceNo='+deviceNo,
    success: function(result) {
...
function getDeviatedReason(){
	...
	var depotId=document.getElementById('DepotID').value;
	var deviceNo=document.getElementById('deviceid5').value;
	if(reason == 0){
...
$.ajax({
    type: "get",
    url: '<%=request.getContextPath()%>/insertDeviatedReason.action?vehicleId='+vehicleId+'&reason='+reason+'&reasonName='+text+'&desc='+desc+'&deviceNo='+deviceNo,
    success: function(result) {
 	   alert("Reason inserted Successfully");
 	  jQuery('#canceldev').click();

     }
}); 
		 obj.series.status == "Deviated";

	...
	var d3=Date.parse(var2);
 	if (d1 <= d3){
        ...
        $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/getNrdVehicleData.action?startdate='+dd1+'&depotlist1='+depotlist1+'&divisionlist1='+div+'&endDate='+dd2,
            success: function(result) {
            	$('#pageLoader').hide();
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>NRD Vehicle Report
							</div>
						</div>
...
// 						console.log("Total no of tables : " + noOfTableExist);
					...
					downloadLink.download = "NRD Vehicle Report.xls";

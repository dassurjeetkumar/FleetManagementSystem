		...
		if(alertId==20||alertId==21){	
			var table;
		     ...
		     var oTable = table.dataTable({
					...
					"bSelect" : false,
	                "bPaginate":false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 21
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					SCHEDULE LATE DEPARTURE REPORT <small></small>
						</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Schedule Late Departure Report
								</div>
							</div>
						 ...
						 <div class="portlet-body">
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Schedule Late Deparature Report</h4>
									<br />

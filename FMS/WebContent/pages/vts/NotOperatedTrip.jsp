...
// 	alert(depotid);
        console.log("=="+givenDate);
	        ...
	        $('#vtsAlertReportsId').dataTable({
    			"aLengthMenu" : [ [ 10, 15, 20, -1 ], [ 10, 15, 20, "All" ] // change
    			
    			],
    		
    			"sAjaxSource" : "getNotOpeartedDetails.action?givendate=" + givenDate+"&depotid=" + depotid,
    		...
    		jQuery(
    				'#vtsAlertReportsId_wrapper .dataTables_filter input')
    				.addClass("form-control input-small input-inline"); // modify
    		// table
    		jQuery(
    				'#vtsAlertReportsId_wrapper .dataTables_length select')

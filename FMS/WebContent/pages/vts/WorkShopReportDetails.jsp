...
"bFilter" : false,
				"bSelect" : false,
 "bPaginate":false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 25
...
<body onload="getHide()">
					...
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View WorkShop  Report
								</div>
							</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>WORKSHOP REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "WORKSHOP REPORT.xls";
    ...
    document.body.removeChild(downloadLink);
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">WorkShop Report</h4>
									<br />

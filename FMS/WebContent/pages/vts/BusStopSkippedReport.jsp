...
//	 alert("HEllo");
 ...
 function getDepot(orgId){
	...
	function validateTripStatusReportFields(scheduleNo,depotNo,divisonNo,selDate,range)
	{
		 if(divisonNo==0)
		 {
	     ...
	     if(range==0)
	     {
		   alert("Please Select Time Diffference");
		   return false;
	     }
				...
				.dataTable(
						{
							...
							"iDisplayLength" : 20,
							"sAjaxSource" : "getBusSkippedReportData.action?scheduleNo="+depotNo+"&selectedDate="+choosenDate+"&range="+range,
							...
							"fnRowCallback" : function(nRow, aaData,
								...
								} else if (aaData[1] == "Division Total") {
							...
							"aoColumnDefs" : [ {
								...
								'aTargets' : [ 0, 1, 2, 3, 4 ]
							      ...
							      "fnCreatedCell": function (nTd, aaData, oData, iRow, iCol) {
							        ...
							        }else if ( aaData == "Divisoin hh Total" ) {
								          $(nTd).css('color', 'red');
								          $(nTd).css('text-align', 'center');
								           $(nTd).css('font-family' ,'Times New Roman');
								           $(nTd).css('font-size' ,' 20px');
				...
				.dataTable(
						{
							...
							// set the initial value
							"iDisplayLength" : 20,
							"sAjaxSource" : "getBusSkippedReportData.action?scheduleNo="+scheduleNo+"&selectedDate="+choosenDate+"&busStopId="+busStopId,
							"sPaginationType" : "bootstrap",
							"bDestroy" : true,
							"oLanguage" : {
								"sLengthMenu" : "_MENU_ records",
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
						BUS STOP SKIPPED REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Bus Stop Skipped Report
							</div>
							<!-- <div class="tools">
...
<!-- 									<div class="form-group" > -->
<!-- 									<label class="col-md-3 control-label">Range<font -->
<!-- 										color="red">*</font></label> -->
<!-- 									<div class="col-md-4"> -->
...
<!-- 								</div>  -->
                         ...
                         <div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<center>
										<span><h4>Late Departure Report</h4></span>
											...
											id="scheduleTripStatus" style="display: none" cellpadding="1">
												<thead>
													...
													<tr bgcolor="#819FF7">
														...
														<th>SCHEDULE NO.</th>
														<th>DUTY</th>
														<th>No.Of Bus Stop Skipped </th>
														<th>Bus Stop Names</th>

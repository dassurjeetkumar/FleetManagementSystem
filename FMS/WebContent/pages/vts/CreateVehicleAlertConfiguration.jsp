...
function validate(){
	var vts_id=document.getElementById("vts_id").value;
	var packetcode=document.getElementById("packet_code").value;
	var miscbytes=document.getElementById("mis_bytes").value;
	var timeduration=document.getElementById("time_duration").value;
	if(vts_id==0){
		alert("please select vehiclealertconfig");
		return false;
	} 
	/* else if(packetcode==0){
		alert("please insert packet code");
		return false;
	}
	else if(miscbytes==0){
		alert("please insert misc bytes");
		return false;
	} */
	else if(timeduration==0){
		alert("please insert time duration");
		return false;
	}else{
		return true;
	}
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create Vehicle Alert Configuration
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
                         <s:if test="hasActionErrors()">
							...
							<form action="saveAlertConfig.action" class="form-horizontal"
								method="post">
								<div class="form-body">
								<h1 class="intro">
                                   ...
                                   <div class="form-group">
									...
									<div class="form-actions fluid">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn blue" onclick="return validate()">Save</button>

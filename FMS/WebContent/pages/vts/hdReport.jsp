...
// 					"iDisplayLength" : 5,
	 "bFilter" : false,
                ...
                "bPaginate":false,
					...
					"sAjaxSource" : "getAlertReport.action?alertID=" + 3
...
function getHADataPerticular(deviceID,ist_date){
	...
	$('#hddetails').dataTable(
			{
				...
				// set the initial value
				"iDisplayLength" : 5,
				"sAjaxSource" : "vehicleAlertAccDetails!vehicleAlertDeaccDetailsReport?device_id="
	...
	jQuery('#hddetails_wrapper .dataTables_filter input').addClass(
			"form-control input-medium input-inline"); // modify table
	// search input
	jQuery('#hddetails_wrapper .dataTables_length select')
			.addClass("form-control input-xsmall input-inline");
...
<body onload="getHide()">
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					HARSH BREAKING REPORT <small></small>
						</h3>
					</div>
				</div>
				<div class="row">
						...
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption" id="captionid">
									<i class="fa fa-globe"></i>Harsh Breaking  Report
								</div>
							</div>
    ...
    inputHTML += "</tr>";
    inputHTML += "<th  align='left'colspan='9'>HARSH BREAKING REPORT</th>";
    inputHTML += "</tr>";
    inputHTML += "<tr>";
    ...
    downloadLink.download = "HARSH BREAKING REPORT.xls";
    ...
    document.body.removeChild(downloadLink);
										...
										<div class="col-md-offset-3 col-md-9"> -->
										 ...
										 <button type="button" id="btnExport" class="btn default" onclick="tabletoExcel();"> EXPORT </button>
			...
			<div class="modal-content" style="width: 800px; height: 500px;"
				...
				<div class="modal-header">
					...
					<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Harsh Breaking Report</h4>
									<br />
									</div>
				<div>
					<p>

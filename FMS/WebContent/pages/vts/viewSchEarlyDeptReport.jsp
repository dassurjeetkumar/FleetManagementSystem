		...
		if(alertId==20||alertId==21){	
			var table;
		     ...
		     var oTable = table.dataTable({
				...
				"bSelect" : false,
                "bPaginate":false,
					"sAjaxSource" : "getAlertReport.action?alertID=" + 20
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">
	 					SCHEDULE EARLY DEPARTURE REPORT <small></small>
						</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box grey-cascade">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Schedule Early Departure Report
								</div>
							</div>
						 ...
						 <div class="portlet-body">
							...
							<div id="header" class="portlet-body" style="display: none; visibility: hidden;">
										<h4 style="margin-left:350px;">Schedule Early Deparature Report</h4>
									<br />

...
<script src="assets/etm/deviceChart.js"
	type="text/javascript"></script>
<%-- 	<script src="assets/etm/deviceNRDChart.js" --%>
<%-- 	type="text/javascript"></script> --%>
...
// var check=$("#Trimax").val();
// var check1=$("#Hanover").val();
// var value="";
// alert(check);
// if(check=="Trimax"){
// 	value="Trimax";
// }else if(check1=="Hanover"){
// 	value="Hanover";
// }
// alert(value);
...
function check(){
	...
	var check1=$('input:radio[name=radio]:checked').val();
		getDeviceDataDashboard(check1);
		getDeviceNRDDataDashboard(check1);
		$(NRDDevice).show();
		$(Alldevice).hide();
		$(NRDDetails).hide();
		$(vdataid).hide();
				...
				<div class="col-md-12">
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><b>Select Option</b>
							</div>
							<div class="tools">
                       ...
                       <div id="checkboxid">
				<label style="font-weight: bold;font-size:15pt;" ><input type="radio" name="radio" value="Trimax" id="Trimax"  onclick="check()"  >Trimax</label>
				<label style="font-weight: bold;font-size:15pt; margin-left:80px;" ><input type="radio" name="radio" value="Hanover" id="Hanover" onclick="check()" > Hanover</label>
              <label style="font-weight: bold;font-size:15pt;margin-left:80px;" ><input type="radio" name="radio" value="Volvo" id="Volvo" onclick="check()" > Volvo</label>      
                         </div>
						</div>
...
<!-- 						</div> -->
			...
			<div class="row">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><b>DEVICE </b>
							</div>
							<div class="tools">
					...
					<div class="col-md-3" id="NRDDetails">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><b> DVP </b>
							</div>
							<div class="tools">
								<a class="collapse" id="vehicle_chart_live2" href="javascript:;">
								</a> <a class="config" data-toggle="modal" href="#portlet-config">
								</a> <a class="reload" href="javascript:;"> </a> <a class="remove"
									href="javascript:;"> </a>
							</div>
						</div>
							<div class="portlet-body" id="chart_live_display2">
							<h4 id="totalDetailsNRD"></h4>
							<p id="demo2"></p>
							<div id="alertspieNRDDETAILS" class="chart"></div>
						</div>
					</div>
				</div>
				
				
				<div class="col-md-3" id="NRDDevice">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><b> NRD DEVICE </b>
							</div>
							<div class="tools">
								<a class="collapse" id="vehicle_chart_live1" href="javascript:;">
								</a> <a class="config" data-toggle="modal" href="#portlet-config">
								</a> <a class="reload" href="javascript:;"> </a> <a class="remove"
									href="javascript:;"> </a>
							</div>
						</div>
							<div class="portlet-body" id="chart_live_display1">
							<h4 id="totalVehicleNRD"></h4>
							<p id="demo1"></p>
							<div id="alertspieNRD" class="chart"></div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12" id="vdataid">
					<div class="portlet box blue">
						<div class="portlet-title" >
							<div class="caption" >
...
<!-- 						DVP Start -->
								...
								<div class="portlet-body" id="dvp" style="display: none">
							<table class="table table-striped table-bordered table-hover"
								id="dvp_dashboard_operable">
								<thead>
									<tr>
										<th>Sr. No.</th>
										<th>Device No</th>
						...
						<div class="portlet-body" id="dvp" style="display: none">
							<table class="table table-striped table-bordered table-hover"
								id="dvp_dashboard_Scrap Proposal">
								<thead>
									<tr>
										<th>Sr. No.</th>
										<th>Device No</th>
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<div class="portlet-body" id="dvp" style="display: none">
							<table class="table table-striped table-bordered table-hover"
								id="dvp_dashboard_Authorized Dealer">  
								<thead>
									<tr>
										<th>Sr. No.</th>
										<th>Device No</th>
								...
								<div class="portlet-body" id="dvp" style="display: none">
							<table class="table table-striped table-bordered table-hover"
								id="dvp_dashboard_Police_Station">  
								<thead>
									<tr>
										<th>Sr. No.</th>
										<th>Device No</th>
...
<script>
	$(document).ready(function() {
		...
		$(NRDDevice).hide();
		var devicetype="All";
		getDeviceDataDashboard(devicetype);
		getNRDDetailsDashboard(devicetype);
	});
</script>
<script>
	google.maps.event.addDomListener(window, 'load', initialize);
	$("#mnu_header li").removeClass("classic-menu-dropdown active");
	$("#mnu_device").addClass("classic-menu-dropdown active");
	$("#mnu_header li").addClass("classic-menu-dropdown");
	$("#device_selected").addClass("selected");

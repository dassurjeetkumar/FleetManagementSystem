				...
				<!-- BEGIN PAGE TITLE & BREADCRUMB-->
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create Dashboard 
							</div>
						...
						<s:if test="hasActionErrors()">
							...
							<!-- BEGIN FORM-->
							<form action="createDashboardName.action" id="createDashboardName" class="form-horizontal" method="post">
...
<!-- 								</div> -->
		...
		<%-- <form action="saveDashboard.action" class="form-horizontal" method="post">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												 <div class="input-group">
													<s:select list="dashboardlist" id="useriddetailss"
...
function getGroup(){
	...
	var id=document.getElementById("useriddetailss").value;

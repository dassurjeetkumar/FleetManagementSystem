...
// 		$("#tripstatus").show();
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxtripwiseLateDepartureReport.action?scheduleNo='+ scheduleNo+'&selectedDate='+selecteddate+'&depotName='+depotName,
	           success: function(result) {
	        	   $('#pageLoader').hide();
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							TRIPWiSE LATE DEPARTURE REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Tripwise Late Departure Report
							</div>
							<div class="actions">
...
// 					getDepot("");
  	             ...
  	             downloadLink.download = "TRIP WISE LATE DEPARTURE REPORT.xls";

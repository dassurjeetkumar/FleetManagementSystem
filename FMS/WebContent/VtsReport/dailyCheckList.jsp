...
//  	if (d1 <= d3){
       ...
       $.ajax({
            ...
            type: "post",
            url: '<%=request.getContextPath()%>/AjaxdailyCheckList.action?startdate='+dd1+'&depotlist1='+depot+'&divisionlist1='+div,
            success: function(result) {
            	$('#pageLoader').hide();
                document.getElementById('dailychecklistid').innerHTML=result;
                fixHeader();
            }
        });
// 		}else{
...
//  			$('#pageLoader').hide();
//  			 document.getElementById('dailychecklistid').innerHTML="";
// 		}
...
function printDiv() {     
    ...
    divElements += document.getElementById("dailychecklistid").innerHTML;
    
    var noOfTableExist = 0;
    try{
		$("#dailychecklistid table").each(function(){
			noOfTableExist++;
		});
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Daily Check List
							</div>
						</div>
										...
										<div class="col-md-4">
											...
											name="divisionlist1"  
												cssClass="select2_category form-control"  
												 onchange="getDepot(this.value)" headerKey="0" headerValue="select division"></s:select>  
...
<!-- 								<input id="enddate" class="form-control" type="text" readonly="" size="16" name="effectiveStartDate"> -->
<%-- 								<span class="input-group-btn"> --%>
<!-- 								<button class="btn default date-set" type="button"> -->
<!-- 								<i class="fa fa-calendar"></i> -->
<!-- 								</button> -->
...
<!-- 								</div></div> -->
 	                     ...
 	                     function tabletoExcel(btnExport){
 	                    	 ...
 	                    	 var divElements = document.getElementById("header").innerHTML;
 	                      var  divElements = document.getElementById("dailychecklistid").innerHTML;
 	                  ...
 	                  downloadLink.download = "Daily check list.xls"; 
					...
					<button type="button" class="btn blue" id="btnExport"  onclick="tabletoExcel();"> EXPORT </button>
<%--                    <span><input type='button' class='btn green' id='button1' onclick='printDiv()' value='Print' /></span>&nbsp;<span> --%>
				</div>
					<div id="dailychecklistid"></div>
			</div>

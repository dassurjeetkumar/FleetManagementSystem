...
// 		$("#tripstatus").show();
		 $.ajax({
	           type: "get",
	           url: '<%=request.getContextPath()%>/AjaxtripwiseEarlyDepartureReport.action?scheduleNo='+ scheduleNo+'&selectedDate='+selecteddate+'&depotName='+depotName,
	           success: function(result) {
	        	   $('#pageLoader').hide();
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">
							TRIP WiSE EARLY DEPARTURE REPORT <small></small>
						</h3>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>View Trip wise Early Departure Report
							</div>
...
// 					getDepot("");
  	             ...
  	             inputHTML += "</tr>";
  	             inputHTML += "<th  align='left'colspan='9'>TRIP WISE EARLY DEPARTURE REPORT</th>";
  	             inputHTML += "</tr>";
  	             inputHTML += "<tr>";
  	             ...
  	             downloadLink.download = "TRIP WISE EARLY DEPARTURE REPORT.xls";

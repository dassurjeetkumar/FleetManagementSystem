...
//       alert( "Please select vehicle" );
   ...
   {
      //alert( "Please select vehicle" );
       bootbox.alert("Please select Schedule No");
      return false;
   }
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>DEVICE STATUS REPORT
							</div>
						</div>
						 ...
						 <form action="" method="post" class="form-horizontal" >
                           <div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Device Type<font
											color="red">*</font></label>
										<div class="col-md-4">
											<s:select list="devicetypelist" id="devicetype" 
											name="divisionlist1"  
								...
								<div class="form-group">
									<label class="col-md-3 control-label">Vehicle Type<font
										color="red">*</font></label>
									<div class="col-md-4">
										<select  id="vehicletype" class="select3_category form-control" name="vehicletype" onchange="getSchedule(this.value)" 
 											> 
											<option value="0">--select--</option>
											<option value="1">Active</option>
											<option value="2">NRD</option>
											<option value="3">Int.Battary</option>
 										</select> 
									</div>
 								</div> 
...
<%-- 							<div id="NoData" align="center"><span><lable>No Data Found</lable></span></div> --%>
                         ...
                         <div align='center'>
					<button type="button" class="btn green" onClick="getScheduleData()">Submit</button> 

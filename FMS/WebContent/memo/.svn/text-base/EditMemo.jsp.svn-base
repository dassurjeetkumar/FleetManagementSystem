				...
				<font color="red"><s:actionmessage/></font>
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Memo Notice
							</div>
						...
						<s:if test="hasActionErrors()">
							...
							<!-- BEGIN FORM-->
							<form action="addEditedMemo.action" method="post"  id="createComplaintId" class="form-horizontal">
							<input type="hidden" name="memo.memo_id" value="<s:property value="memo.memo_id"/>"/>
									...
									<div class="col-md-4">
										<select class="form-control" id="status" name="memo.status">
											...
											<option id="deactive" value="INACTIVE">INACTIVE</option>
														...
														<script>
															var status = "<s:property value="memo.status"/>";
															if (status != undefined) {
																if (status == "ACTIVE"
																		|| status == "ACTIVE") {
																	document
									...
									<div class="col-md-4">
										<div class="input-group input-medium date date-picker"	data-date-format="dd-mm-yyyy" data-date-viewmode="years" >
											<input class="form-control" type="text" size="16"
												name="memo.date" id="incident_date" 

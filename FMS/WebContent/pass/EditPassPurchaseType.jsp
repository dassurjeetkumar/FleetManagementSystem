...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="passpurchase.status"/>');
...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Edit Pass Purchase Type
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="editPassPurchaseTypeAction.action" class="form-horizontal" method="POST"  name ="frm" >
						
						<input type="hidden" name="passpurchase.pass_purchase_id" 
								value="<s:property value='passpurchase.pass_purchase_id'/>" />
							...
							<div class="form-group">
													...
													<div class="col-md-4">
												<input type="text" class="form-control" name="passpurchase.pass_purchase_name" id="pass_purchase_name" value='<s:property value="passpurchase.pass_purchase_name" /> '>

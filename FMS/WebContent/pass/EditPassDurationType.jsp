...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="passduration.status"/>');
...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Edit Pass Duration Type
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="editPassDurationTypeAction.action" class="form-horizontal" method="POST"  name ="frm" >
						
						<input type="hidden" name="passduration.pass_duration_id" 
								value="<s:property value='passduration.pass_duration_id'/>" />
							...
							<div class="form-group">
													<label class="col-md-3 control-label">Pass Duration(In Month):<span class="required"> * </span></label>
													<div class="col-md-4">
					...
					<div class="form-body"> 
									...
									<s:select list="passtype1" cssClass="select2_category form-control" id="pass_type_id" name="passduration.pass_type_id">
								...
								<div class="form-body"> 
									<div class="form-group">
										<label class="col-md-3 control-label">
											Pass Sub Type Name:<font color="red">*</font>
										</label>
										<div class="col-md-4"> 
													
									<s:select list="passsubtype" cssClass="select2_category form-control" id="pass_sub_type_id" name="passduration.pass_sub_type_id">

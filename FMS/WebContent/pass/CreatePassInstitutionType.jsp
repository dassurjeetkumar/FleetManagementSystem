...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Create Pass Institution Type
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="createPassInstitutionTypeAction.action" class="form-horizontal" method="POST"  name ="frm" >
			...
			<font color="red"><s:actionerror/></font>  <br>
							<div class="form-group">
													<label class="col-md-3 control-label">Pass Institution Name:<span class="required"> * </span></label>
													<div class="col-md-4">

				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Pass Rate 
							</div>
							<div class="actions">
...
<%if(edit.equalsIgnoreCase("Y")){ %> <a href="#" class="btn blue" id="editPassMaster"
									> <i class="fa fa-pencil"></i>
									Edit
								</a><%}%>

<%if(delete.equalsIgnoreCase("Y")){ %>
								 <a href="#" class="btn red" id="deletePassMaster"
...
<!-- 											<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=PASSRATEMASTERRPT'"> -->
...
<!-- 							   </div> -->
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<thead>
									<tr>
										...
										<th>Pass Issuer Name</th>
										<th>Pass Type Name</th>
										<th>Pass Purchase Name</th>
										<th>Service Type Name</th>
										<th>Pass SubType </th>
										<th>Pass Distance Name</th>
										<th>Pass Duration Name</th>
										<th>Pass Cast Name</th>
	...
	<script>
			...
			function callCreate() {
				document.forms[0].action = "PassRateAction!add";
				document.forms[0].submit();
			}
			$(document).ready(function() {

				window.history.pushState("", "", "PassRateAction!view");
...
<form name="form1" id="form1" action="DeletePassRateAction.action" method="POST">
 	<input type="hidden" name="id" id="did" value="" /> 

 </form>
<form name="form2" id="form2" action="PassRateAction!edit" method="POST">

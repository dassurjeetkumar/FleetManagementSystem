...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="passdistance.status"/>');
...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Edit Pass Distance Type
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="editPassDistanceTypeAction.action" class="form-horizontal" method="POST"  name ="frm" >
						
						<input type="hidden" name="passdistance.pass_distance_id" 
								value="<s:property value='passdistance.pass_distance_id'/>" />

...
function cancelform(){
	window.location.href = 'PassCounterMaster.action';
}
...
<div class="page-content-wrapper">
			...
			<div class="tab-pane active" id="tab_0">
				...
				<div class="row">
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Create Pass Counter Master
						</div>
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="createPassCounterMasterTypeAction.action" class="form-horizontal" method="POST"  name ="frm" >
			...
			<font color="red"><s:actionerror/></font>  <br>
									...
									<s:select list="centerissuerlist" cssClass="select2_category form-control" id="pass_issue_center_id" name="passcountermaster.pass_issue_center_id">
		     								...
		     								<span style="color:red;"><s:property value="fieldErrors.get('pass_issue_center_id').get(0)" /></span> 
												...
												<div class="form-group">
													<label class="col-md-3 control-label">Pass Counter number:<font color="red">*</font><span class="required"></span></label>
													<div class="col-md-4">

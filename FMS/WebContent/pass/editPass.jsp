...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="passRate.status"/>');
				...
				<%if (edit.equalsIgnoreCase("Y")){%>
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Pass Rate Master
							</div>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><span id="integerVal"></span></font>
							...
							<form action="EditPassRateAction.action" onsubmit="return checkInt()" class="form-horizontal" method="post">
								<font color="red"><s:actionerror/></font>  
								<%-- <font color="red"><span id="integerVal"></span></font> --%>
							
								<input type="hidden" name="passRate.id" 
								value="<s:property value='passRate.id'/>" />
								<div class="form-body">
		                           ...
		                           <s:select list="passPassengerTypeMap" id="passenger_type" name="passRate.passenger_type" 
		                             cssClass="select2_category form-control" headerKey="0" headerValue="Select"></s:select>
                                       	...
                                       	<script>
											var orgTypeId ="<s:property value='passRate.passenger_type'/>";
											if(orgTypeId!=""){
								...
								<div class="form-body">
		                           ...
		                           <s:select list="passissuerTypeMap" id="pass_issuer_type" name="passRate.pass_issuer_type" 
		                             cssClass="select2_category form-control" headerKey="0" headerValue="Select"></s:select>
                                           ...
                                           <script>
											var orgTypeId ="<s:property value='passRate.pass_issuer_type'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 
									...
									<div class="form-group">
										...
										<div class="col-md-4">
		                                 ...
		                                 <s:select list="passTypeMap" id="pass_type_id" name="passRate.pass_type_id" 
                                          ...
                                          <script>
											var orgTypeId ="<s:property value='passRate.pass_type_id'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 
...
<!-- 								</div> -->
								<div class="col-md-4">
		                             ...
		                             <select class="select2_category form-control" name="passRate.pass_sub_type_id" id="pass_sub_type_id">
											...
											<s:if test="fieldErrors.get('pass_sub_type_id').size() > 0">
											 ...
											 <script>
											var orgTypeId ="<s:property value='passRate.pass_sub_type_id'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 
									...
									<div class="form-group">
										...
										<div class="col-md-4">
		                                 ...
		                                 <s:select list="castcategory" id="pass_cast_id" name="passRate.pass_cast_id" 
                                          ...
                                          <script>
											var orgTypeId ="<s:property value='passRate.pass_cast_id'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 
								...
								<div class="form-body">
		                           ...
		                           <s:select list="passpurchaseTypeMap" id="pass_purchase_type" name="passRate.pass_purchase_type" 
		                             cssClass="select2_category form-control" headerKey="0" headerValue="Select"></s:select>
											...
											<s:if test="fieldErrors.get('passType.pass_purchase_type').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('passType.pass_purchase_type').get(0)" /></span>
											</s:if>	 
                                        <script>
											var orgTypeId ="<s:property value='passRate.pass_purchase_type'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 
		                           ...
		                           <s:select list="passdistanceTypeMap" id="pass_distance_type" name="passRate.pass_distance_type" 
		                             cssClass="select2_category form-control" headerKey="0" headerValue="Select"></s:select>
											...
											<s:if test="fieldErrors.get('passType.pass_distance_type').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('passType.pass_distance_type').get(0)" /></span>
											</s:if>	 
                                         <script>
											var orgTypeId ="<s:property value='passRate.pass_distance_type'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 
								...
								<div class="form-body">
		                           ...
		                           <s:select list="passdurationTypeMap" id="pass_duration_type" name="passRate.pass_duration_type" 
		                             cssClass="select2_category form-control" headerKey="0" headerValue="Select"></s:select>
											...
											<s:if test="fieldErrors.get('passType.pass_duration_type').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('passType.pass_duration_type').get(0)" /></span>
											</s:if>	 
                                    <script>
											var orgTypeId ="<s:property value='passRate.pass_duration_type'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 
					...
					<div class="form-body">
		                           ...
		                           <s:select list="ServiceTypeMap" id="service_type_id" name="passRate.service_type_id" 
		                             cssClass="select2_category form-control" headerKey="0" headerValue="Select"></s:select>
											...
											<s:if test="fieldErrors.get('passRate.service_type_id').size() > 0">
		     								<span style="color:red;"><s:property value="fieldErrors.get('passRate.service_type_id').get(0)" /></span>
											</s:if>	 
                                         <script>
											var orgTypeId ="<s:property value='passRate.service_type_id'/>";
											if(orgTypeId!=""){
 												document.getElementById(orgTypeId).selected= true; 

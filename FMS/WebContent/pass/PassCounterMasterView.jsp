...
<%-- 		<%if (access.equalsIgnoreCase("Y")){%> --%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						PASS COUNTER MASTER   <small></small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Pass Counter Master
							</div>
...
<%-- 									<%if(edit.equalsIgnoreCase("Y")){ %> --%>
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover"
								id="passissuercountertypeview">
								<thead>
									<tr>
										<th style="width1: 8px;"></th>
										<th>Pass Counter Master Id</th>
										<th>Pass Counter Master Name</th>
										<th>Pass Center Name</th>
										<th>Pass Counter Number</th>
										<th>Terminal</th>
										<th>Status</th>
										<th>Remarks</th>
										</tr>
	...
	function callEdit(){
		...
		if (cnt == 0) {
			...
			document.forms[0].action = "editpassCounterMaster.action?passid="+ val;
...
function callDelete(){
		...
		if (cnt == 0) {
			...
			if(isEligibleForOpertion(val)){
			document.forms[0].action = "deletepassCounterMaster.action?passid="+ val;
			document.forms[0].submit();
			}else{
				bootbox.alert("Please Select Valid Record");
			}
	...
	function callCreate() {
		document.forms[0].action = "createpassCounterMaster.action";
		document.forms[0].submit();
	}
	
	$(document).ready(function() {
		   window.history.pushState("","", "PassCounterMaster.action");

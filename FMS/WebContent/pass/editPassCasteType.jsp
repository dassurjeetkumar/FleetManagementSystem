...
jQuery(document).ready(function(){
	 ...
	 SelectElement('<s:property value="passcastetype.status"/>');
...
function cancelform(){
	window.location.href = 'PassCasteTypeAction.action';
}
</script>
...
<div class="page-content-wrapper">
   ...
   <div class="alert alert-danger">
			...
			<s:actionerror/> </span>
					...
					<form action="editPassCasteTypeAction.action" class="form-horizontal" method="POST"  name ="frm" >
						
						<input type="hidden" name="passcastetype.pass_cast_id" 
								value="<s:property value='passcastetype.pass_cast_id'/>" />

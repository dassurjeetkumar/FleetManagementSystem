				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Revenue Sector
							</div>
						...
						<div class="portlet-body form">
							...
							<s:actionmessage />
							<!-- BEGIN FORM-->
							<form action="addEditedRevenueSector.action" method="post"
...
{	var param = $('#geodata').val();
	window.open("RevenueSector/editRevenueGeoFence.jsp","Edit GeoFence", "width=500, height=500");
	}
</script>

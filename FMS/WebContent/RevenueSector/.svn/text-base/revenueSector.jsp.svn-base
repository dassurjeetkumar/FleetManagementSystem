...
<%if (access.equalsIgnoreCase("Y")){%>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Revenue Sector
							</div>
							<div class="actions">
	...
	function callEdit() {
		...
		if (cnt == 0) {
			...
			document.forms[0].action = 'editRevenueSector.action?revenueSectorId='+val;
...
// 									document.getElementById("form1").action = "editDevice.action";
		...
		function callCreate() {
			...
			document.forms[0].action = "CreateRevenueSector.action";
			document.forms[0].submit();
		}
...
<form name="form2" id="form2" action="deleteRevenueSector.action"
	method="POST">

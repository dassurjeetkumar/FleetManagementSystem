...
function check()
{
	...
	function validate() {
		...
		document.forms[0].action = 'createRevenueAction.action';
		document.forms[0].submit();
	}
	function goView() {
		document.forms[0].action = 'viewRevenueSectorList.action';
		document.forms[0].submit();
	}
</script>
				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Create Revenue Sector
							</div>
						...
						<div class="portlet-body form">
							...
							<s:actionmessage />
							<!-- BEGIN FORM-->
							<form action="createRevenueAction.action" name="RevenueSector"
							...
							<div>
								<div class="portlet solid purple" >
									...
									<input id="pac-input" class="form-control input-lg" size="100" type="text" placeholder="Search Box">
										<div id="gmap_marker_revenueSector" class="gmaps" ></div>
									</div>
								</div>
							</div>
...
function initializea()
   {
	window.open("RevenueSector/RevenueGeoMap.jsp", "Capture GeoFence", "width=500, height=500");
	}
</script>

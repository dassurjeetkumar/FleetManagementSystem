...
<%if (access.equalsIgnoreCase("Y")){ %>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>View Training
							</div>
							<div class="actions">
							...
							<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right ">
										...
										<%if(status.equalsIgnoreCase("ACTIVE")){ %>
											<a class="btn blue" href="javascript: void(0)" onclick="window.open('','_new').location.href='/its/generateReport?id=TRAININGRPT'">
						...
						<div class="portlet-body">
							...
							<s:if test="%{deletestatus=='fail'}">
								Could Not Delete Training Details
							</s:if>
							</div>
							<table class="table table-striped table-bordered table-hover"
								...
								<thead>
									<tr>
										...
										<th>Duration</th>
										<th>Status</th>
										<th>Remarks</th><%if(viewdeletedrecord.equalsIgnoreCase("Y")) {%>	
                              <th>Record Status</th>
                                <%}%>
									</tr>
								</thead>
		...
		if (cnt == 0) {
			...
			bootbox.confirm("Are you Sure, you want to delete this record?",
							function(result) {
								...
								if (result == true) {
									document.getElementById("deltrainingid").value = val;
	...
	function callEdit() {
		...
		if (cnt == 0) {
			...
			if(isEligibleForOpertion(val)){
			document.getElementById("edittrainingid").value = val;
		...
		function callCreate() {
			document.forms[0].action = "createTraining.action";
			document.forms[0].submit();
		}
		$(document).ready(function() {
			   window.history.pushState("","", "traininglist.action");
			 });
...
<form name="form1" id="form1" action="ModifyTrainingDetails" method="POST">
	<input type="hidden" name="edittrainingid" id="edittrainingid" value="" />

</form>
<form name="form2" id="form2" action="DeleteTrainingDetails.action"
	method="POST">
	<input type="hidden" name="deltrainingid" id="deltrainingid" />

...
public class TripwiseLateDepartureReport extends ActionSupport {
	...
	public String getTripwiseLateDeparture(){
...
//			List<Map<String, Object>> aliasToValueMapList = query.list();
			 VtsResponse6 alertresults=scheduleDAO.getDataTripWiseLateDepartureReport(date1,scheduleNo);
			  
			
			 regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br>VTS Tripwise Late Departure Report</br></h4></div>";

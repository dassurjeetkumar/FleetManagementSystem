...
public class ConductorWisePercentETMAction {
	...
	public String getStartdate() {
		...
		public String getConductorWisePercentETM()
		{
			try {
...
//				String depotdb=common.getDBResultStr(session1, sql1, "depotname");
			...
			String sql="select EMPLOYEE_NAME,TOKEN,count(wd.conductor_Id) noofdays,sum(ETIM_Coll_Amt) etm,sum(manualpassenger) manual," +
					...
					"and (Bag_Coll_Amt+ETIM_Coll_Amt)>0 group by wd.conductor_Id order by etmper desc";

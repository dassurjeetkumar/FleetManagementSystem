...
public class ManualOperatedReportAction {
	...
	public String getStartdate() {
		...
		public String getManualOperated()
		{
			try {
...
//				String depotdb=common.getDBResultStr(session1, sql1, "depotname");
			...
			String sql="select s.schedule_number,e.TOKEN,ff.schedule_number_name,wd.status,wd.Bag_Coll_Amt from Waybill_Details wd " +
					...
					"and wd.ETIM_Coll_Amt='0.00' and wd.Bag_Coll_Amt !='0.00' AND wd.status in('closed','AUDITED')";
//        System.out.println(sql);
			 rs = stmt.executeQuery(sql);

		
			regionTypeAjaxString1.append("<div id='header' style='display: none;'><div align='center'> </br>100% Manual Operated Report </br>From Date:- "+startdate+" To Date:-"+ enddate+"</br></h4></div>");
			...
			regionTypeAjaxString1.append("<thead><tr><th>Sr No</th><th>Schedule No.</th><th>Conductor Token</th><th>Schedule Number Name</th>" +
						""+"</tr></thead><tbody>");
				...
				regionTypeAjaxString1.append("<td align='right'>"+ rs.getString("schedule_number_name") +"</td>");

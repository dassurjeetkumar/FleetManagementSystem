...
public class LateDepartureSummaryReportAction extends ActionSupport{
	String path="";
	char ft = 15;
	String str="";
	String c=" ";
	...
	private Map<Integer, String> getDivisionName() {
		...
		Query query = session
				.createQuery("from OrganisationChart orgchart  " +
						"where parent_id ='1' and org_type_id=2 and deleted_status=0 order by orgchart.org_name");
		try {
...
public String AjaxLateDepartureSummary()
  {
	try {
...
//					String fileName = "EarlyArrivalSummary.txt";
					     ...
					     regionTypeAjaxString +=" <div id='header' style='display: none;'><div align='center'><h4>"+""+" </br>"+ ""+" </br>Late Departure Summary Report</br>From Date:- "+startdate+" To Date:-"+ enddate+"</h4></div>";
